...
namespace Fiken.Test.Api
{
    ...
    public class DependencyInjectionTest
    {
        ...
        {
            var accountBalancesApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IAccountBalancesApi>();
            Assert.True(accountBalancesApi.HttpClient.BaseAddress != null);
            ...
            var bankAccountsApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IBankAccountsApi>();
            Assert.True(bankAccountsApi.HttpClient.BaseAddress != null);
            ...
            var creditNotesApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<ICreditNotesApi>();
            Assert.True(creditNotesApi.HttpClient.BaseAddress != null);
            ...
            var inboxApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IInboxApi>();
            Assert.True(inboxApi.HttpClient.BaseAddress != null);
            ...
            var journalEntriesApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IJournalEntriesApi>();
            Assert.True(journalEntriesApi.HttpClient.BaseAddress != null);
            ...
            var orderConfirmationsApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IOrderConfirmationsApi>();
            Assert.True(orderConfirmationsApi.HttpClient.BaseAddress != null);
            ...
            var purchasesApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IPurchasesApi>();
            Assert.True(purchasesApi.HttpClient.BaseAddress != null);

            var salesApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<ISalesApi>();
            Assert.True(salesApi.HttpClient.BaseAddress != null);
        ...
        {
            var accountBalancesApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IAccountBalancesApi>();
            Assert.True(accountBalancesApi.HttpClient.BaseAddress != null);

            var accountsApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IAccountsApi>();
            Assert.True(accountsApi.HttpClient.BaseAddress != null);

            var bankAccountsApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IBankAccountsApi>();
            Assert.True(bankAccountsApi.HttpClient.BaseAddress != null);
            ...
            var creditNotesApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<ICreditNotesApi>();
            Assert.True(creditNotesApi.HttpClient.BaseAddress != null);

            var groupsApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IGroupsApi>();
            Assert.True(groupsApi.HttpClient.BaseAddress != null);

            var inboxApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IInboxApi>();
            Assert.True(inboxApi.HttpClient.BaseAddress != null);

            var invoicesApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IInvoicesApi>();
            Assert.True(invoicesApi.HttpClient.BaseAddress != null);

            var journalEntriesApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IJournalEntriesApi>();
            Assert.True(journalEntriesApi.HttpClient.BaseAddress != null);

            var offersApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IOffersApi>();
            Assert.True(offersApi.HttpClient.BaseAddress != null);

            var orderConfirmationsApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IOrderConfirmationsApi>();
            Assert.True(orderConfirmationsApi.HttpClient.BaseAddress != null);
            ...
            var purchasesApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IPurchasesApi>();
            Assert.True(purchasesApi.HttpClient.BaseAddress != null);

            var salesApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<ISalesApi>();
            Assert.True(salesApi.HttpClient.BaseAddress != null);
        ...
        {
            var accountBalancesApi = _hostUsingAddWithAClient.Services.GetRequiredService<IAccountBalancesApi>();
            Assert.True(accountBalancesApi.HttpClient.BaseAddress != null);
            
            var accountsApi = _hostUsingAddWithAClient.Services.GetRequiredService<IAccountsApi>();
            Assert.True(accountsApi.HttpClient.BaseAddress != null);
            
            var bankAccountsApi = _hostUsingAddWithAClient.Services.GetRequiredService<IBankAccountsApi>();
            Assert.True(bankAccountsApi.HttpClient.BaseAddress != null);
            ...
            var creditNotesApi = _hostUsingAddWithAClient.Services.GetRequiredService<ICreditNotesApi>();
            Assert.True(creditNotesApi.HttpClient.BaseAddress != null);
            
            var groupsApi = _hostUsingAddWithAClient.Services.GetRequiredService<IGroupsApi>();
            Assert.True(groupsApi.HttpClient.BaseAddress != null);
            
            var inboxApi = _hostUsingAddWithAClient.Services.GetRequiredService<IInboxApi>();
            Assert.True(inboxApi.HttpClient.BaseAddress != null);
            
            var invoicesApi = _hostUsingAddWithAClient.Services.GetRequiredService<IInvoicesApi>();
            Assert.True(invoicesApi.HttpClient.BaseAddress != null);
            
            var journalEntriesApi = _hostUsingAddWithAClient.Services.GetRequiredService<IJournalEntriesApi>();
            Assert.True(journalEntriesApi.HttpClient.BaseAddress != null);
            
            var offersApi = _hostUsingAddWithAClient.Services.GetRequiredService<IOffersApi>();
            Assert.True(offersApi.HttpClient.BaseAddress != null);
            
            var orderConfirmationsApi = _hostUsingAddWithAClient.Services.GetRequiredService<IOrderConfirmationsApi>();
            Assert.True(orderConfirmationsApi.HttpClient.BaseAddress != null);
            ...
            var purchasesApi = _hostUsingAddWithAClient.Services.GetRequiredService<IPurchasesApi>();
            Assert.True(purchasesApi.HttpClient.BaseAddress != null);
            
            var salesApi = _hostUsingAddWithAClient.Services.GetRequiredService<ISalesApi>();
            Assert.True(salesApi.HttpClient.BaseAddress != null);
        ...
        {
            var accountBalancesApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IAccountBalancesApi>();
            Assert.True(accountBalancesApi.HttpClient.BaseAddress != null);

            var accountsApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IAccountsApi>();
            Assert.True(accountsApi.HttpClient.BaseAddress != null);

            var bankAccountsApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IBankAccountsApi>();
            Assert.True(bankAccountsApi.HttpClient.BaseAddress != null);
            ...
            var creditNotesApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<ICreditNotesApi>();
            Assert.True(creditNotesApi.HttpClient.BaseAddress != null);

            var groupsApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IGroupsApi>();
            Assert.True(groupsApi.HttpClient.BaseAddress != null);

            var inboxApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IInboxApi>();
            Assert.True(inboxApi.HttpClient.BaseAddress != null);

            var invoicesApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IInvoicesApi>();
            Assert.True(invoicesApi.HttpClient.BaseAddress != null);

            var journalEntriesApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IJournalEntriesApi>();
            Assert.True(journalEntriesApi.HttpClient.BaseAddress != null);

            var offersApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IOffersApi>();
            Assert.True(offersApi.HttpClient.BaseAddress != null);

            var orderConfirmationsApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IOrderConfirmationsApi>();
            Assert.True(orderConfirmationsApi.HttpClient.BaseAddress != null);
            ...
            var purchasesApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IPurchasesApi>();
            Assert.True(purchasesApi.HttpClient.BaseAddress != null);

            var salesApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<ISalesApi>();
            Assert.True(salesApi.HttpClient.BaseAddress != null);
