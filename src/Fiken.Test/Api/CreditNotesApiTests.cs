...
namespace Fiken.Test.Api
{
    ...
    /// </summary>
    public sealed class CreditNotesApiTests : ApiTestsBase
    {
        private readonly ICreditNotesApi _instance;

        public CreditNotesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ICreditNotesApi>();
        }

        /// <summary>
        /// Test AddAttachmentToCreditNoteDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddAttachmentToCreditNoteDraftAsyncTest()
        {
            ...
            await _instance.AddAttachmentToCreditNoteDraftAsync(companySlug, draftId, filename, comment, file);
        }

        /// <summary>
        /// Test CreateCreditNoteCounter
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateCreditNoteCounterAsyncTest()
        {
            string companySlug = default!;
            Client.Option<Counter> counter = default!;
            await _instance.CreateCreditNoteCounterAsync(companySlug, counter);
        }

        /// <summary>
        /// Test CreateCreditNoteDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateCreditNoteDraftAsyncTest()
        {
            string companySlug = default!;
            InvoiceishDraftRequest invoiceishDraftRequest = default!;
            await _instance.CreateCreditNoteDraftAsync(companySlug, invoiceishDraftRequest);
        }

        /// <summary>
        /// Test CreateCreditNoteFromDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateCreditNoteFromDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.CreateCreditNoteFromDraftAsync(companySlug, draftId);
        }

        /// <summary>
        /// Test CreateFullCreditNote
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateFullCreditNoteAsyncTest()
        {
            string companySlug = default!;
            FullCreditNoteRequest fullCreditNoteRequest = default!;
            await _instance.CreateFullCreditNoteAsync(companySlug, fullCreditNoteRequest);
        }

        /// <summary>
        /// Test CreatePartialCreditNote
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreatePartialCreditNoteAsyncTest()
        {
            string companySlug = default!;
            PartialCreditNoteRequest partialCreditNoteRequest = default!;
            await _instance.CreatePartialCreditNoteAsync(companySlug, partialCreditNoteRequest);
        }

        /// <summary>
        /// Test DeleteCreditNoteDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteCreditNoteDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.DeleteCreditNoteDraftAsync(companySlug, draftId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetCreditNoteAsyncTest()
        {
            string companySlug = default!;
            string creditNoteId = default!;
            var response = await _instance.GetCreditNoteAsync(companySlug, creditNoteId);
            var model = response.Ok();
            Assert.IsType<CreditNoteResult>(model);
        }

        /// <summary>
        /// Test GetCreditNoteCounter
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetCreditNoteCounterAsyncTest()
        {
            string companySlug = default!;
            var response = await _instance.GetCreditNoteCounterAsync(companySlug);
            var model = response.Ok();
            Assert.IsType<Counter>(model);
        }

        /// <summary>
        /// Test GetCreditNoteDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetCreditNoteDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetCreditNoteDraftAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<InvoiceishDraftResult>(model);
        }

        /// <summary>
        /// Test GetCreditNoteDraftAttachments
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetCreditNoteDraftAttachmentsAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetCreditNoteDraftAttachmentsAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<List<Attachment>>(model);
        }

        /// <summary>
        /// Test GetCreditNoteDrafts
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetCreditNoteDraftsAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            var response = await _instance.GetCreditNoteDraftsAsync(companySlug, page, pageSize);
            var model = response.Ok();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetCreditNotesAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            ...
            Client.Option<Guid> creditNoteDraftUuid = default!;
            var response = await _instance.GetCreditNotesAsync(companySlug, page, pageSize, issueDate, issueDateLe, issueDateLt, issueDateGe, issueDateGt, lastModified, lastModifiedLe, lastModifiedLt, lastModifiedGe, lastModifiedGt, customerId, settled, creditNoteDraftUuid);
            var model = response.Ok();
            Assert.IsType<List<CreditNoteResult>>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task SendCreditNoteAsyncTest()
        {
            string companySlug = default!;
            SendCreditNoteRequest sendCreditNoteRequest = default!;
            await _instance.SendCreditNoteAsync(companySlug, sendCreditNoteRequest);
        }

        /// <summary>
        /// Test UpdateCreditNoteDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateCreditNoteDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            InvoiceishDraftRequest invoiceishDraftRequest = default!;
            await _instance.UpdateCreditNoteDraftAsync(companySlug, draftId, invoiceishDraftRequest);
        }
    }
}
