...
namespace Fiken.Test.Api
{
    ...
    public sealed class InvoicesApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test AddAttachmentToInvoice
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddAttachmentToInvoiceAsyncTest()
        {
            ...
            await _instance.AddAttachmentToInvoiceAsync(companySlug, invoiceId, filename, file);
        }

        /// <summary>
        /// Test AddAttachmentToInvoiceDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddAttachmentToInvoiceDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            Client.Option<string> filename = default!;
            Client.Option<string> comment = default!;
            Client.Option<System.IO.Stream> file = default!;
            await _instance.AddAttachmentToInvoiceDraftAsync(companySlug, draftId, filename, comment, file);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateInvoiceAsyncTest()
        {
            string companySlug = default!;
            InvoiceRequest invoiceRequest = default!;
            await _instance.CreateInvoiceAsync(companySlug, invoiceRequest);
        }

        /// <summary>
        /// Test CreateInvoiceCounter
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateInvoiceCounterAsyncTest()
        {
            string companySlug = default!;
            Client.Option<Counter> counter = default!;
            await _instance.CreateInvoiceCounterAsync(companySlug, counter);
        }

        /// <summary>
        /// Test CreateInvoiceDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateInvoiceDraftAsyncTest()
        {
            string companySlug = default!;
            InvoiceishDraftRequest invoiceishDraftRequest = default!;
            await _instance.CreateInvoiceDraftAsync(companySlug, invoiceishDraftRequest);
        }

        /// <summary>
        /// Test CreateInvoiceFromDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateInvoiceFromDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.CreateInvoiceFromDraftAsync(companySlug, draftId);
        }

        /// <summary>
        /// Test DeleteInvoiceDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteInvoiceDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.DeleteInvoiceDraftAsync(companySlug, draftId);
        }
        ...
        public async Task GetInvoiceAsyncTest()
        {
            string companySlug = default!;
            long invoiceId = default!;
            var response = await _instance.GetInvoiceAsync(companySlug, invoiceId);
            var model = response.Ok();
            Assert.IsType<InvoiceResult>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetInvoiceAttachmentsAsyncTest()
        {
            string companySlug = default!;
            long invoiceId = default!;
            var response = await _instance.GetInvoiceAttachmentsAsync(companySlug, invoiceId);
            var model = response.Ok();
            Assert.IsType<List<Attachment>>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetInvoiceCounterAsyncTest()
        {
            string companySlug = default!;
            var response = await _instance.GetInvoiceCounterAsync(companySlug);
            var model = response.Ok();
            Assert.IsType<Counter>(model);
        }

        /// <summary>
        /// Test GetInvoiceDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetInvoiceDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetInvoiceDraftAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<InvoiceishDraftResult>(model);
        }

        /// <summary>
        /// Test GetInvoiceDraftAttachments
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetInvoiceDraftAttachmentsAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetInvoiceDraftAttachmentsAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<List<Attachment>>(model);
        }

        /// <summary>
        /// Test GetInvoiceDrafts
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetInvoiceDraftsAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            Client.Option<string> orderReference = default!;
            Client.Option<Guid> uuid = default!;
            var response = await _instance.GetInvoiceDraftsAsync(companySlug, page, pageSize, orderReference, uuid);
            var model = response.Ok();
            Assert.IsType<List<InvoiceishDraftResult>>(model);
        }
        ...
        public async Task GetInvoicesAsyncTest()
        {
            ...
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            Client.Option<DateOnly> issueDate = default!;
            Client.Option<DateOnly> issueDateLe = default!;
            Client.Option<DateOnly> issueDateLt = default!;
            Client.Option<DateOnly> issueDateGe = default!;
            Client.Option<DateOnly> issueDateGt = default!;
            ...
            Client.Option<DateOnly> dueDate = default!;
            Client.Option<DateOnly> dueDateLe = default!;
            Client.Option<DateOnly> dueDateLt = default!;
            Client.Option<DateOnly> dueDateGe = default!;
            Client.Option<DateOnly> dueDateGt = default!;
            Client.Option<long> customerId = default!;
            Client.Option<bool> settled = default!;
            Client.Option<string> orderReference = default!;
            Client.Option<Guid> invoiceDraftUuid = default!;
            Client.Option<string> invoiceNumber = default!;
            var response = await _instance.GetInvoicesAsync(companySlug, page, pageSize, issueDate, issueDateLe, issueDateLt, issueDateGe, issueDateGt, lastModified, lastModifiedLe, lastModifiedLt, lastModifiedGe, lastModifiedGt, dueDate, dueDateLe, dueDateLt, dueDateGe, dueDateGt, customerId, settled, orderReference, invoiceDraftUuid, invoiceNumber);
            var model = response.Ok();
            Assert.IsType<List<InvoiceResult>>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task SendInvoiceAsyncTest()
        {
            string companySlug = default!;
            SendInvoiceRequest sendInvoiceRequest = default!;
            await _instance.SendInvoiceAsync(companySlug, sendInvoiceRequest);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateInvoiceAsyncTest()
        {
            string companySlug = default!;
            long invoiceId = default!;
            UpdateInvoiceRequest updateInvoiceRequest = default!;
            await _instance.UpdateInvoiceAsync(companySlug, invoiceId, updateInvoiceRequest);
        }

        /// <summary>
        /// Test UpdateInvoiceDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateInvoiceDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            InvoiceishDraftRequest invoiceishDraftRequest = default!;
            await _instance.UpdateInvoiceDraftAsync(companySlug, draftId, invoiceishDraftRequest);
        }
    }
}
