...
{
    /// <summary>
    ///  Class for testing OrderConfirmationsApi
    /// </summary>
    public sealed class OrderConfirmationsApiTests : ApiTestsBase
    {
        private readonly IOrderConfirmationsApi _instance;

        public OrderConfirmationsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IOrderConfirmationsApi>();
        }

        /// <summary>
        /// Test AddAttachmentToOrderConfirmationDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddAttachmentToOrderConfirmationDraftAsyncTest()
        {
            ...
            await _instance.AddAttachmentToOrderConfirmationDraftAsync(companySlug, draftId, filename, comment, file);
        }

        /// <summary>
        /// Test CreateInvoiceDraftFromOrderConfirmation
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateInvoiceDraftFromOrderConfirmationAsyncTest()
        {
            string companySlug = default!;
            string confirmationId = default!;
            await _instance.CreateInvoiceDraftFromOrderConfirmationAsync(companySlug, confirmationId);
        }

        /// <summary>
        /// Test CreateOrderConfirmationCounter
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateOrderConfirmationCounterAsyncTest()
        {
            string companySlug = default!;
            Client.Option<Counter> counter = default!;
            await _instance.CreateOrderConfirmationCounterAsync(companySlug, counter);
        }

        /// <summary>
        /// Test CreateOrderConfirmationDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateOrderConfirmationDraftAsyncTest()
        {
            string companySlug = default!;
            InvoiceishDraftRequest invoiceishDraftRequest = default!;
            await _instance.CreateOrderConfirmationDraftAsync(companySlug, invoiceishDraftRequest);
        }

        /// <summary>
        /// Test CreateOrderConfirmationFromDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateOrderConfirmationFromDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.CreateOrderConfirmationFromDraftAsync(companySlug, draftId);
        }

        /// <summary>
        /// Test DeleteOrderConfirmationDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteOrderConfirmationDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.DeleteOrderConfirmationDraftAsync(companySlug, draftId);
        }

        /// <summary>
        /// Test GetOrderConfirmation
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOrderConfirmationAsyncTest()
        {
            string companySlug = default!;
            string confirmationId = default!;
            var response = await _instance.GetOrderConfirmationAsync(companySlug, confirmationId);
            var model = response.Ok();
            Assert.IsType<OrderConfirmation>(model);
        }

        /// <summary>
        /// Test GetOrderConfirmationCounter
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOrderConfirmationCounterAsyncTest()
        {
            string companySlug = default!;
            var response = await _instance.GetOrderConfirmationCounterAsync(companySlug);
            var model = response.Ok();
            Assert.IsType<Counter>(model);
        }

        /// <summary>
        /// Test GetOrderConfirmationDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOrderConfirmationDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetOrderConfirmationDraftAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<InvoiceishDraftResult>(model);
        }

        /// <summary>
        /// Test GetOrderConfirmationDraftAttachments
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOrderConfirmationDraftAttachmentsAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetOrderConfirmationDraftAttachmentsAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<List<Attachment>>(model);
        }

        /// <summary>
        /// Test GetOrderConfirmationDrafts
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOrderConfirmationDraftsAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            var response = await _instance.GetOrderConfirmationDraftsAsync(companySlug, page, pageSize);
            var model = response.Ok();
            Assert.IsType<List<InvoiceishDraftResult>>(model);
        }

        /// <summary>
        /// Test GetOrderConfirmations
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOrderConfirmationsAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            var response = await _instance.GetOrderConfirmationsAsync(companySlug, page, pageSize);
            var model = response.Ok();
            Assert.IsType<List<OrderConfirmation>>(model);
        }

        /// <summary>
        /// Test UpdateOrderConfirmationDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateOrderConfirmationDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            InvoiceishDraftRequest invoiceishDraftRequest = default!;
            await _instance.UpdateOrderConfirmationDraftAsync(companySlug, draftId, invoiceishDraftRequest);
        }
    }
}
