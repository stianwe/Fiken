...
namespace Fiken.Test.Api
{
    ...
    public sealed class OffersApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test AddAttachmentToOfferDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddAttachmentToOfferDraftAsyncTest()
        {
            ...
            await _instance.AddAttachmentToOfferDraftAsync(companySlug, draftId, filename, comment, file);
        }

        /// <summary>
        /// Test CreateOfferCounter
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateOfferCounterAsyncTest()
        {
            string companySlug = default!;
            Client.Option<Counter> counter = default!;
            await _instance.CreateOfferCounterAsync(companySlug, counter);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateOfferDraftAsyncTest()
        {
            string companySlug = default!;
            InvoiceishDraftRequest invoiceishDraftRequest = default!;
            await _instance.CreateOfferDraftAsync(companySlug, invoiceishDraftRequest);
        }

        /// <summary>
        /// Test CreateOfferFromDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateOfferFromDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.CreateOfferFromDraftAsync(companySlug, draftId);
        }

        /// <summary>
        /// Test DeleteOfferDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteOfferDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.DeleteOfferDraftAsync(companySlug, draftId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOfferAsyncTest()
        {
            string companySlug = default!;
            string offerId = default!;
            var response = await _instance.GetOfferAsync(companySlug, offerId);
            var model = response.Ok();
            Assert.IsType<Offer>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOfferCounterAsyncTest()
        {
            string companySlug = default!;
            var response = await _instance.GetOfferCounterAsync(companySlug);
            var model = response.Ok();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOfferDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetOfferDraftAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<InvoiceishDraftResult>(model);
        }

        /// <summary>
        /// Test GetOfferDraftAttachments
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOfferDraftAttachmentsAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetOfferDraftAttachmentsAsync(companySlug, draftId);
            var model = response.Ok();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOfferDraftsAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            var response = await _instance.GetOfferDraftsAsync(companySlug, page, pageSize);
            var model = response.Ok();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetOffersAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            var response = await _instance.GetOffersAsync(companySlug, page, pageSize);
            var model = response.Ok();
            Assert.IsType<List<Offer>>(model);
        }

        /// <summary>
        /// Test UpdateOfferDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateOfferDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            InvoiceishDraftRequest invoiceishDraftRequest = default!;
            await _instance.UpdateOfferDraftAsync(companySlug, draftId, invoiceishDraftRequest);
        }
    }
}
