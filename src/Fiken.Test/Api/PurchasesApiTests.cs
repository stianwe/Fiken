...
namespace Fiken.Test.Api
{
    ...
    /// </summary>
    public sealed class PurchasesApiTests : ApiTestsBase
    {
        private readonly IPurchasesApi _instance;

        public PurchasesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IPurchasesApi>();
        }

        /// <summary>
        /// Test AddAttachmentToPurchase
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddAttachmentToPurchaseAsyncTest()
        {
            string companySlug = default!;
            long purchaseId = default!;
            Client.Option<string> filename = default!;
            Client.Option<bool> attachToPayment = default!;
            Client.Option<bool> attachToSale = default!;
            Client.Option<System.IO.Stream> file = default!;
            await _instance.AddAttachmentToPurchaseAsync(companySlug, purchaseId, filename, attachToPayment, attachToSale, file);
        }

        /// <summary>
        /// Test AddAttachmentToPurchaseDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddAttachmentToPurchaseDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            Client.Option<string> filename = default!;
            Client.Option<System.IO.Stream> file = default!;
            await _instance.AddAttachmentToPurchaseDraftAsync(companySlug, draftId, filename, file);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreatePurchaseAsyncTest()
        {
            string companySlug = default!;
            PurchaseRequest purchaseRequest = default!;
            await _instance.CreatePurchaseAsync(companySlug, purchaseRequest);
        }

        /// <summary>
        /// Test CreatePurchaseDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreatePurchaseDraftAsyncTest()
        {
            string companySlug = default!;
            DraftRequest draftRequest = default!;
            await _instance.CreatePurchaseDraftAsync(companySlug, draftRequest);
        }

        /// <summary>
        /// Test CreatePurchaseFromDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreatePurchaseFromDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.CreatePurchaseFromDraftAsync(companySlug, draftId);
        }

        /// <summary>
        /// Test CreatePurchasePayment
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreatePurchasePaymentAsyncTest()
        {
            string companySlug = default!;
            long purchaseId = default!;
            Payment payment = default!;
            await _instance.CreatePurchasePaymentAsync(companySlug, purchaseId, payment);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeletePurchaseAsyncTest()
        {
            string companySlug = default!;
            long purchaseId = default!;
            string description = default!;
            var response = await _instance.DeletePurchaseAsync(companySlug, purchaseId, description);
            var model = response.Ok();
            Assert.IsType<PurchaseResult>(model);
        }

        /// <summary>
        /// Test DeletePurchaseDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeletePurchaseDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.DeletePurchaseDraftAsync(companySlug, draftId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetPurchaseAsyncTest()
        {
            string companySlug = default!;
            long purchaseId = default!;
            var response = await _instance.GetPurchaseAsync(companySlug, purchaseId);
            var model = response.Ok();
            Assert.IsType<PurchaseResult>(model);
        }

        /// <summary>
        /// Test GetPurchaseAttachments
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetPurchaseAttachmentsAsyncTest()
        {
            string companySlug = default!;
            long purchaseId = default!;
            var response = await _instance.GetPurchaseAttachmentsAsync(companySlug, purchaseId);
            var model = response.Ok();
            Assert.IsType<List<Attachment>>(model);
        }

        /// <summary>
        /// Test GetPurchaseDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetPurchaseDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetPurchaseDraftAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<DraftResult>(model);
        }

        /// <summary>
        /// Test GetPurchaseDraftAttachments
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetPurchaseDraftAttachmentsAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetPurchaseDraftAttachmentsAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<List<Attachment>>(model);
        }

        /// <summary>
        /// Test GetPurchaseDrafts
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetPurchaseDraftsAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            var response = await _instance.GetPurchaseDraftsAsync(companySlug, page, pageSize);
            var model = response.Ok();
            Assert.IsType<List<DraftResult>>(model);
        }

        /// <summary>
        /// Test GetPurchasePayment
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetPurchasePaymentAsyncTest()
        {
            string companySlug = default!;
            long purchaseId = default!;
            long paymentId = default!;
            var response = await _instance.GetPurchasePaymentAsync(companySlug, purchaseId, paymentId);
            var model = response.Ok();
            Assert.IsType<Payment>(model);
        }

        /// <summary>
        /// Test GetPurchasePayments
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetPurchasePaymentsAsyncTest()
        {
            string companySlug = default!;
            long purchaseId = default!;
            var response = await _instance.GetPurchasePaymentsAsync(companySlug, purchaseId);
            var model = response.Ok();
            Assert.IsType<List<Payment>>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetPurchasesAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            Client.Option<DateOnly> date = default!;
            Client.Option<DateOnly> dateLe = default!;
            Client.Option<DateOnly> dateLt = default!;
            Client.Option<DateOnly> dateGe = default!;
            Client.Option<DateOnly> dateGt = default!;
            Client.Option<string> sortBy = default!;
            Client.Option<bool> paid = default!;
            var response = await _instance.GetPurchasesAsync(companySlug, page, pageSize, date, dateLe, dateLt, dateGe, dateGt, sortBy, paid);
            var model = response.Ok();
            Assert.IsType<List<PurchaseResult>>(model);
        }

        /// <summary>
        /// Test UpdatePurchaseDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdatePurchaseDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            DraftRequest draftRequest = default!;
            await _instance.UpdatePurchaseDraftAsync(companySlug, draftId, draftRequest);
        }
    }
}
