...
namespace Fiken.Test.Api
{
    ...
    /// </summary>
    public sealed class SalesApiTests : ApiTestsBase
    {
        private readonly ISalesApi _instance;

        public SalesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISalesApi>();
        }

        /// <summary>
        /// Test AddAttachmentToSale
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddAttachmentToSaleAsyncTest()
        {
            ...
            await _instance.AddAttachmentToSaleAsync(companySlug, saleId, filename, attachToPayment, attachToSale, file);
        }

        /// <summary>
        /// Test AddAttachmentToSaleDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task AddAttachmentToSaleDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            Client.Option<string> filename = default!;
            Client.Option<System.IO.Stream> file = default!;
            await _instance.AddAttachmentToSaleDraftAsync(companySlug, draftId, filename, file);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateSaleAsyncTest()
        {
            string companySlug = default!;
            SaleRequest saleRequest = default!;
            await _instance.CreateSaleAsync(companySlug, saleRequest);
        }

        /// <summary>
        /// Test CreateSaleDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateSaleDraftAsyncTest()
        {
            string companySlug = default!;
            DraftRequest draftRequest = default!;
            await _instance.CreateSaleDraftAsync(companySlug, draftRequest);
        }

        /// <summary>
        /// Test CreateSaleFromDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateSaleFromDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.CreateSaleFromDraftAsync(companySlug, draftId);
        }

        /// <summary>
        /// Test CreateSalePayment
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task CreateSalePaymentAsyncTest()
        {
            string companySlug = default!;
            long saleId = default!;
            Payment payment = default!;
            await _instance.CreateSalePaymentAsync(companySlug, saleId, payment);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteSaleAsyncTest()
        {
            string companySlug = default!;
            long saleId = default!;
            string description = default!;
            var response = await _instance.DeleteSaleAsync(companySlug, saleId, description);
            var model = response.Ok();
            Assert.IsType<SaleResult>(model);
        }

        /// <summary>
        /// Test DeleteSaleDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task DeleteSaleDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            await _instance.DeleteSaleDraftAsync(companySlug, draftId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSaleAsyncTest()
        {
            string companySlug = default!;
            long saleId = default!;
            var response = await _instance.GetSaleAsync(companySlug, saleId);
            var model = response.Ok();
            Assert.IsType<SaleResult>(model);
        }

        /// <summary>
        /// Test GetSaleAttachments
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSaleAttachmentsAsyncTest()
        {
            string companySlug = default!;
            long saleId = default!;
            var response = await _instance.GetSaleAttachmentsAsync(companySlug, saleId);
            var model = response.Ok();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSaleDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetSaleDraftAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<DraftResult>(model);
        }

        /// <summary>
        /// Test GetSaleDraftAttachments
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSaleDraftAttachmentsAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            var response = await _instance.GetSaleDraftAttachmentsAsync(companySlug, draftId);
            var model = response.Ok();
            Assert.IsType<List<Attachment>>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSaleDraftsAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            var response = await _instance.GetSaleDraftsAsync(companySlug, page, pageSize);
            var model = response.Ok();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSalePaymentAsyncTest()
        {
            string companySlug = default!;
            long saleId = default!;
            long paymentId = default!;
            var response = await _instance.GetSalePaymentAsync(companySlug, saleId, paymentId);
            var model = response.Ok();
            Assert.IsType<Payment>(model);
        }

        /// <summary>
        /// Test GetSalePayments
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSalePaymentsAsyncTest()
        {
            string companySlug = default!;
            long saleId = default!;
            var response = await _instance.GetSalePaymentsAsync(companySlug, saleId);
            var model = response.Ok();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSalesAsyncTest()
        {
            string companySlug = default!;
            Client.Option<int> page = default!;
            Client.Option<int> pageSize = default!;
            ...
            Client.Option<string> saleNumber = default!;
            Client.Option<bool> settled = default!;
            Client.Option<long> contactId = default!;
            var response = await _instance.GetSalesAsync(companySlug, page, pageSize, date, dateLe, dateLt, dateGe, dateGt, lastModified, lastModifiedLe, lastModifiedLt, lastModifiedGe, lastModifiedGt, saleNumber, settled, contactId);
            var model = response.Ok();
            Assert.IsType<List<SaleResult>>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task SettledSaleAsyncTest()
        {
            string companySlug = default!;
            long saleId = default!;
            DateOnly settledDate = default!;
            var response = await _instance.SettledSaleAsync(companySlug, saleId, settledDate);
            var model = response.Ok();
            Assert.IsType<SaleResult>(model);
        }

        /// <summary>
        /// Test UpdateSaleDraft
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateSaleDraftAsyncTest()
        {
            string companySlug = default!;
            long draftId = default!;
            DraftRequest draftRequest = default!;
            await _instance.UpdateSaleDraftAsync(companySlug, draftId, draftRequest);
        }
    }
}
