...
namespace Fiken.Test.Model
{
    ...
    public class CompanyTests : IDisposable
    {
        ...
        /// <summary>
        /// Test the property 'HasApiAccess'
        /// </summary>
        [Fact]
        public void HasApiAccessTest()
        {
            // TODO unit test for the property 'HasApiAccess'
        }

        /// <summary>
        /// Test the property 'TestCompany'
        /// </summary>
        [Fact]
        public void TestCompanyTest()
        {
            // TODO unit test for the property 'TestCompany'
        }

        /// <summary>
        /// Test the property 'AccountingStartDate'
        /// </summary>
        [Fact]
        public void AccountingStartDateTest()
        {
            // TODO unit test for the property 'AccountingStartDate'
        }
    }
}
