...
namespace Fiken.Model
{
    ...
    /// </summary>
    public partial class CreditNoteLineResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditNoteLineResult" /> class.
        /// </summary>
        ...
        /// <param name="vatType">One of: {\&quot;HIGH\&quot;, \&quot;MEDIUM\&quot;, \&quot;LOW\&quot;, \&quot;EXEMPT\&quot;, \&quot;EXEMPT_IMPORT_EXPORT\&quot;, \&quot;EXEMPT_REVERSE\&quot;, \&quot;OUTSIDE\&quot;, \&quot;NONE\&quot;}. \&quot;HIGH\&quot; is the most common. </param>
        /// <param name="discount">If field is set, all amounts must be given before the discount is applied. The API will calculate the new totals. Discount value should be a percent with a value between 0 and 100. Decimal values such as 25.5 are also allowed.</param>
        ...
        [JsonConstructor]
        public CreditNoteLineResult(long unitPrice, decimal quantity, Option<string?> incomeAccount = default, Option<string?> vatType = default, Option<decimal?> discount = default, Option<long?> productId = default, Option<string?> description = default, Option<string?> comment = default)
        {
            UnitPrice = unitPrice;
            Quantity = quantity;
        ...
        /// </summary>
        /// <value>If field is set, all amounts must be given before the discount is applied. The API will calculate the new totals. Discount value should be a percent with a value between 0 and 100. Decimal values such as 25.5 are also allowed.</value>
        /* <example>25</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreditNoteLineResult" />
    /// </summary>
    public class CreditNoteLineResultJsonConverter : JsonConverter<CreditNoteLineResult>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreditNoteLineResult" />
        /// </summary>
        ...
        public override CreditNoteLineResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!unitPrice.IsSet)
                throw new ArgumentException("Property is required for class CreditNoteLineResult.", nameof(unitPrice));

            if (!quantity.IsSet)
                throw new ArgumentException("Property is required for class CreditNoteLineResult.", nameof(quantity));

            if (unitPrice.IsSet && unitPrice.Value == null)
                throw new ArgumentNullException(nameof(unitPrice), "Property is not nullable for class CreditNoteLineResult.");

            if (quantity.IsSet && quantity.Value == null)
                throw new ArgumentNullException(nameof(quantity), "Property is not nullable for class CreditNoteLineResult.");

            if (incomeAccount.IsSet && incomeAccount.Value == null)
                throw new ArgumentNullException(nameof(incomeAccount), "Property is not nullable for class CreditNoteLineResult.");

            if (vatType.IsSet && vatType.Value == null)
                throw new ArgumentNullException(nameof(vatType), "Property is not nullable for class CreditNoteLineResult.");

            if (discount.IsSet && discount.Value == null)
                throw new ArgumentNullException(nameof(discount), "Property is not nullable for class CreditNoteLineResult.");

            if (productId.IsSet && productId.Value == null)
                throw new ArgumentNullException(nameof(productId), "Property is not nullable for class CreditNoteLineResult.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class CreditNoteLineResult.");

            if (comment.IsSet && comment.Value == null)
                throw new ArgumentNullException(nameof(comment), "Property is not nullable for class CreditNoteLineResult.");

            return new CreditNoteLineResult(unitPrice.Value!.Value!, quantity.Value!.Value!, incomeAccount, vatType, discount, productId, description, comment);
        }

        /// <summary>
        /// Serializes a <see cref="CreditNoteLineResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="creditNoteLineResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreditNoteLineResult creditNoteLineResult, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, creditNoteLineResult, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreditNoteLineResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="creditNoteLineResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreditNoteLineResult creditNoteLineResult, JsonSerializerOptions jsonSerializerOptions)
        {
            if (creditNoteLineResult.IncomeAccountOption.IsSet && creditNoteLineResult.IncomeAccount == null)
                throw new ArgumentNullException(nameof(creditNoteLineResult.IncomeAccount), "Property is required for class CreditNoteLineResult.");

            if (creditNoteLineResult.VatTypeOption.IsSet && creditNoteLineResult.VatType == null)
                throw new ArgumentNullException(nameof(creditNoteLineResult.VatType), "Property is required for class CreditNoteLineResult.");

            if (creditNoteLineResult.DescriptionOption.IsSet && creditNoteLineResult.Description == null)
                throw new ArgumentNullException(nameof(creditNoteLineResult.Description), "Property is required for class CreditNoteLineResult.");

            if (creditNoteLineResult.CommentOption.IsSet && creditNoteLineResult.Comment == null)
                throw new ArgumentNullException(nameof(creditNoteLineResult.Comment), "Property is required for class CreditNoteLineResult.");

            writer.WriteNumber("unitPrice", creditNoteLineResult.UnitPrice);

            writer.WriteNumber("quantity", creditNoteLineResult.Quantity);

            if (creditNoteLineResult.IncomeAccountOption.IsSet)
                writer.WriteString("incomeAccount", creditNoteLineResult.IncomeAccount);

            if (creditNoteLineResult.VatTypeOption.IsSet)
                writer.WriteString("vatType", creditNoteLineResult.VatType);

            if (creditNoteLineResult.DiscountOption.IsSet)
                writer.WriteNumber("discount", creditNoteLineResult.DiscountOption.Value!.Value);

            if (creditNoteLineResult.ProductIdOption.IsSet)
                writer.WriteNumber("productId", creditNoteLineResult.ProductIdOption.Value!.Value);

            if (creditNoteLineResult.DescriptionOption.IsSet)
                writer.WriteString("description", creditNoteLineResult.Description);

            if (creditNoteLineResult.CommentOption.IsSet)
                writer.WriteString("comment", creditNoteLineResult.Comment);
        }
    }
}
