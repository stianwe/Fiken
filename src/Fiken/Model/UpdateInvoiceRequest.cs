...
namespace Fiken.Model
{
    ...
    public partial class UpdateInvoiceRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="newDueDate">Due date of invoice, format yyyy-mm-dd</param>
        /// <param name="sentManually">If the invoice was not sent using Fiken this can be set to \&quot;true\&quot;</param>
        [JsonConstructor]
        public UpdateInvoiceRequest(Option<DateOnly?> newDueDate = default, Option<bool?> sentManually = default)
        {
            NewDueDateOption = newDueDate;
        ...
        /// <summary>
        /// Used to track the state of NewDueDate
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DateOnly?> NewDueDateOption { get; private set; }
        ...
        public DateOnly? NewDueDate { get { return this.NewDueDateOption; } set { this.NewDueDateOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NewDueDate: ").Append(NewDueDate).Append("\n");
    ...
    {
        /// <summary>
        /// The format to use to serialize NewDueDate
        /// </summary>
        public static string NewDueDateFormat { get; set; } = "yyyy'-'MM'-'dd";
        ...
        public override UpdateInvoiceRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DateOnly?> newDueDate = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "newDueDate":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                newDueDate = new Option<DateOnly?>(JsonSerializer.Deserialize<DateOnly>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "sentManually":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (newDueDate.IsSet && newDueDate.Value == null)
                throw new ArgumentNullException(nameof(newDueDate), "Property is not nullable for class UpdateInvoiceRequest.");

            if (sentManually.IsSet && sentManually.Value == null)
                throw new ArgumentNullException(nameof(sentManually), "Property is not nullable for class UpdateInvoiceRequest.");

            return new UpdateInvoiceRequest(newDueDate, sentManually);
        }
        ...
        {
            if (updateInvoiceRequest.NewDueDateOption.IsSet)
                writer.WriteString("newDueDate", updateInvoiceRequest.NewDueDateOption.Value!.Value.ToString(NewDueDateFormat));

            if (updateInvoiceRequest.SentManuallyOption.IsSet)
                writer.WriteBoolean("sentManually", updateInvoiceRequest.SentManuallyOption.Value!.Value);
        }
    }
}
