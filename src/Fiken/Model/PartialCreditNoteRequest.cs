...
namespace Fiken.Model
{
    ...
    /// </summary>
    public partial class PartialCreditNoteRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialCreditNoteRequest" /> class.
        /// </summary>
        /// <param name="issueDate">Date that the credit note is issued, format yyyy-mm-dd</param>
        /// <param name="lines">lines</param>
        /// <param name="ourReference">Optional</param>
        /// <param name="yourReference">Optional - Your reference for invoice, free string format.</param>
        /// <param name="orderReference">Reference if sending via EHF.</param>
        /// <param name="project">Optional - Project associated with the credit note.</param>
        /// <param name="currency">ISO 4217 currency code</param>
        /// <param name="invoiceId">Optional - Id of invoice that the credit note is associated with.</param>
        /// <param name="contactId">Id of contact that the credit note is associated with.</param>
        /// <param name="contactPersonId">Id of contact person that the credit note is associated with (Credit person must belong to the provided contact).</param>
        /// <param name="creditNoteText">creditNoteText</param>
        [JsonConstructor]
        public PartialCreditNoteRequest(DateOnly issueDate, List<CreditNoteLineResult> lines, Option<string?> ourReference = default, Option<string?> yourReference = default, Option<string?> orderReference = default, Option<long?> project = default, Option<string?> currency = default, Option<long?> invoiceId = default, Option<long?> contactId = default, Option<long?> contactPersonId = default, Option<string?> creditNoteText = default)
        {
            IssueDate = issueDate;
            Lines = lines;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> ProjectOption { get; private set; }
        ...
        public long? Project { get { return this.ProjectOption; } set { this.ProjectOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> InvoiceIdOption { get; private set; }
        ...
        public long? InvoiceId { get { return this.InvoiceIdOption; } set { this.InvoiceIdOption = new(value); } }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // CreditNoteText (string) maxLength
            if (this.CreditNoteText != null && this.CreditNoteText.Length > 500)
            {
                yield return new ValidationResult("Invalid value for CreditNoteText, length must be less than 500.", new [] { "CreditNoteText" });
            }
    ...
    /// <summary>
    /// A Json converter for type <see cref="PartialCreditNoteRequest" />
    /// </summary>
    public class PartialCreditNoteRequestJsonConverter : JsonConverter<PartialCreditNoteRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="PartialCreditNoteRequest" />
        /// </summary>
        ...
        public override PartialCreditNoteRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "lines":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                lines = new Option<List<CreditNoteLineResult>?>(JsonSerializer.Deserialize<List<CreditNoteLineResult>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "ourReference":
                        ...
                        case "project":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                project = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
                        case "currency":
            ...
            if (!issueDate.IsSet)
                throw new ArgumentException("Property is required for class PartialCreditNoteRequest.", nameof(issueDate));

            if (!lines.IsSet)
                throw new ArgumentException("Property is required for class PartialCreditNoteRequest.", nameof(lines));

            if (issueDate.IsSet && issueDate.Value == null)
                throw new ArgumentNullException(nameof(issueDate), "Property is not nullable for class PartialCreditNoteRequest.");

            if (lines.IsSet && lines.Value == null)
                throw new ArgumentNullException(nameof(lines), "Property is not nullable for class PartialCreditNoteRequest.");

            if (ourReference.IsSet && ourReference.Value == null)
                throw new ArgumentNullException(nameof(ourReference), "Property is not nullable for class PartialCreditNoteRequest.");

            if (yourReference.IsSet && yourReference.Value == null)
                throw new ArgumentNullException(nameof(yourReference), "Property is not nullable for class PartialCreditNoteRequest.");

            if (orderReference.IsSet && orderReference.Value == null)
                throw new ArgumentNullException(nameof(orderReference), "Property is not nullable for class PartialCreditNoteRequest.");

            if (project.IsSet && project.Value == null)
                throw new ArgumentNullException(nameof(project), "Property is not nullable for class PartialCreditNoteRequest.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class PartialCreditNoteRequest.");

            if (invoiceId.IsSet && invoiceId.Value == null)
                throw new ArgumentNullException(nameof(invoiceId), "Property is not nullable for class PartialCreditNoteRequest.");

            if (contactId.IsSet && contactId.Value == null)
                throw new ArgumentNullException(nameof(contactId), "Property is not nullable for class PartialCreditNoteRequest.");

            if (contactPersonId.IsSet && contactPersonId.Value == null)
                throw new ArgumentNullException(nameof(contactPersonId), "Property is not nullable for class PartialCreditNoteRequest.");

            if (creditNoteText.IsSet && creditNoteText.Value == null)
                throw new ArgumentNullException(nameof(creditNoteText), "Property is not nullable for class PartialCreditNoteRequest.");

            return new PartialCreditNoteRequest(issueDate.Value!.Value!, lines.Value!, ourReference, yourReference, orderReference, project, currency, invoiceId, contactId, contactPersonId, creditNoteText);
        }

        /// <summary>
        /// Serializes a <see cref="PartialCreditNoteRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="partialCreditNoteRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PartialCreditNoteRequest partialCreditNoteRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, partialCreditNoteRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PartialCreditNoteRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="partialCreditNoteRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PartialCreditNoteRequest partialCreditNoteRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (partialCreditNoteRequest.Lines == null)
                throw new ArgumentNullException(nameof(partialCreditNoteRequest.Lines), "Property is required for class PartialCreditNoteRequest.");

            if (partialCreditNoteRequest.OurReferenceOption.IsSet && partialCreditNoteRequest.OurReference == null)
                throw new ArgumentNullException(nameof(partialCreditNoteRequest.OurReference), "Property is required for class PartialCreditNoteRequest.");

            if (partialCreditNoteRequest.YourReferenceOption.IsSet && partialCreditNoteRequest.YourReference == null)
                throw new ArgumentNullException(nameof(partialCreditNoteRequest.YourReference), "Property is required for class PartialCreditNoteRequest.");

            if (partialCreditNoteRequest.OrderReferenceOption.IsSet && partialCreditNoteRequest.OrderReference == null)
                throw new ArgumentNullException(nameof(partialCreditNoteRequest.OrderReference), "Property is required for class PartialCreditNoteRequest.");

            if (partialCreditNoteRequest.CurrencyOption.IsSet && partialCreditNoteRequest.Currency == null)
                throw new ArgumentNullException(nameof(partialCreditNoteRequest.Currency), "Property is required for class PartialCreditNoteRequest.");

            if (partialCreditNoteRequest.CreditNoteTextOption.IsSet && partialCreditNoteRequest.CreditNoteText == null)
                throw new ArgumentNullException(nameof(partialCreditNoteRequest.CreditNoteText), "Property is required for class PartialCreditNoteRequest.");

            writer.WriteString("issueDate", partialCreditNoteRequest.IssueDate.ToString(IssueDateFormat));

            writer.WritePropertyName("lines");
            JsonSerializer.Serialize(writer, partialCreditNoteRequest.Lines, jsonSerializerOptions);
            if (partialCreditNoteRequest.OurReferenceOption.IsSet)
                writer.WriteString("ourReference", partialCreditNoteRequest.OurReference);

            if (partialCreditNoteRequest.YourReferenceOption.IsSet)
                writer.WriteString("yourReference", partialCreditNoteRequest.YourReference);

            if (partialCreditNoteRequest.OrderReferenceOption.IsSet)
                writer.WriteString("orderReference", partialCreditNoteRequest.OrderReference);

            if (partialCreditNoteRequest.ProjectOption.IsSet)
                writer.WriteNumber("project", partialCreditNoteRequest.ProjectOption.Value!.Value);

            if (partialCreditNoteRequest.CurrencyOption.IsSet)
                writer.WriteString("currency", partialCreditNoteRequest.Currency);

            if (partialCreditNoteRequest.InvoiceIdOption.IsSet)
                writer.WriteNumber("invoiceId", partialCreditNoteRequest.InvoiceIdOption.Value!.Value);

            if (partialCreditNoteRequest.ContactIdOption.IsSet)
                writer.WriteNumber("contactId", partialCreditNoteRequest.ContactIdOption.Value!.Value);

            if (partialCreditNoteRequest.ContactPersonIdOption.IsSet)
                writer.WriteNumber("contactPersonId", partialCreditNoteRequest.ContactPersonIdOption.Value!.Value);

            if (partialCreditNoteRequest.CreditNoteTextOption.IsSet)
                writer.WriteString("creditNoteText", partialCreditNoteRequest.CreditNoteText);
        }
    }
}
