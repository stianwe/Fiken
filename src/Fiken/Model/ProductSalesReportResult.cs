...
namespace Fiken.Model
{
    ...
    /// </summary>
    public partial class ProductSalesReportResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductSalesReportResult" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ProductSalesReportResult(Option<Product?> product = default, Option<ProductSalesLineInfo?> sold = default, Option<ProductSalesLineInfo?> credited = default, Option<ProductSalesLineInfo?> sum = default)
        {
        ...
        /// <summary>
        /// Used to track the state of Sold
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ProductSalesLineInfo?> SoldOption { get; private set; }

        /// <summary>
        /// Gets or Sets Sold
        /// </summary>
        [JsonPropertyName("sold")]
        public ProductSalesLineInfo? Sold { get { return this.SoldOption; } set { this.SoldOption = new(value); } }

        /// <summary>
        /// Used to track the state of Credited
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ProductSalesLineInfo?> CreditedOption { get; private set; }

        /// <summary>
        /// Gets or Sets Credited
        /// </summary>
        [JsonPropertyName("credited")]
        public ProductSalesLineInfo? Credited { get { return this.CreditedOption; } set { this.CreditedOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ProductSalesLineInfo?> SumOption { get; private set; }

        /// <summary>
        /// Gets or Sets Sum
        /// </summary>
        [JsonPropertyName("sum")]
        public ProductSalesLineInfo? Sum { get { return this.SumOption; } set { this.SumOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProductSalesReportResult" />
    /// </summary>
    public class ProductSalesReportResultJsonConverter : JsonConverter<ProductSalesReportResult>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProductSalesReportResult" />
        /// </summary>
        ...
        public override ProductSalesReportResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ProductSalesLineInfo?> sold = default;
            Option<ProductSalesLineInfo?> credited = default;
            Option<ProductSalesLineInfo?> sum = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "sold":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                sold = new Option<ProductSalesLineInfo?>(JsonSerializer.Deserialize<ProductSalesLineInfo>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "credited":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                credited = new Option<ProductSalesLineInfo?>(JsonSerializer.Deserialize<ProductSalesLineInfo>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "sum":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                sum = new Option<ProductSalesLineInfo?>(JsonSerializer.Deserialize<ProductSalesLineInfo>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (product.IsSet && product.Value == null)
                throw new ArgumentNullException(nameof(product), "Property is not nullable for class ProductSalesReportResult.");

            if (sold.IsSet && sold.Value == null)
                throw new ArgumentNullException(nameof(sold), "Property is not nullable for class ProductSalesReportResult.");

            if (credited.IsSet && credited.Value == null)
                throw new ArgumentNullException(nameof(credited), "Property is not nullable for class ProductSalesReportResult.");

            if (sum.IsSet && sum.Value == null)
                throw new ArgumentNullException(nameof(sum), "Property is not nullable for class ProductSalesReportResult.");

            return new ProductSalesReportResult(product, sold, credited, sum);
        }

        /// <summary>
        /// Serializes a <see cref="ProductSalesReportResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="productSalesReportResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProductSalesReportResult productSalesReportResult, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, productSalesReportResult, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProductSalesReportResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="productSalesReportResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProductSalesReportResult productSalesReportResult, JsonSerializerOptions jsonSerializerOptions)
        {
            if (productSalesReportResult.ProductOption.IsSet && productSalesReportResult.Product == null)
                throw new ArgumentNullException(nameof(productSalesReportResult.Product), "Property is required for class ProductSalesReportResult.");

            if (productSalesReportResult.SoldOption.IsSet && productSalesReportResult.Sold == null)
                throw new ArgumentNullException(nameof(productSalesReportResult.Sold), "Property is required for class ProductSalesReportResult.");

            if (productSalesReportResult.CreditedOption.IsSet && productSalesReportResult.Credited == null)
                throw new ArgumentNullException(nameof(productSalesReportResult.Credited), "Property is required for class ProductSalesReportResult.");

            if (productSalesReportResult.SumOption.IsSet && productSalesReportResult.Sum == null)
                throw new ArgumentNullException(nameof(productSalesReportResult.Sum), "Property is required for class ProductSalesReportResult.");

            if (productSalesReportResult.ProductOption.IsSet)
            {
                writer.WritePropertyName("product");
                JsonSerializer.Serialize(writer, productSalesReportResult.Product, jsonSerializerOptions);
            }
            if (productSalesReportResult.SoldOption.IsSet)
            {
                writer.WritePropertyName("sold");
                JsonSerializer.Serialize(writer, productSalesReportResult.Sold, jsonSerializerOptions);
            }
            if (productSalesReportResult.CreditedOption.IsSet)
            {
                writer.WritePropertyName("credited");
                JsonSerializer.Serialize(writer, productSalesReportResult.Credited, jsonSerializerOptions);
            }
            if (productSalesReportResult.SumOption.IsSet)
            {
                writer.WritePropertyName("sum");
                JsonSerializer.Serialize(writer, productSalesReportResult.Sum, jsonSerializerOptions);
            }
        }
    }
}
