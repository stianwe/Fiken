...
namespace Fiken.Model
{
    ...
    public partial class Attachment : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="identifier">User-defined identifier for attachment. Could be the Invoice Id or receipt number for example.</param>
        /// <param name="downloadUrl">For use with API credentials (bearer token or oauth 2)</param>
        /// <param name="downloadUrlWithFikenNormalUserCredentials">Requires the user to login with username and password in Fiken.</param>
        /// <param name="comment">Field for additional information for this attachment.</param>
        /// <param name="type">type</param>
        [JsonConstructor]
        public Attachment(Option<string?> identifier = default, Option<string?> downloadUrl = default, Option<string?> downloadUrlWithFikenNormalUserCredentials = default, Option<string?> comment = default, Option<TypeEnum?> type = default)
        {
            IdentifierOption = identifier;
            DownloadUrlOption = downloadUrl;
            DownloadUrlWithFikenNormalUserCredentialsOption = downloadUrlWithFikenNormalUserCredentials;
        ...
        public static string TypeEnumToJsonValue(TypeEnum? value)
        {
            ...
            if (value == TypeEnum.Reminder)
                return "reminder";

            if (value == TypeEnum.Unspecified)
                return "unspecified";

            if (value == TypeEnum.Ocr)
                return "ocr";
        ...
        /// </summary>
        /// <value>For use with API credentials (bearer token or oauth 2)</value>
        [JsonPropertyName("downloadUrl")]
        public string? DownloadUrl { get { return this.DownloadUrlOption; } set { this.DownloadUrlOption = new(value); } }

        /// <summary>
        /// Used to track the state of DownloadUrlWithFikenNormalUserCredentials
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> DownloadUrlWithFikenNormalUserCredentialsOption { get; private set; }

        /// <summary>
        /// Requires the user to login with username and password in Fiken.
        /// </summary>
        /// <value>Requires the user to login with username and password in Fiken.</value>
        [JsonPropertyName("downloadUrlWithFikenNormalUserCredentials")]
        public string? DownloadUrlWithFikenNormalUserCredentials { get { return this.DownloadUrlWithFikenNormalUserCredentialsOption; } set { this.DownloadUrlWithFikenNormalUserCredentialsOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DownloadUrlWithFikenNormalUserCredentials: ").Append(DownloadUrlWithFikenNormalUserCredentials).Append("\n");
    ...
    public class AttachmentJsonConverter : JsonConverter<Attachment>
    {
        ...
        public override Attachment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> downloadUrlWithFikenNormalUserCredentials = default;
            Option<string?> comment = default;
            Option<Attachment.TypeEnum?> type = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "downloadUrlWithFikenNormalUserCredentials":
                            downloadUrlWithFikenNormalUserCredentials = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "comment":
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<Attachment.TypeEnum?>(Attachment.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (identifier.IsSet && identifier.Value == null)
                throw new ArgumentNullException(nameof(identifier), "Property is not nullable for class Attachment.");

            if (downloadUrl.IsSet && downloadUrl.Value == null)
                throw new ArgumentNullException(nameof(downloadUrl), "Property is not nullable for class Attachment.");

            if (downloadUrlWithFikenNormalUserCredentials.IsSet && downloadUrlWithFikenNormalUserCredentials.Value == null)
                throw new ArgumentNullException(nameof(downloadUrlWithFikenNormalUserCredentials), "Property is not nullable for class Attachment.");

            if (comment.IsSet && comment.Value == null)
                throw new ArgumentNullException(nameof(comment), "Property is not nullable for class Attachment.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class Attachment.");

            return new Attachment(identifier, downloadUrl, downloadUrlWithFikenNormalUserCredentials, comment, type);
        }
        ...
        {
            if (attachment.IdentifierOption.IsSet && attachment.Identifier == null)
                throw new ArgumentNullException(nameof(attachment.Identifier), "Property is required for class Attachment.");

            if (attachment.DownloadUrlOption.IsSet && attachment.DownloadUrl == null)
                throw new ArgumentNullException(nameof(attachment.DownloadUrl), "Property is required for class Attachment.");

            if (attachment.DownloadUrlWithFikenNormalUserCredentialsOption.IsSet && attachment.DownloadUrlWithFikenNormalUserCredentials == null)
                throw new ArgumentNullException(nameof(attachment.DownloadUrlWithFikenNormalUserCredentials), "Property is required for class Attachment.");

            if (attachment.CommentOption.IsSet && attachment.Comment == null)
                throw new ArgumentNullException(nameof(attachment.Comment), "Property is required for class Attachment.");

            if (attachment.IdentifierOption.IsSet)
                writer.WriteString("identifier", attachment.Identifier);

            if (attachment.DownloadUrlOption.IsSet)
                writer.WriteString("downloadUrl", attachment.DownloadUrl);

            if (attachment.DownloadUrlWithFikenNormalUserCredentialsOption.IsSet)
                writer.WriteString("downloadUrlWithFikenNormalUserCredentials", attachment.DownloadUrlWithFikenNormalUserCredentials);

            if (attachment.CommentOption.IsSet)
                writer.WriteString("comment", attachment.Comment);

            var typeRawValue = Attachment.TypeEnumToJsonValue(attachment.TypeOption.Value!.Value);
