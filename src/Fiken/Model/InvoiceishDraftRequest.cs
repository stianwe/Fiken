...
namespace Fiken.Model
{
    ...
    /// </summary>
    public partial class InvoiceishDraftRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceishDraftRequest" /> class.
        /// </summary>
        ...
        /// <param name="invoiceText">Comment/description printed above the invoice lines. If not present, and standard text is registered, standard text is printed.</param>
        ...
        /// <param name="contactPersonId">Id of the contact person. Must be associated with the provided customer.</param>
        /// <param name="projectId">projectId</param>
        [JsonConstructor]
        public InvoiceishDraftRequest(TypeEnum type, int daysUntilDueDate, long customerId, Option<string?> uuid = default, Option<DateOnly?> issueDate = default, Option<string?> invoiceText = default, Option<string?> yourReference = default, Option<string?> ourReference = default, Option<string?> orderReference = default, Option<List<InvoiceishDraftLine>?> lines = default, Option<string?> currency = default, Option<string?> bankAccountNumber = default, Option<string?> iban = default, Option<string?> bic = default, Option<string?> paymentAccount = default, Option<long?> contactPersonId = default, Option<long?> projectId = default)
        {
            Type = type;
        ...
        /// </summary>
        /// <value>Comment/description printed above the invoice lines. If not present, and standard text is registered, standard text is printed.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="InvoiceishDraftRequest" />
    /// </summary>
    public class InvoiceishDraftRequestJsonConverter : JsonConverter<InvoiceishDraftRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="InvoiceishDraftRequest" />
        /// </summary>
        ...
        public override InvoiceishDraftRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<InvoiceishDraftRequest.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<InvoiceishDraftRequest.TypeEnum?>(InvoiceishDraftRequest.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
            ...
            if (!type.IsSet)
                throw new ArgumentException("Property is required for class InvoiceishDraftRequest.", nameof(type));

            if (!daysUntilDueDate.IsSet)
                throw new ArgumentException("Property is required for class InvoiceishDraftRequest.", nameof(daysUntilDueDate));

            if (!customerId.IsSet)
                throw new ArgumentException("Property is required for class InvoiceishDraftRequest.", nameof(customerId));

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class InvoiceishDraftRequest.");

            if (daysUntilDueDate.IsSet && daysUntilDueDate.Value == null)
                throw new ArgumentNullException(nameof(daysUntilDueDate), "Property is not nullable for class InvoiceishDraftRequest.");

            if (customerId.IsSet && customerId.Value == null)
                throw new ArgumentNullException(nameof(customerId), "Property is not nullable for class InvoiceishDraftRequest.");

            if (uuid.IsSet && uuid.Value == null)
                throw new ArgumentNullException(nameof(uuid), "Property is not nullable for class InvoiceishDraftRequest.");

            if (issueDate.IsSet && issueDate.Value == null)
                throw new ArgumentNullException(nameof(issueDate), "Property is not nullable for class InvoiceishDraftRequest.");

            if (invoiceText.IsSet && invoiceText.Value == null)
                throw new ArgumentNullException(nameof(invoiceText), "Property is not nullable for class InvoiceishDraftRequest.");

            if (yourReference.IsSet && yourReference.Value == null)
                throw new ArgumentNullException(nameof(yourReference), "Property is not nullable for class InvoiceishDraftRequest.");

            if (ourReference.IsSet && ourReference.Value == null)
                throw new ArgumentNullException(nameof(ourReference), "Property is not nullable for class InvoiceishDraftRequest.");

            if (orderReference.IsSet && orderReference.Value == null)
                throw new ArgumentNullException(nameof(orderReference), "Property is not nullable for class InvoiceishDraftRequest.");

            if (lines.IsSet && lines.Value == null)
                throw new ArgumentNullException(nameof(lines), "Property is not nullable for class InvoiceishDraftRequest.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class InvoiceishDraftRequest.");

            if (bankAccountNumber.IsSet && bankAccountNumber.Value == null)
                throw new ArgumentNullException(nameof(bankAccountNumber), "Property is not nullable for class InvoiceishDraftRequest.");

            if (iban.IsSet && iban.Value == null)
                throw new ArgumentNullException(nameof(iban), "Property is not nullable for class InvoiceishDraftRequest.");

            if (bic.IsSet && bic.Value == null)
                throw new ArgumentNullException(nameof(bic), "Property is not nullable for class InvoiceishDraftRequest.");

            if (paymentAccount.IsSet && paymentAccount.Value == null)
                throw new ArgumentNullException(nameof(paymentAccount), "Property is not nullable for class InvoiceishDraftRequest.");

            if (contactPersonId.IsSet && contactPersonId.Value == null)
                throw new ArgumentNullException(nameof(contactPersonId), "Property is not nullable for class InvoiceishDraftRequest.");

            if (projectId.IsSet && projectId.Value == null)
                throw new ArgumentNullException(nameof(projectId), "Property is not nullable for class InvoiceishDraftRequest.");

            return new InvoiceishDraftRequest(type.Value!.Value!, daysUntilDueDate.Value!.Value!, customerId.Value!.Value!, uuid, issueDate, invoiceText, yourReference, ourReference, orderReference, lines, currency, bankAccountNumber, iban, bic, paymentAccount, contactPersonId, projectId);
        }

        /// <summary>
        /// Serializes a <see cref="InvoiceishDraftRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="invoiceishDraftRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InvoiceishDraftRequest invoiceishDraftRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, invoiceishDraftRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InvoiceishDraftRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="invoiceishDraftRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InvoiceishDraftRequest invoiceishDraftRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (invoiceishDraftRequest.UuidOption.IsSet && invoiceishDraftRequest.Uuid == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.Uuid), "Property is required for class InvoiceishDraftRequest.");

            if (invoiceishDraftRequest.InvoiceTextOption.IsSet && invoiceishDraftRequest.InvoiceText == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.InvoiceText), "Property is required for class InvoiceishDraftRequest.");

            if (invoiceishDraftRequest.YourReferenceOption.IsSet && invoiceishDraftRequest.YourReference == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.YourReference), "Property is required for class InvoiceishDraftRequest.");

            if (invoiceishDraftRequest.OurReferenceOption.IsSet && invoiceishDraftRequest.OurReference == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.OurReference), "Property is required for class InvoiceishDraftRequest.");

            if (invoiceishDraftRequest.OrderReferenceOption.IsSet && invoiceishDraftRequest.OrderReference == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.OrderReference), "Property is required for class InvoiceishDraftRequest.");

            if (invoiceishDraftRequest.LinesOption.IsSet && invoiceishDraftRequest.Lines == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.Lines), "Property is required for class InvoiceishDraftRequest.");

            if (invoiceishDraftRequest.CurrencyOption.IsSet && invoiceishDraftRequest.Currency == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.Currency), "Property is required for class InvoiceishDraftRequest.");

            if (invoiceishDraftRequest.BankAccountNumberOption.IsSet && invoiceishDraftRequest.BankAccountNumber == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.BankAccountNumber), "Property is required for class InvoiceishDraftRequest.");

            if (invoiceishDraftRequest.IbanOption.IsSet && invoiceishDraftRequest.Iban == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.Iban), "Property is required for class InvoiceishDraftRequest.");

            if (invoiceishDraftRequest.BicOption.IsSet && invoiceishDraftRequest.Bic == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.Bic), "Property is required for class InvoiceishDraftRequest.");

            if (invoiceishDraftRequest.PaymentAccountOption.IsSet && invoiceishDraftRequest.PaymentAccount == null)
                throw new ArgumentNullException(nameof(invoiceishDraftRequest.PaymentAccount), "Property is required for class InvoiceishDraftRequest.");

            var typeRawValue = InvoiceishDraftRequest.TypeEnumToJsonValue(invoiceishDraftRequest.Type);
            writer.WriteString("type", typeRawValue);
            writer.WriteNumber("daysUntilDueDate", invoiceishDraftRequest.DaysUntilDueDate);

            writer.WriteNumber("customerId", invoiceishDraftRequest.CustomerId);

            if (invoiceishDraftRequest.UuidOption.IsSet)
                writer.WriteString("uuid", invoiceishDraftRequest.Uuid);

            if (invoiceishDraftRequest.IssueDateOption.IsSet)
                writer.WriteString("issueDate", invoiceishDraftRequest.IssueDateOption.Value!.Value.ToString(IssueDateFormat));

            if (invoiceishDraftRequest.InvoiceTextOption.IsSet)
                writer.WriteString("invoiceText", invoiceishDraftRequest.InvoiceText);

            if (invoiceishDraftRequest.YourReferenceOption.IsSet)
                writer.WriteString("yourReference", invoiceishDraftRequest.YourReference);

            if (invoiceishDraftRequest.OurReferenceOption.IsSet)
                writer.WriteString("ourReference", invoiceishDraftRequest.OurReference);

            if (invoiceishDraftRequest.OrderReferenceOption.IsSet)
                writer.WriteString("orderReference", invoiceishDraftRequest.OrderReference);

            if (invoiceishDraftRequest.LinesOption.IsSet)
            {
                writer.WritePropertyName("lines");
                JsonSerializer.Serialize(writer, invoiceishDraftRequest.Lines, jsonSerializerOptions);
            }
            if (invoiceishDraftRequest.CurrencyOption.IsSet)
                writer.WriteString("currency", invoiceishDraftRequest.Currency);

            if (invoiceishDraftRequest.BankAccountNumberOption.IsSet)
                writer.WriteString("bankAccountNumber", invoiceishDraftRequest.BankAccountNumber);

            if (invoiceishDraftRequest.IbanOption.IsSet)
                writer.WriteString("iban", invoiceishDraftRequest.Iban);

            if (invoiceishDraftRequest.BicOption.IsSet)
                writer.WriteString("bic", invoiceishDraftRequest.Bic);

            if (invoiceishDraftRequest.PaymentAccountOption.IsSet)
                writer.WriteString("paymentAccount", invoiceishDraftRequest.PaymentAccount);

            if (invoiceishDraftRequest.ContactPersonIdOption.IsSet)
                writer.WriteNumber("contactPersonId", invoiceishDraftRequest.ContactPersonIdOption.Value!.Value);

            if (invoiceishDraftRequest.ProjectIdOption.IsSet)
                writer.WriteNumber("projectId", invoiceishDraftRequest.ProjectIdOption.Value!.Value);
        }
    }
}
