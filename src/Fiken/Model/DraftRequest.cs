...
namespace Fiken.Model
{
    ...
    /// DraftRequest
    /// </summary>
    public partial class DraftRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="projectId">Project ID if only 1 project associated with entire draft. It is also possible to specify the project on individual draft lines</param>
        ...
        [JsonConstructor]
        public DraftRequest(bool cash, List<DraftLineRequest> lines, Option<DateOnly?> invoiceIssueDate = default, Option<DateOnly?> dueDate = default, Option<string?> invoiceNumber = default, Option<long?> contactId = default, Option<long?> projectId = default, Option<string?> currency = default, Option<string?> kid = default, Option<bool?> paid = default, Option<List<Payment>?> payments = default)
        {
            Cash = cash;
            Lines = lines;
        ...
        /// </summary>
        /// <value>Project ID if only 1 project associated with entire draft. It is also possible to specify the project on individual draft lines</value>
        /* <example>2888156</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="DraftRequest" />
    /// </summary>
    public class DraftRequestJsonConverter : JsonConverter<DraftRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="DraftRequest" />
        /// </summary>
        ...
        public override DraftRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<DraftLineRequest>?> lines = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "lines":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                lines = new Option<List<DraftLineRequest>?>(JsonSerializer.Deserialize<List<DraftLineRequest>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
            ...
            if (!cash.IsSet)
                throw new ArgumentException("Property is required for class DraftRequest.", nameof(cash));

            if (!lines.IsSet)
                throw new ArgumentException("Property is required for class DraftRequest.", nameof(lines));

            if (cash.IsSet && cash.Value == null)
                throw new ArgumentNullException(nameof(cash), "Property is not nullable for class DraftRequest.");

            if (lines.IsSet && lines.Value == null)
                throw new ArgumentNullException(nameof(lines), "Property is not nullable for class DraftRequest.");

            if (invoiceIssueDate.IsSet && invoiceIssueDate.Value == null)
                throw new ArgumentNullException(nameof(invoiceIssueDate), "Property is not nullable for class DraftRequest.");

            if (dueDate.IsSet && dueDate.Value == null)
                throw new ArgumentNullException(nameof(dueDate), "Property is not nullable for class DraftRequest.");

            if (invoiceNumber.IsSet && invoiceNumber.Value == null)
                throw new ArgumentNullException(nameof(invoiceNumber), "Property is not nullable for class DraftRequest.");

            if (contactId.IsSet && contactId.Value == null)
                throw new ArgumentNullException(nameof(contactId), "Property is not nullable for class DraftRequest.");

            if (projectId.IsSet && projectId.Value == null)
                throw new ArgumentNullException(nameof(projectId), "Property is not nullable for class DraftRequest.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class DraftRequest.");

            if (kid.IsSet && kid.Value == null)
                throw new ArgumentNullException(nameof(kid), "Property is not nullable for class DraftRequest.");

            if (paid.IsSet && paid.Value == null)
                throw new ArgumentNullException(nameof(paid), "Property is not nullable for class DraftRequest.");

            if (payments.IsSet && payments.Value == null)
                throw new ArgumentNullException(nameof(payments), "Property is not nullable for class DraftRequest.");

            return new DraftRequest(cash.Value!.Value!, lines.Value!, invoiceIssueDate, dueDate, invoiceNumber, contactId, projectId, currency, kid, paid, payments);
        }

        /// <summary>
        /// Serializes a <see cref="DraftRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="draftRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DraftRequest draftRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, draftRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DraftRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="draftRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DraftRequest draftRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (draftRequest.Lines == null)
                throw new ArgumentNullException(nameof(draftRequest.Lines), "Property is required for class DraftRequest.");

            if (draftRequest.InvoiceNumberOption.IsSet && draftRequest.InvoiceNumber == null)
                throw new ArgumentNullException(nameof(draftRequest.InvoiceNumber), "Property is required for class DraftRequest.");

            if (draftRequest.CurrencyOption.IsSet && draftRequest.Currency == null)
                throw new ArgumentNullException(nameof(draftRequest.Currency), "Property is required for class DraftRequest.");

            if (draftRequest.KidOption.IsSet && draftRequest.Kid == null)
                throw new ArgumentNullException(nameof(draftRequest.Kid), "Property is required for class DraftRequest.");

            if (draftRequest.PaymentsOption.IsSet && draftRequest.Payments == null)
                throw new ArgumentNullException(nameof(draftRequest.Payments), "Property is required for class DraftRequest.");

            writer.WriteBoolean("cash", draftRequest.Cash);

            writer.WritePropertyName("lines");
            JsonSerializer.Serialize(writer, draftRequest.Lines, jsonSerializerOptions);
            if (draftRequest.InvoiceIssueDateOption.IsSet)
                writer.WriteString("invoiceIssueDate", draftRequest.InvoiceIssueDateOption.Value!.Value.ToString(InvoiceIssueDateFormat));

            if (draftRequest.DueDateOption.IsSet)
                writer.WriteString("dueDate", draftRequest.DueDateOption.Value!.Value.ToString(DueDateFormat));

            if (draftRequest.InvoiceNumberOption.IsSet)
                writer.WriteString("invoiceNumber", draftRequest.InvoiceNumber);

            if (draftRequest.ContactIdOption.IsSet)
                writer.WriteNumber("contactId", draftRequest.ContactIdOption.Value!.Value);

            if (draftRequest.ProjectIdOption.IsSet)
                writer.WriteNumber("projectId", draftRequest.ProjectIdOption.Value!.Value);

            if (draftRequest.CurrencyOption.IsSet)
                writer.WriteString("currency", draftRequest.Currency);

            if (draftRequest.KidOption.IsSet)
                writer.WriteString("kid", draftRequest.Kid);

            if (draftRequest.PaidOption.IsSet)
                writer.WriteBoolean("paid", draftRequest.PaidOption.Value!.Value);

            if (draftRequest.PaymentsOption.IsSet)
            {
                writer.WritePropertyName("payments");
                JsonSerializer.Serialize(writer, draftRequest.Payments, jsonSerializerOptions);
            }
        }
    }
}
