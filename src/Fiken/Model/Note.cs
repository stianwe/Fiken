...
namespace Fiken.Model
{
    ...
    public partial class Note : IValidatableObject
    {
        ...
        /// <param name="varNote">varNote</param>
        [JsonConstructor]
        public Note(Option<string?> author = default, Option<string?> varNote = default)
        {
            AuthorOption = author;
            VarNoteOption = varNote;
            OnCreated();
        }
        ...
        /// Gets or Sets Author
        /// </summary>
        /* <example>James Jones</example> */
        [JsonPropertyName("author")]
        public string? Author { get { return this.AuthorOption; } set { this.AuthorOption = new(value); } }

        /// <summary>
        /// Used to track the state of VarNote
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> VarNoteOption { get; private set; }

        /// <summary>
        /// Gets or Sets VarNote
        /// </summary>
        /* <example>Invoice sent after telephone conversation with customer</example> */
        [JsonPropertyName("note")]
        public string? VarNote { get { return this.VarNoteOption; } set { this.VarNoteOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarNote: ").Append(VarNote).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    public class NoteJsonConverter : JsonConverter<Note>
    {
        ...
        public override Note Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "author":
                            ...
                            break;
                        case "note":
                            varNote = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        default:
                            break;
                    }
            ...
            if (author.IsSet && author.Value == null)
                throw new ArgumentNullException(nameof(author), "Property is not nullable for class Note.");

            if (varNote.IsSet && varNote.Value == null)
                throw new ArgumentNullException(nameof(varNote), "Property is not nullable for class Note.");

            return new Note(author, varNote);
        }
        ...
        {
            if (note.AuthorOption.IsSet && note.Author == null)
                throw new ArgumentNullException(nameof(note.Author), "Property is required for class Note.");

            if (note.VarNoteOption.IsSet && note.VarNote == null)
                throw new ArgumentNullException(nameof(note.VarNote), "Property is required for class Note.");

            if (note.AuthorOption.IsSet)
                writer.WriteString("author", note.Author);

            if (note.VarNoteOption.IsSet)
                writer.WriteString("note", note.VarNote);
        }
    }
}
