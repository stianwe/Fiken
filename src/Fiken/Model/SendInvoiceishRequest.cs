...
namespace Fiken.Model
{
    ...
    /// </summary>
    public partial class SendInvoiceishRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendInvoiceishRequest" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SendInvoiceishRequest(List<SendInvoiceishRequest.MethodEnum> method, bool includeDocumentAttachments = true, Option<string?> recipientName = default, Option<string?> recipientEmail = default, Option<string?> message = default, Option<EmailSendOptionEnum?> emailSendOption = default, Option<bool?> mergeInvoiceAndAttachments = default, Option<string?> organizationNumber = default, Option<string?> mobileNumber = default)
        {
            Method = method;
        ...
        public List<SendInvoiceishRequest.MethodEnum> Method { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SendInvoiceishRequest {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="SendInvoiceishRequest" />
    /// </summary>
    public class SendInvoiceishRequestJsonConverter : JsonConverter<SendInvoiceishRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="SendInvoiceishRequest" />
        /// </summary>
        ...
        public override SendInvoiceishRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<SendInvoiceishRequest.MethodEnum>?> method = default;
            ...
            Option<SendInvoiceishRequest.EmailSendOptionEnum?> emailSendOption = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "method":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                method = new Option<List<SendInvoiceishRequest.MethodEnum>?>(JsonSerializer.Deserialize<List<SendInvoiceishRequest.MethodEnum>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        ...
                        case "emailSendOption":
                            ...
                            if (emailSendOptionRawValue != null)
                                emailSendOption = new Option<SendInvoiceishRequest.EmailSendOptionEnum?>(SendInvoiceishRequest.EmailSendOptionEnumFromStringOrDefault(emailSendOptionRawValue));
                            break;
            ...
            if (!method.IsSet)
                throw new ArgumentException("Property is required for class SendInvoiceishRequest.", nameof(method));

            if (!includeDocumentAttachments.IsSet)
                throw new ArgumentException("Property is required for class SendInvoiceishRequest.", nameof(includeDocumentAttachments));

            if (method.IsSet && method.Value == null)
                throw new ArgumentNullException(nameof(method), "Property is not nullable for class SendInvoiceishRequest.");

            if (includeDocumentAttachments.IsSet && includeDocumentAttachments.Value == null)
                throw new ArgumentNullException(nameof(includeDocumentAttachments), "Property is not nullable for class SendInvoiceishRequest.");

            if (recipientName.IsSet && recipientName.Value == null)
                throw new ArgumentNullException(nameof(recipientName), "Property is not nullable for class SendInvoiceishRequest.");

            if (recipientEmail.IsSet && recipientEmail.Value == null)
                throw new ArgumentNullException(nameof(recipientEmail), "Property is not nullable for class SendInvoiceishRequest.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class SendInvoiceishRequest.");

            if (emailSendOption.IsSet && emailSendOption.Value == null)
                throw new ArgumentNullException(nameof(emailSendOption), "Property is not nullable for class SendInvoiceishRequest.");

            if (mergeInvoiceAndAttachments.IsSet && mergeInvoiceAndAttachments.Value == null)
                throw new ArgumentNullException(nameof(mergeInvoiceAndAttachments), "Property is not nullable for class SendInvoiceishRequest.");

            if (organizationNumber.IsSet && organizationNumber.Value == null)
                throw new ArgumentNullException(nameof(organizationNumber), "Property is not nullable for class SendInvoiceishRequest.");

            if (mobileNumber.IsSet && mobileNumber.Value == null)
                throw new ArgumentNullException(nameof(mobileNumber), "Property is not nullable for class SendInvoiceishRequest.");

            return new SendInvoiceishRequest(method.Value!, includeDocumentAttachments.Value!.Value!, recipientName, recipientEmail, message, emailSendOption, mergeInvoiceAndAttachments, organizationNumber, mobileNumber);
        }

        /// <summary>
        /// Serializes a <see cref="SendInvoiceishRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendInvoiceishRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SendInvoiceishRequest sendInvoiceishRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sendInvoiceishRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SendInvoiceishRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendInvoiceishRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SendInvoiceishRequest sendInvoiceishRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sendInvoiceishRequest.Method == null)
                throw new ArgumentNullException(nameof(sendInvoiceishRequest.Method), "Property is required for class SendInvoiceishRequest.");

            if (sendInvoiceishRequest.RecipientNameOption.IsSet && sendInvoiceishRequest.RecipientName == null)
                throw new ArgumentNullException(nameof(sendInvoiceishRequest.RecipientName), "Property is required for class SendInvoiceishRequest.");

            if (sendInvoiceishRequest.RecipientEmailOption.IsSet && sendInvoiceishRequest.RecipientEmail == null)
                throw new ArgumentNullException(nameof(sendInvoiceishRequest.RecipientEmail), "Property is required for class SendInvoiceishRequest.");

            if (sendInvoiceishRequest.MessageOption.IsSet && sendInvoiceishRequest.Message == null)
                throw new ArgumentNullException(nameof(sendInvoiceishRequest.Message), "Property is required for class SendInvoiceishRequest.");

            if (sendInvoiceishRequest.OrganizationNumberOption.IsSet && sendInvoiceishRequest.OrganizationNumber == null)
                throw new ArgumentNullException(nameof(sendInvoiceishRequest.OrganizationNumber), "Property is required for class SendInvoiceishRequest.");

            if (sendInvoiceishRequest.MobileNumberOption.IsSet && sendInvoiceishRequest.MobileNumber == null)
                throw new ArgumentNullException(nameof(sendInvoiceishRequest.MobileNumber), "Property is required for class SendInvoiceishRequest.");

            writer.WritePropertyName("method");
            JsonSerializer.Serialize(writer, sendInvoiceishRequest.Method, jsonSerializerOptions);
            writer.WriteBoolean("includeDocumentAttachments", sendInvoiceishRequest.IncludeDocumentAttachments);

            if (sendInvoiceishRequest.RecipientNameOption.IsSet)
                writer.WriteString("recipientName", sendInvoiceishRequest.RecipientName);

            if (sendInvoiceishRequest.RecipientEmailOption.IsSet)
                writer.WriteString("recipientEmail", sendInvoiceishRequest.RecipientEmail);

            if (sendInvoiceishRequest.MessageOption.IsSet)
                writer.WriteString("message", sendInvoiceishRequest.Message);

            var emailSendOptionRawValue = SendInvoiceishRequest.EmailSendOptionEnumToJsonValue(sendInvoiceishRequest.EmailSendOptionOption.Value!.Value);
            writer.WriteString("emailSendOption", emailSendOptionRawValue);
            if (sendInvoiceishRequest.MergeInvoiceAndAttachmentsOption.IsSet)
                writer.WriteBoolean("mergeInvoiceAndAttachments", sendInvoiceishRequest.MergeInvoiceAndAttachmentsOption.Value!.Value);

            if (sendInvoiceishRequest.OrganizationNumberOption.IsSet)
                writer.WriteString("organizationNumber", sendInvoiceishRequest.OrganizationNumber);

            if (sendInvoiceishRequest.MobileNumberOption.IsSet)
                writer.WriteString("mobileNumber", sendInvoiceishRequest.MobileNumber);
        }
    }
}
