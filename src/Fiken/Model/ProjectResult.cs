...
namespace Fiken.Model
{
    ...
    /// ProjectResult
    /// </summary>
    public partial class ProjectResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectResult" /> class.
        /// </summary>
        /// <param name="projectId">projectId</param>
        /// <param name="number">number</param>
        /// <param name="name">name</param>
        /// <param name="description">description</param>
        /// <param name="startDate">Start date for the project, inclusive, format yyyy-mm-dd</param>
        /// <param name="endDate">End date for the project, inclusive, format yyyy-mm-dd</param>
        /// <param name="contact">contact</param>
        /// <param name="completed">Whether the project is completed or not.</param>
        [JsonConstructor]
        public ProjectResult(Option<long?> projectId = default, Option<string?> number = default, Option<string?> name = default, Option<string?> description = default, Option<DateOnly?> startDate = default, Option<DateOnly?> endDate = default, Option<Contact?> contact = default, Option<bool?> completed = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> NumberOption { get; }

        /// <summary>
        /// Gets or Sets Number
        /// </summary>
        [JsonPropertyName("number")]
        public string? Number { get { return this.NumberOption; } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProjectResult" />
    /// </summary>
    public class ProjectResultJsonConverter : JsonConverter<ProjectResult>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ProjectResult" />
        /// </summary>
        ...
        public override ProjectResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (projectId.IsSet && projectId.Value == null)
                throw new ArgumentNullException(nameof(projectId), "Property is not nullable for class ProjectResult.");

            if (number.IsSet && number.Value == null)
                throw new ArgumentNullException(nameof(number), "Property is not nullable for class ProjectResult.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ProjectResult.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class ProjectResult.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class ProjectResult.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class ProjectResult.");

            if (contact.IsSet && contact.Value == null)
                throw new ArgumentNullException(nameof(contact), "Property is not nullable for class ProjectResult.");

            if (completed.IsSet && completed.Value == null)
                throw new ArgumentNullException(nameof(completed), "Property is not nullable for class ProjectResult.");

            return new ProjectResult(projectId, number, name, description, startDate, endDate, contact, completed);
        }

        /// <summary>
        /// Serializes a <see cref="ProjectResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProjectResult projectResult, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, projectResult, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProjectResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProjectResult projectResult, JsonSerializerOptions jsonSerializerOptions)
        {
            if (projectResult.NumberOption.IsSet && projectResult.Number == null)
                throw new ArgumentNullException(nameof(projectResult.Number), "Property is required for class ProjectResult.");

            if (projectResult.NameOption.IsSet && projectResult.Name == null)
                throw new ArgumentNullException(nameof(projectResult.Name), "Property is required for class ProjectResult.");

            if (projectResult.DescriptionOption.IsSet && projectResult.Description == null)
                throw new ArgumentNullException(nameof(projectResult.Description), "Property is required for class ProjectResult.");

            if (projectResult.ContactOption.IsSet && projectResult.Contact == null)
                throw new ArgumentNullException(nameof(projectResult.Contact), "Property is required for class ProjectResult.");

            if (projectResult.ProjectIdOption.IsSet)
                writer.WriteNumber("projectId", projectResult.ProjectIdOption.Value!.Value);

            if (projectResult.NumberOption.IsSet)
                writer.WriteString("number", projectResult.Number);

            if (projectResult.NameOption.IsSet)
                writer.WriteString("name", projectResult.Name);

            if (projectResult.DescriptionOption.IsSet)
                writer.WriteString("description", projectResult.Description);

            if (projectResult.StartDateOption.IsSet)
                writer.WriteString("startDate", projectResult.StartDateOption.Value!.Value.ToString(StartDateFormat));

            if (projectResult.EndDateOption.IsSet)
                writer.WriteString("endDate", projectResult.EndDateOption.Value!.Value.ToString(EndDateFormat));

            if (projectResult.ContactOption.IsSet)
            {
                writer.WritePropertyName("contact");
                JsonSerializer.Serialize(writer, projectResult.Contact, jsonSerializerOptions);
            }
            if (projectResult.CompletedOption.IsSet)
                writer.WriteBoolean("completed", projectResult.CompletedOption.Value!.Value);
        }
    }
}
