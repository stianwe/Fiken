...
namespace Fiken.Model
{
    ...
    /// DraftLineRequest
    /// </summary>
    public partial class DraftLineRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DraftLineRequest" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public DraftLineRequest(string text, string vatType, string incomeAccount, long net, long gross, Option<long?> projectId = default)
        {
            Text = text;
            VatType = vatType;
    ...
    /// <summary>
    /// A Json converter for type <see cref="DraftLineRequest" />
    /// </summary>
    public class DraftLineRequestJsonConverter : JsonConverter<DraftLineRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="DraftLineRequest" />
        /// </summary>
        ...
        public override DraftLineRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!text.IsSet)
                throw new ArgumentException("Property is required for class DraftLineRequest.", nameof(text));

            if (!vatType.IsSet)
                throw new ArgumentException("Property is required for class DraftLineRequest.", nameof(vatType));

            if (!incomeAccount.IsSet)
                throw new ArgumentException("Property is required for class DraftLineRequest.", nameof(incomeAccount));

            if (!net.IsSet)
                throw new ArgumentException("Property is required for class DraftLineRequest.", nameof(net));

            if (!gross.IsSet)
                throw new ArgumentException("Property is required for class DraftLineRequest.", nameof(gross));

            if (text.IsSet && text.Value == null)
                throw new ArgumentNullException(nameof(text), "Property is not nullable for class DraftLineRequest.");

            if (vatType.IsSet && vatType.Value == null)
                throw new ArgumentNullException(nameof(vatType), "Property is not nullable for class DraftLineRequest.");

            if (incomeAccount.IsSet && incomeAccount.Value == null)
                throw new ArgumentNullException(nameof(incomeAccount), "Property is not nullable for class DraftLineRequest.");

            if (net.IsSet && net.Value == null)
                throw new ArgumentNullException(nameof(net), "Property is not nullable for class DraftLineRequest.");

            if (gross.IsSet && gross.Value == null)
                throw new ArgumentNullException(nameof(gross), "Property is not nullable for class DraftLineRequest.");

            if (projectId.IsSet && projectId.Value == null)
                throw new ArgumentNullException(nameof(projectId), "Property is not nullable for class DraftLineRequest.");

            return new DraftLineRequest(text.Value!, vatType.Value!, incomeAccount.Value!, net.Value!.Value!, gross.Value!.Value!, projectId);
        }

        /// <summary>
        /// Serializes a <see cref="DraftLineRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="draftLineRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DraftLineRequest draftLineRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, draftLineRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DraftLineRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="draftLineRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DraftLineRequest draftLineRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (draftLineRequest.Text == null)
                throw new ArgumentNullException(nameof(draftLineRequest.Text), "Property is required for class DraftLineRequest.");

            if (draftLineRequest.VatType == null)
                throw new ArgumentNullException(nameof(draftLineRequest.VatType), "Property is required for class DraftLineRequest.");

            if (draftLineRequest.IncomeAccount == null)
                throw new ArgumentNullException(nameof(draftLineRequest.IncomeAccount), "Property is required for class DraftLineRequest.");

            writer.WriteString("text", draftLineRequest.Text);

            writer.WriteString("vatType", draftLineRequest.VatType);

            writer.WriteString("incomeAccount", draftLineRequest.IncomeAccount);

            writer.WriteNumber("net", draftLineRequest.Net);

            writer.WriteNumber("gross", draftLineRequest.Gross);

            if (draftLineRequest.ProjectIdOption.IsSet)
                writer.WriteNumber("projectId", draftLineRequest.ProjectIdOption.Value!.Value);
        }
    }
}
