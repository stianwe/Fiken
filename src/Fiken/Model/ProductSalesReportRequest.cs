...
namespace Fiken.Model
{
    ...
    /// </summary>
    public partial class ProductSalesReportRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductSalesReportRequest" /> class.
        /// </summary>
        /// <param name="from">Start date range for the report, inclusive, format yyyy-mm-dd</param>
        /// <param name="to">End date range for the report, inclusive, format yyyy-mm-dd</param>
        [JsonConstructor]
        public ProductSalesReportRequest(DateOnly from, DateOnly to)
        {
            From = from;
            To = to;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProductSalesReportRequest" />
    /// </summary>
    public class ProductSalesReportRequestJsonConverter : JsonConverter<ProductSalesReportRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ProductSalesReportRequest" />
        /// </summary>
        ...
        public override ProductSalesReportRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!from.IsSet)
                throw new ArgumentException("Property is required for class ProductSalesReportRequest.", nameof(from));

            if (!to.IsSet)
                throw new ArgumentException("Property is required for class ProductSalesReportRequest.", nameof(to));

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ProductSalesReportRequest.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ProductSalesReportRequest.");

            return new ProductSalesReportRequest(from.Value!.Value!, to.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="ProductSalesReportRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="productSalesReportRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProductSalesReportRequest productSalesReportRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, productSalesReportRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProductSalesReportRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="productSalesReportRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProductSalesReportRequest productSalesReportRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("from", productSalesReportRequest.From.ToString(FromFormat));

            writer.WriteString("to", productSalesReportRequest.To.ToString(ToFormat));
        }
    }
}
