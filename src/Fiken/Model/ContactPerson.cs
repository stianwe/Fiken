...
namespace Fiken.Model
{
    ...
    public partial class ContactPerson : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ContactPerson(string name, string email, Option<long?> contactPersonId = default, Option<string?> phoneNumber = default, Option<Address?> address = default)
        {
            Name = name;
            Email = email;
        ...
        public Option<long?> ContactPersonIdOption { get; }
        ...
        public long? ContactPersonId { get { return this.ContactPersonIdOption; } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ContactPerson" />
    /// </summary>
    public class ContactPersonJsonConverter : JsonConverter<ContactPerson>
    {
        /// <summary>
        /// Deserializes json to <see cref="ContactPerson" />
        /// </summary>
        ...
        public override ContactPerson Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class ContactPerson.", nameof(name));

            if (!email.IsSet)
                throw new ArgumentException("Property is required for class ContactPerson.", nameof(email));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ContactPerson.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class ContactPerson.");

            if (contactPersonId.IsSet && contactPersonId.Value == null)
                throw new ArgumentNullException(nameof(contactPersonId), "Property is not nullable for class ContactPerson.");

            if (phoneNumber.IsSet && phoneNumber.Value == null)
                throw new ArgumentNullException(nameof(phoneNumber), "Property is not nullable for class ContactPerson.");

            if (address.IsSet && address.Value == null)
                throw new ArgumentNullException(nameof(address), "Property is not nullable for class ContactPerson.");

            return new ContactPerson(name.Value!, email.Value!, contactPersonId, phoneNumber, address);
        }

        /// <summary>
        /// Serializes a <see cref="ContactPerson" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="contactPerson"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ContactPerson contactPerson, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, contactPerson, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ContactPerson" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="contactPerson"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ContactPerson contactPerson, JsonSerializerOptions jsonSerializerOptions)
        {
            if (contactPerson.Name == null)
                throw new ArgumentNullException(nameof(contactPerson.Name), "Property is required for class ContactPerson.");

            if (contactPerson.Email == null)
                throw new ArgumentNullException(nameof(contactPerson.Email), "Property is required for class ContactPerson.");

            if (contactPerson.PhoneNumberOption.IsSet && contactPerson.PhoneNumber == null)
                throw new ArgumentNullException(nameof(contactPerson.PhoneNumber), "Property is required for class ContactPerson.");

            if (contactPerson.AddressOption.IsSet && contactPerson.Address == null)
                throw new ArgumentNullException(nameof(contactPerson.Address), "Property is required for class ContactPerson.");

            writer.WriteString("name", contactPerson.Name);

            writer.WriteString("email", contactPerson.Email);

            if (contactPerson.ContactPersonIdOption.IsSet)
                writer.WriteNumber("contactPersonId", contactPerson.ContactPersonIdOption.Value!.Value);

            if (contactPerson.PhoneNumberOption.IsSet)
                writer.WriteString("phoneNumber", contactPerson.PhoneNumber);

            if (contactPerson.AddressOption.IsSet)
            {
                writer.WritePropertyName("address");
                JsonSerializer.Serialize(writer, contactPerson.Address, jsonSerializerOptions);
            }
        }
    }
}
