...
namespace Fiken.Model
{
    ...
    public partial class Account : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Account(Option<string?> code = default, Option<string?> name = default)
        {
            CodeOption = code;
            NameOption = name;
            OnCreated();
    ...
    public class AccountJsonConverter : JsonConverter<Account>
    {
        ...
        public override Account Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (code.IsSet && code.Value == null)
                throw new ArgumentNullException(nameof(code), "Property is not nullable for class Account.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class Account.");

            return new Account(code, name);
        }
        ...
        {
            if (account.CodeOption.IsSet && account.Code == null)
                throw new ArgumentNullException(nameof(account.Code), "Property is required for class Account.");

            if (account.NameOption.IsSet && account.Name == null)
                throw new ArgumentNullException(nameof(account.Name), "Property is required for class Account.");

            if (account.CodeOption.IsSet)
