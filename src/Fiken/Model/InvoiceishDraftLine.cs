...
namespace Fiken.Model
{
    ...
    /// InvoiceishDraftLine
    /// </summary>
    public partial class InvoiceishDraftLine : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceishDraftLine" /> class.
        /// </summary>
        /// <param name="quantity">Number of units to be invoiced.</param>
        /// <param name="invoiceishDraftLineId">Unique draft line ID</param>
        /// <param name="lastModifiedDate">Date that the draft line was last modified in Fiken, format yyyy-mm-dd.</param>
        /// <param name="productId">Product to be credited/debited on invoice draft line.</param>
        ...
        /// <param name="discount">Percentage discount charged on invoice draft line. Should be a value between 0 and 100. Can be decimal values such as 25.5</param>
        ...
        [JsonConstructor]
        public InvoiceishDraftLine(decimal quantity, Option<long?> invoiceishDraftLineId = default, Option<DateOnly?> lastModifiedDate = default, Option<long?> productId = default, Option<string?> description = default, Option<long?> unitPrice = default, Option<string?> vatType = default, Option<decimal?> discount = default, Option<string?> comment = default, Option<string?> incomeAccount = default)
        {
            Quantity = quantity;
            InvoiceishDraftLineIdOption = invoiceishDraftLineId;
        ...
        /// <summary>
        /// Used to track the state of InvoiceishDraftLineId
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> InvoiceishDraftLineIdOption { get; private set; }

        /// <summary>
        /// Unique draft line ID
        /// </summary>
        /// <value>Unique draft line ID</value>
        /* <example>2888156</example> */
        [JsonPropertyName("invoiceishDraftLineId")]
        public long? InvoiceishDraftLineId { get { return this.InvoiceishDraftLineIdOption; } set { this.InvoiceishDraftLineIdOption = new(value); } }
        ...
        /// </summary>
        /// <value>Date that the draft line was last modified in Fiken, format yyyy-mm-dd.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvoiceishDraftLineId: ").Append(InvoiceishDraftLineId).Append("\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="InvoiceishDraftLine" />
    /// </summary>
    public class InvoiceishDraftLineJsonConverter : JsonConverter<InvoiceishDraftLine>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="InvoiceishDraftLine" />
        /// </summary>
        ...
        public override InvoiceishDraftLine Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<long?> invoiceishDraftLineId = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "invoiceishDraftLineId":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                invoiceishDraftLineId = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
            ...
            if (!quantity.IsSet)
                throw new ArgumentException("Property is required for class InvoiceishDraftLine.", nameof(quantity));

            if (quantity.IsSet && quantity.Value == null)
                throw new ArgumentNullException(nameof(quantity), "Property is not nullable for class InvoiceishDraftLine.");

            if (invoiceishDraftLineId.IsSet && invoiceishDraftLineId.Value == null)
                throw new ArgumentNullException(nameof(invoiceishDraftLineId), "Property is not nullable for class InvoiceishDraftLine.");

            if (lastModifiedDate.IsSet && lastModifiedDate.Value == null)
                throw new ArgumentNullException(nameof(lastModifiedDate), "Property is not nullable for class InvoiceishDraftLine.");

            if (productId.IsSet && productId.Value == null)
                throw new ArgumentNullException(nameof(productId), "Property is not nullable for class InvoiceishDraftLine.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class InvoiceishDraftLine.");

            if (unitPrice.IsSet && unitPrice.Value == null)
                throw new ArgumentNullException(nameof(unitPrice), "Property is not nullable for class InvoiceishDraftLine.");

            if (vatType.IsSet && vatType.Value == null)
                throw new ArgumentNullException(nameof(vatType), "Property is not nullable for class InvoiceishDraftLine.");

            if (discount.IsSet && discount.Value == null)
                throw new ArgumentNullException(nameof(discount), "Property is not nullable for class InvoiceishDraftLine.");

            if (comment.IsSet && comment.Value == null)
                throw new ArgumentNullException(nameof(comment), "Property is not nullable for class InvoiceishDraftLine.");

            if (incomeAccount.IsSet && incomeAccount.Value == null)
                throw new ArgumentNullException(nameof(incomeAccount), "Property is not nullable for class InvoiceishDraftLine.");

            return new InvoiceishDraftLine(quantity.Value!.Value!, invoiceishDraftLineId, lastModifiedDate, productId, description, unitPrice, vatType, discount, comment, incomeAccount);
        }

        /// <summary>
        /// Serializes a <see cref="InvoiceishDraftLine" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="invoiceishDraftLine"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InvoiceishDraftLine invoiceishDraftLine, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, invoiceishDraftLine, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InvoiceishDraftLine" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="invoiceishDraftLine"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InvoiceishDraftLine invoiceishDraftLine, JsonSerializerOptions jsonSerializerOptions)
        {
            if (invoiceishDraftLine.DescriptionOption.IsSet && invoiceishDraftLine.Description == null)
                throw new ArgumentNullException(nameof(invoiceishDraftLine.Description), "Property is required for class InvoiceishDraftLine.");

            if (invoiceishDraftLine.VatTypeOption.IsSet && invoiceishDraftLine.VatType == null)
                throw new ArgumentNullException(nameof(invoiceishDraftLine.VatType), "Property is required for class InvoiceishDraftLine.");

            if (invoiceishDraftLine.CommentOption.IsSet && invoiceishDraftLine.Comment == null)
                throw new ArgumentNullException(nameof(invoiceishDraftLine.Comment), "Property is required for class InvoiceishDraftLine.");

            if (invoiceishDraftLine.IncomeAccountOption.IsSet && invoiceishDraftLine.IncomeAccount == null)
                throw new ArgumentNullException(nameof(invoiceishDraftLine.IncomeAccount), "Property is required for class InvoiceishDraftLine.");

            writer.WriteNumber("quantity", invoiceishDraftLine.Quantity);

            if (invoiceishDraftLine.InvoiceishDraftLineIdOption.IsSet)
                writer.WriteNumber("invoiceishDraftLineId", invoiceishDraftLine.InvoiceishDraftLineIdOption.Value!.Value);

            if (invoiceishDraftLine.LastModifiedDateOption.IsSet)
                writer.WriteString("lastModifiedDate", invoiceishDraftLine.LastModifiedDateOption.Value!.Value.ToString(LastModifiedDateFormat));

            if (invoiceishDraftLine.ProductIdOption.IsSet)
                writer.WriteNumber("productId", invoiceishDraftLine.ProductIdOption.Value!.Value);

            if (invoiceishDraftLine.DescriptionOption.IsSet)
                writer.WriteString("description", invoiceishDraftLine.Description);

            if (invoiceishDraftLine.UnitPriceOption.IsSet)
                writer.WriteNumber("unitPrice", invoiceishDraftLine.UnitPriceOption.Value!.Value);

            if (invoiceishDraftLine.VatTypeOption.IsSet)
                writer.WriteString("vatType", invoiceishDraftLine.VatType);

            if (invoiceishDraftLine.DiscountOption.IsSet)
                writer.WriteNumber("discount", invoiceishDraftLine.DiscountOption.Value!.Value);

            if (invoiceishDraftLine.CommentOption.IsSet)
                writer.WriteString("comment", invoiceishDraftLine.Comment);

            if (invoiceishDraftLine.IncomeAccountOption.IsSet)
                writer.WriteString("incomeAccount", invoiceishDraftLine.IncomeAccount);
        }
    }
}
