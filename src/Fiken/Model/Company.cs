...
namespace Fiken.Model
{
    ...
    public partial class Company : IValidatableObject
    {
        ...
        /// <param name="slug">Formatted name of company. This is the companySlug that should be used in all URLs related to this company.</param>
        /// <param name="organizationNumber">Brreg organization number.</param>
        /// <param name="vatType">vatType</param>
        /// <param name="address">address</param>
        /// <param name="phoneNumber">phoneNumber</param>
        /// <param name="email">email</param>
        /// <param name="creationDate">creationDate</param>
        /// <param name="hasApiAccess">hasApiAccess</param>
        /// <param name="testCompany">Whether the company is a demo (true) or not</param>
        /// <param name="accountingStartDate">accountingStartDate</param>
        [JsonConstructor]
        public Company(Option<string?> name = default, Option<string?> slug = default, Option<string?> organizationNumber = default, Option<VatTypeEnum?> vatType = default, Option<Address?> address = default, Option<string?> phoneNumber = default, Option<string?> email = default, Option<DateOnly?> creationDate = default, Option<bool?> hasApiAccess = default, Option<bool?> testCompany = default, Option<DateOnly?> accountingStartDate = default)
        {
            NameOption = name;
            SlugOption = slug;
            ...
            HasApiAccessOption = hasApiAccess;
            TestCompanyOption = testCompany;
            AccountingStartDateOption = accountingStartDate;
            OnCreated();
        }
        ...
        /// <summary>
        /// Returns a <see cref="VatTypeEnum"/>
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static VatTypeEnum VatTypeEnumFromString(string value)
        {
            if (value.Equals("no"))
                return VatTypeEnum.No;

            if (value.Equals("yearly"))
                return VatTypeEnum.Yearly;

            if (value.Equals("monthly"))
                return VatTypeEnum.Monthly;

            if (value.Equals("bi-monthly"))
                return VatTypeEnum.BiMonthly;

            throw new NotImplementedException($"Could not convert value to type VatTypeEnum: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static VatTypeEnum? VatTypeEnumFromStringOrDefault(string value)
        {
            if (value.Equals("no"))
                return VatTypeEnum.No;
        ...
        /// <summary>
        /// Converts the <see cref="VatTypeEnum"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static string VatTypeEnumToJsonValue(VatTypeEnum? value)
        {
            if (value == VatTypeEnum.No)
                return "no";

            if (value == VatTypeEnum.Yearly)
                return "yearly";

            if (value == VatTypeEnum.Monthly)
                return "monthly";

            if (value == VatTypeEnum.BiMonthly)
                return "bi-monthly";
        ...
        public Option<VatTypeEnum?> VatTypeOption { get; private set; }

        /// <summary>
        /// Gets or Sets VatType
        /// </summary>
        [JsonPropertyName("vatType")]
        public VatTypeEnum? VatType { get { return this.VatTypeOption; } set { this.VatTypeOption = new(value); } }
        ...
        /* <example>Swagger test company</example> */
        ...
        /// </summary>
        /// <value>Formatted name of company. This is the companySlug that should be used in all URLs related to this company.</value>
        /* <example>swagger-test-company</example> */
        ...
        /// Gets or Sets Email
        /// </summary>
        /* <example>swaggertestcompany@fiken.gmail</example> */
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DateOnly?> CreationDateOption { get; private set; }

        /// <summary>
        /// Gets or Sets CreationDate
        /// </summary>
        /* <example>Wed Jan 01 01:00:00 CET 2025</example> */
        [JsonPropertyName("creationDate")]
        public DateOnly? CreationDate { get { return this.CreationDateOption; } set { this.CreationDateOption = new(value); } }

        /// <summary>
        /// Used to track the state of HasApiAccess
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> HasApiAccessOption { get; private set; }

        /// <summary>
        /// Gets or Sets HasApiAccess
        /// </summary>
        /* <example>true</example> */
        [JsonPropertyName("hasApiAccess")]
        public bool? HasApiAccess { get { return this.HasApiAccessOption; } set { this.HasApiAccessOption = new(value); } }

        /// <summary>
        /// Used to track the state of TestCompany
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> TestCompanyOption { get; private set; }

        /// <summary>
        /// Whether the company is a demo (true) or not
        /// </summary>
        /// <value>Whether the company is a demo (true) or not</value>
        [JsonPropertyName("testCompany")]
        public bool? TestCompany { get { return this.TestCompanyOption; } set { this.TestCompanyOption = new(value); } }

        /// <summary>
        /// Used to track the state of AccountingStartDate
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DateOnly?> AccountingStartDateOption { get; private set; }

        /// <summary>
        /// Gets or Sets AccountingStartDate
        /// </summary>
        /* <example>Wed Jan 01 01:00:00 CET 2025</example> */
        [JsonPropertyName("accountingStartDate")]
        public DateOnly? AccountingStartDate { get { return this.AccountingStartDateOption; } set { this.AccountingStartDateOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HasApiAccess: ").Append(HasApiAccess).Append("\n");
            sb.Append("  TestCompany: ").Append(TestCompany).Append("\n");
            sb.Append("  AccountingStartDate: ").Append(AccountingStartDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    public class CompanyJsonConverter : JsonConverter<Company>
    {
        ...
        /// </summary>
        public static string CreationDateFormat { get; set; } = "yyyy'-'MM'-'dd";

        /// <summary>
        /// The format to use to serialize AccountingStartDate
        /// </summary>
        public static string AccountingStartDateFormat { get; set; } = "yyyy'-'MM'-'dd";
        ...
        public override Company Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Company.VatTypeEnum?> vatType = default;
            Option<Address?> address = default;
            Option<string?> phoneNumber = default;
            Option<string?> email = default;
            Option<DateOnly?> creationDate = default;
            Option<bool?> hasApiAccess = default;
            Option<bool?> testCompany = default;
            Option<DateOnly?> accountingStartDate = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "organizationNumber":
                            ...
                            break;
                        case "vatType":
                            string? vatTypeRawValue = utf8JsonReader.GetString();
                            if (vatTypeRawValue != null)
                                vatType = new Option<Company.VatTypeEnum?>(Company.VatTypeEnumFromStringOrDefault(vatTypeRawValue));
                            break;
                        case "address":
                        ...
                        case "creationDate":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                creationDate = new Option<DateOnly?>(JsonSerializer.Deserialize<DateOnly>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "hasApiAccess":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                hasApiAccess = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "testCompany":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                testCompany = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "accountingStartDate":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                accountingStartDate = new Option<DateOnly?>(JsonSerializer.Deserialize<DateOnly>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (slug.IsSet && slug.Value == null)
                throw new ArgumentNullException(nameof(slug), "Property is not nullable for class Company.");

            if (organizationNumber.IsSet && organizationNumber.Value == null)
                throw new ArgumentNullException(nameof(organizationNumber), "Property is not nullable for class Company.");

            if (vatType.IsSet && vatType.Value == null)
                throw new ArgumentNullException(nameof(vatType), "Property is not nullable for class Company.");

            if (address.IsSet && address.Value == null)
                throw new ArgumentNullException(nameof(address), "Property is not nullable for class Company.");

            if (phoneNumber.IsSet && phoneNumber.Value == null)
                throw new ArgumentNullException(nameof(phoneNumber), "Property is not nullable for class Company.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class Company.");

            if (creationDate.IsSet && creationDate.Value == null)
                throw new ArgumentNullException(nameof(creationDate), "Property is not nullable for class Company.");

            if (hasApiAccess.IsSet && hasApiAccess.Value == null)
                throw new ArgumentNullException(nameof(hasApiAccess), "Property is not nullable for class Company.");

            if (testCompany.IsSet && testCompany.Value == null)
                throw new ArgumentNullException(nameof(testCompany), "Property is not nullable for class Company.");

            if (accountingStartDate.IsSet && accountingStartDate.Value == null)
                throw new ArgumentNullException(nameof(accountingStartDate), "Property is not nullable for class Company.");

            return new Company(name, slug, organizationNumber, vatType, address, phoneNumber, email, creationDate, hasApiAccess, testCompany, accountingStartDate);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Company company, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (company.SlugOption.IsSet && company.Slug == null)
                throw new ArgumentNullException(nameof(company.Slug), "Property is required for class Company.");

            if (company.OrganizationNumberOption.IsSet && company.OrganizationNumber == null)
                throw new ArgumentNullException(nameof(company.OrganizationNumber), "Property is required for class Company.");

            if (company.AddressOption.IsSet && company.Address == null)
                throw new ArgumentNullException(nameof(company.Address), "Property is required for class Company.");

            if (company.PhoneNumberOption.IsSet && company.PhoneNumber == null)
                throw new ArgumentNullException(nameof(company.PhoneNumber), "Property is required for class Company.");

            if (company.EmailOption.IsSet && company.Email == null)
                throw new ArgumentNullException(nameof(company.Email), "Property is required for class Company.");

            if (company.NameOption.IsSet)
                writer.WriteString("name", company.Name);

            if (company.SlugOption.IsSet)
                writer.WriteString("slug", company.Slug);

            if (company.OrganizationNumberOption.IsSet)
                writer.WriteString("organizationNumber", company.OrganizationNumber);

            var vatTypeRawValue = Company.VatTypeEnumToJsonValue(company.VatTypeOption.Value!.Value);
            writer.WriteString("vatType", vatTypeRawValue);
            if (company.AddressOption.IsSet)
            {
                writer.WritePropertyName("address");
                JsonSerializer.Serialize(writer, company.Address, jsonSerializerOptions);
            }
            if (company.PhoneNumberOption.IsSet)
                writer.WriteString("phoneNumber", company.PhoneNumber);

            if (company.EmailOption.IsSet)
                writer.WriteString("email", company.Email);

            if (company.CreationDateOption.IsSet)
                writer.WriteString("creationDate", company.CreationDateOption.Value!.Value.ToString(CreationDateFormat));

            if (company.HasApiAccessOption.IsSet)
                writer.WriteBoolean("hasApiAccess", company.HasApiAccessOption.Value!.Value);

            if (company.TestCompanyOption.IsSet)
                writer.WriteBoolean("testCompany", company.TestCompanyOption.Value!.Value);

            if (company.AccountingStartDateOption.IsSet)
                writer.WriteString("accountingStartDate", company.AccountingStartDateOption.Value!.Value.ToString(AccountingStartDateFormat));
        }
    }
}
