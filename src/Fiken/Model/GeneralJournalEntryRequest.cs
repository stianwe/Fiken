...
namespace Fiken.Model
{
    ...
    /// </summary>
    public partial class GeneralJournalEntryRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralJournalEntryRequest" /> class.
        /// </summary>
        ...
        /// <param name="open">The journal entry can be set to either open or closed (closed is the default). In the case of an open journal entry these can be deleted without creating a counter transaction. (default to false)</param>
        [JsonConstructor]
        public GeneralJournalEntryRequest(List<JournalEntry> journalEntries, Option<string?> description = default, Option<bool?> open = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<bool?> OpenOption { get; private set; }
        ...
        /// </summary>
        /// <value>The journal entry can be set to either open or closed (closed is the default). In the case of an open journal entry these can be deleted without creating a counter transaction.</value>
        /* <example>false</example> */
        [JsonPropertyName("open")]
        public bool? Open { get { return this.OpenOption; } set { this.OpenOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="GeneralJournalEntryRequest" />
    /// </summary>
    public class GeneralJournalEntryRequestJsonConverter : JsonConverter<GeneralJournalEntryRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="GeneralJournalEntryRequest" />
        /// </summary>
        ...
        public override GeneralJournalEntryRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<JournalEntry>?> journalEntries = default;
            Option<string?> description = default;
            Option<bool?> open = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "journalEntries":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                journalEntries = new Option<List<JournalEntry>?>(JsonSerializer.Deserialize<List<JournalEntry>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "description":
                        ...
                        case "open":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                open = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        default:
                            break;
                    }
            ...
            if (!journalEntries.IsSet)
                throw new ArgumentException("Property is required for class GeneralJournalEntryRequest.", nameof(journalEntries));

            if (journalEntries.IsSet && journalEntries.Value == null)
                throw new ArgumentNullException(nameof(journalEntries), "Property is not nullable for class GeneralJournalEntryRequest.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class GeneralJournalEntryRequest.");

            if (open.IsSet && open.Value == null)
                throw new ArgumentNullException(nameof(open), "Property is not nullable for class GeneralJournalEntryRequest.");

            return new GeneralJournalEntryRequest(journalEntries.Value!, description, open);
        }

        /// <summary>
        /// Serializes a <see cref="GeneralJournalEntryRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generalJournalEntryRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GeneralJournalEntryRequest generalJournalEntryRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, generalJournalEntryRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GeneralJournalEntryRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generalJournalEntryRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GeneralJournalEntryRequest generalJournalEntryRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (generalJournalEntryRequest.JournalEntries == null)
                throw new ArgumentNullException(nameof(generalJournalEntryRequest.JournalEntries), "Property is required for class GeneralJournalEntryRequest.");

            if (generalJournalEntryRequest.DescriptionOption.IsSet && generalJournalEntryRequest.Description == null)
                throw new ArgumentNullException(nameof(generalJournalEntryRequest.Description), "Property is required for class GeneralJournalEntryRequest.");

            writer.WritePropertyName("journalEntries");
            JsonSerializer.Serialize(writer, generalJournalEntryRequest.JournalEntries, jsonSerializerOptions);
            if (generalJournalEntryRequest.DescriptionOption.IsSet)
                writer.WriteString("description", generalJournalEntryRequest.Description);

            if (generalJournalEntryRequest.OpenOption.IsSet)
                writer.WriteBoolean("open", generalJournalEntryRequest.OpenOption.Value!.Value);
        }
    }
}
