...
namespace Fiken.Model
{
    ...
    /// InvoiceLineResult
    /// </summary>
    public partial class InvoiceLineResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceLineResult" /> class.
        /// </summary>
        ...
        /// <param name="netInNok">Net amount of invoice line in cents in NOK if currency and amounts provided are in foreign currency. This is calculated by Fiken.</param>
        /// <param name="vatInNok">VAT amount of invoice line in cents in NOK if currency and amounts provided are in foreign currency. This is calculated by Fiken.</param>
        /// <param name="grossInNok">Gross amount of invoice line in cents in NOK if currency and amounts provided are in foreign currency. This is calculated by Fiken.</param>
        ...
        /// <param name="unitPrice">Net price per unit in invoice currency (in cents).</param>
        ...
        /// <param name="productName">Name of product to be printed on invoice line.</param>
        /// <param name="description">Description of the invoiced product or service.</param>
        /// <param name="comment">Additional information to be printed on invoice.</param>
        /// <param name="incomeAccount">Field is similar to vatType, it defaults to the product&#39;s income account. Either the line or the product needs to have an income account set.</param>
        [JsonConstructor]
        public InvoiceLineResult(Option<long?> net = default, Option<long?> vat = default, Option<string?> vatType = default, Option<long?> gross = default, Option<long?> netInNok = default, Option<long?> vatInNok = default, Option<long?> grossInNok = default, Option<decimal?> vatInPercent = default, Option<long?> unitPrice = default, Option<decimal?> quantity = default, Option<decimal?> discount = default, Option<long?> productId = default, Option<string?> productName = default, Option<string?> description = default, Option<string?> comment = default, Option<string?> incomeAccount = default)
        {
            NetOption = net;
            VatOption = vat;
    ...
    /// <summary>
    /// A Json converter for type <see cref="InvoiceLineResult" />
    /// </summary>
    public class InvoiceLineResultJsonConverter : JsonConverter<InvoiceLineResult>
    {
        /// <summary>
        /// Deserializes json to <see cref="InvoiceLineResult" />
        /// </summary>
        ...
        public override InvoiceLineResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (net.IsSet && net.Value == null)
                throw new ArgumentNullException(nameof(net), "Property is not nullable for class InvoiceLineResult.");

            if (vat.IsSet && vat.Value == null)
                throw new ArgumentNullException(nameof(vat), "Property is not nullable for class InvoiceLineResult.");

            if (vatType.IsSet && vatType.Value == null)
                throw new ArgumentNullException(nameof(vatType), "Property is not nullable for class InvoiceLineResult.");

            if (gross.IsSet && gross.Value == null)
                throw new ArgumentNullException(nameof(gross), "Property is not nullable for class InvoiceLineResult.");

            if (netInNok.IsSet && netInNok.Value == null)
                throw new ArgumentNullException(nameof(netInNok), "Property is not nullable for class InvoiceLineResult.");

            if (vatInNok.IsSet && vatInNok.Value == null)
                throw new ArgumentNullException(nameof(vatInNok), "Property is not nullable for class InvoiceLineResult.");

            if (grossInNok.IsSet && grossInNok.Value == null)
                throw new ArgumentNullException(nameof(grossInNok), "Property is not nullable for class InvoiceLineResult.");

            if (vatInPercent.IsSet && vatInPercent.Value == null)
                throw new ArgumentNullException(nameof(vatInPercent), "Property is not nullable for class InvoiceLineResult.");

            if (unitPrice.IsSet && unitPrice.Value == null)
                throw new ArgumentNullException(nameof(unitPrice), "Property is not nullable for class InvoiceLineResult.");

            if (quantity.IsSet && quantity.Value == null)
                throw new ArgumentNullException(nameof(quantity), "Property is not nullable for class InvoiceLineResult.");

            if (discount.IsSet && discount.Value == null)
                throw new ArgumentNullException(nameof(discount), "Property is not nullable for class InvoiceLineResult.");

            if (productId.IsSet && productId.Value == null)
                throw new ArgumentNullException(nameof(productId), "Property is not nullable for class InvoiceLineResult.");

            if (productName.IsSet && productName.Value == null)
                throw new ArgumentNullException(nameof(productName), "Property is not nullable for class InvoiceLineResult.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class InvoiceLineResult.");

            if (comment.IsSet && comment.Value == null)
                throw new ArgumentNullException(nameof(comment), "Property is not nullable for class InvoiceLineResult.");

            if (incomeAccount.IsSet && incomeAccount.Value == null)
                throw new ArgumentNullException(nameof(incomeAccount), "Property is not nullable for class InvoiceLineResult.");

            return new InvoiceLineResult(net, vat, vatType, gross, netInNok, vatInNok, grossInNok, vatInPercent, unitPrice, quantity, discount, productId, productName, description, comment, incomeAccount);
        }

        /// <summary>
        /// Serializes a <see cref="InvoiceLineResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="invoiceLineResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InvoiceLineResult invoiceLineResult, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, invoiceLineResult, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InvoiceLineResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="invoiceLineResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InvoiceLineResult invoiceLineResult, JsonSerializerOptions jsonSerializerOptions)
        {
            if (invoiceLineResult.VatTypeOption.IsSet && invoiceLineResult.VatType == null)
                throw new ArgumentNullException(nameof(invoiceLineResult.VatType), "Property is required for class InvoiceLineResult.");

            if (invoiceLineResult.ProductNameOption.IsSet && invoiceLineResult.ProductName == null)
                throw new ArgumentNullException(nameof(invoiceLineResult.ProductName), "Property is required for class InvoiceLineResult.");

            if (invoiceLineResult.DescriptionOption.IsSet && invoiceLineResult.Description == null)
                throw new ArgumentNullException(nameof(invoiceLineResult.Description), "Property is required for class InvoiceLineResult.");

            if (invoiceLineResult.CommentOption.IsSet && invoiceLineResult.Comment == null)
                throw new ArgumentNullException(nameof(invoiceLineResult.Comment), "Property is required for class InvoiceLineResult.");

            if (invoiceLineResult.IncomeAccountOption.IsSet && invoiceLineResult.IncomeAccount == null)
                throw new ArgumentNullException(nameof(invoiceLineResult.IncomeAccount), "Property is required for class InvoiceLineResult.");

            if (invoiceLineResult.NetOption.IsSet)
                writer.WriteNumber("net", invoiceLineResult.NetOption.Value!.Value);

            if (invoiceLineResult.VatOption.IsSet)
                writer.WriteNumber("vat", invoiceLineResult.VatOption.Value!.Value);

            if (invoiceLineResult.VatTypeOption.IsSet)
                writer.WriteString("vatType", invoiceLineResult.VatType);

            if (invoiceLineResult.GrossOption.IsSet)
                writer.WriteNumber("gross", invoiceLineResult.GrossOption.Value!.Value);

            if (invoiceLineResult.NetInNokOption.IsSet)
                writer.WriteNumber("netInNok", invoiceLineResult.NetInNokOption.Value!.Value);

            if (invoiceLineResult.VatInNokOption.IsSet)
                writer.WriteNumber("vatInNok", invoiceLineResult.VatInNokOption.Value!.Value);

            if (invoiceLineResult.GrossInNokOption.IsSet)
                writer.WriteNumber("grossInNok", invoiceLineResult.GrossInNokOption.Value!.Value);

            if (invoiceLineResult.VatInPercentOption.IsSet)
                writer.WriteNumber("vatInPercent", invoiceLineResult.VatInPercentOption.Value!.Value);

            if (invoiceLineResult.UnitPriceOption.IsSet)
                writer.WriteNumber("unitPrice", invoiceLineResult.UnitPriceOption.Value!.Value);

            if (invoiceLineResult.QuantityOption.IsSet)
                writer.WriteNumber("quantity", invoiceLineResult.QuantityOption.Value!.Value);

            if (invoiceLineResult.DiscountOption.IsSet)
                writer.WriteNumber("discount", invoiceLineResult.DiscountOption.Value!.Value);

            if (invoiceLineResult.ProductIdOption.IsSet)
                writer.WriteNumber("productId", invoiceLineResult.ProductIdOption.Value!.Value);

            if (invoiceLineResult.ProductNameOption.IsSet)
                writer.WriteString("productName", invoiceLineResult.ProductName);

            if (invoiceLineResult.DescriptionOption.IsSet)
                writer.WriteString("description", invoiceLineResult.Description);

            if (invoiceLineResult.CommentOption.IsSet)
                writer.WriteString("comment", invoiceLineResult.Comment);

            if (invoiceLineResult.IncomeAccountOption.IsSet)
                writer.WriteString("incomeAccount", invoiceLineResult.IncomeAccount);
        }
    }
}
