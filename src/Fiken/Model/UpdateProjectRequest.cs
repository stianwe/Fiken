...
namespace Fiken.Model
{
    ...
    public partial class UpdateProjectRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpdateProjectRequest(Option<string?> name = default, Option<string?> description = default, Option<DateOnly?> startDate = default, Option<DateOnly?> endDate = default, Option<long?> contactId = default, Option<bool?> completed = default)
        {
            NameOption = name;
    ...
    public class UpdateProjectRequestJsonConverter : JsonConverter<UpdateProjectRequest>
    {
        ...
        public override UpdateProjectRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class UpdateProjectRequest.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class UpdateProjectRequest.");

            if (contactId.IsSet && contactId.Value == null)
                throw new ArgumentNullException(nameof(contactId), "Property is not nullable for class UpdateProjectRequest.");

            if (completed.IsSet && completed.Value == null)
                throw new ArgumentNullException(nameof(completed), "Property is not nullable for class UpdateProjectRequest.");

            return new UpdateProjectRequest(name, description, startDate, endDate, contactId, completed);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateProjectRequest updateProjectRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateProjectRequest.StartDateOption.IsSet)
                writer.WriteString("startDate", updateProjectRequest.StartDateOption.Value!.Value.ToString(StartDateFormat));

            if (updateProjectRequest.EndDateOption.IsSet)
                writer.WriteString("endDate", updateProjectRequest.EndDateOption.Value!.Value.ToString(EndDateFormat));

            if (updateProjectRequest.ContactIdOption.IsSet)
                writer.WriteNumber("contactId", updateProjectRequest.ContactIdOption.Value!.Value);

            if (updateProjectRequest.CompletedOption.IsSet)
                writer.WriteBoolean("completed", updateProjectRequest.CompletedOption.Value!.Value);
        }
    }
}
