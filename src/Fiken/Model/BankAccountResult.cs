...
namespace Fiken.Model
{
    ...
    /// BankAccountResult
    /// </summary>
    public partial class BankAccountResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BankAccountResult" /> class.
        /// </summary>
        ...
        /// <param name="foreignService">foreignService</param>
        /// <param name="type">type</param>
        /// <param name="reconciledBalance">Amounts are always represented as a number, and specifies the number of cents in the amount. Fractions will be ignored. ie. 10050 &#x3D; 100.50</param>
        /// <param name="reconciledDate">reconciledDate</param>
        /// <param name="inactive">inactive (default to false)</param>
        [JsonConstructor]
        public BankAccountResult(Option<long?> bankAccountId = default, Option<string?> name = default, Option<string?> accountCode = default, Option<string?> bankAccountNumber = default, Option<string?> iban = default, Option<string?> bic = default, Option<string?> foreignService = default, Option<TypeEnum?> type = default, Option<long?> reconciledBalance = default, Option<DateOnly?> reconciledDate = default, Option<bool?> inactive = default)
        {
            BankAccountIdOption = bankAccountId;
            NameOption = name;
            AccountCodeOption = accountCode;
            BankAccountNumberOption = bankAccountNumber;
            IbanOption = iban;
            BicOption = bic;
            ForeignServiceOption = foreignService;
            TypeOption = type;
            ReconciledBalanceOption = reconciledBalance;
            ReconciledDateOption = reconciledDate;
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum TaxDeduction for value: tax_deduction
            /// </summary>
            TaxDeduction = 2,
        ...
        public static TypeEnum TypeEnumFromString(string value)
        {
            ...
            if (value.Equals("tax_deduction"))
                return TypeEnum.TaxDeduction;

            if (value.Equals("foreign"))
                return TypeEnum.Foreign;

            if (value.Equals("credit_card"))
                return TypeEnum.CreditCard;
        ...
        public static string TypeEnumToJsonValue(TypeEnum? value)
        {
            ...
            if (value == TypeEnum.TaxDeduction)
                return "tax_deduction";

            if (value == TypeEnum.Foreign)
                return "foreign";

            if (value == TypeEnum.CreditCard)
                return "credit_card";
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> BankAccountIdOption { get; private set; }
        ...
        public long? BankAccountId { get { return this.BankAccountIdOption; } set { this.BankAccountIdOption = new(value); } }
        ...
        /// Gets or Sets Name
        /// </summary>
        /* <example>Utgiftskonto DNB</example> */
        [JsonPropertyName("name")]
        public string? Name { get { return this.NameOption; } set { this.NameOption = new(value); } }

        /// <summary>
        /// Used to track the state of AccountCode
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> AccountCodeOption { get; private set; }

        /// <summary>
        /// Gets or Sets AccountCode
        /// </summary>
        /* <example>1920:10007</example> */
        [JsonPropertyName("accountCode")]
        public string? AccountCode { get { return this.AccountCodeOption; } set { this.AccountCodeOption = new(value); } }
        ...
        /// <summary>
        /// Used to track the state of ForeignService
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> ForeignServiceOption { get; private set; }

        /// <summary>
        /// Gets or Sets ForeignService
        /// </summary>
        [JsonPropertyName("foreignService")]
        public string? ForeignService { get { return this.ForeignServiceOption; } set { this.ForeignServiceOption = new(value); } }

        /// <summary>
        /// Used to track the state of ReconciledBalance
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> ReconciledBalanceOption { get; private set; }
        ...
        /* <example>10050</example> */
        [JsonPropertyName("reconciledBalance")]
        public long? ReconciledBalance { get { return this.ReconciledBalanceOption; } set { this.ReconciledBalanceOption = new(value); } }

        /// <summary>
        /// Used to track the state of ReconciledDate
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DateOnly?> ReconciledDateOption { get; private set; }

        /// <summary>
        /// Gets or Sets ReconciledDate
        /// </summary>
        /* <example>Tue Apr 03 02:00:00 CEST 2018</example> */
        [JsonPropertyName("reconciledDate")]
        public DateOnly? ReconciledDate { get { return this.ReconciledDateOption; } set { this.ReconciledDateOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ForeignService: ").Append(ForeignService).Append("\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  ReconciledBalance: ").Append(ReconciledBalance).Append("\n");
            sb.Append("  ReconciledDate: ").Append(ReconciledDate).Append("\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="BankAccountResult" />
    /// </summary>
    public class BankAccountResultJsonConverter : JsonConverter<BankAccountResult>
    {
        /// <summary>
        /// The format to use to serialize ReconciledDate
        /// </summary>
        public static string ReconciledDateFormat { get; set; } = "yyyy'-'MM'-'dd";

        /// <summary>
        /// Deserializes json to <see cref="BankAccountResult" />
        /// </summary>
        ...
        public override BankAccountResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> accountCode = default;
            Option<string?> bankAccountNumber = default;
            Option<string?> iban = default;
            Option<string?> bic = default;
            Option<string?> foreignService = default;
            Option<BankAccountResult.TypeEnum?> type = default;
            Option<long?> reconciledBalance = default;
            Option<DateOnly?> reconciledDate = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "name":
                            ...
                            break;
                        case "accountCode":
                            accountCode = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        ...
                        case "bic":
                            ...
                            break;
                        case "foreignService":
                            foreignService = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "type":
                            string? typeRawValue = utf8JsonReader.GetString();
                            if (typeRawValue != null)
                                type = new Option<BankAccountResult.TypeEnum?>(BankAccountResult.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "reconciledBalance":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                reconciledBalance = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
                        case "reconciledDate":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                reconciledDate = new Option<DateOnly?>(JsonSerializer.Deserialize<DateOnly>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "inactive":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (bankAccountId.IsSet && bankAccountId.Value == null)
                throw new ArgumentNullException(nameof(bankAccountId), "Property is not nullable for class BankAccountResult.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class BankAccountResult.");

            if (accountCode.IsSet && accountCode.Value == null)
                throw new ArgumentNullException(nameof(accountCode), "Property is not nullable for class BankAccountResult.");

            if (bankAccountNumber.IsSet && bankAccountNumber.Value == null)
                throw new ArgumentNullException(nameof(bankAccountNumber), "Property is not nullable for class BankAccountResult.");

            if (iban.IsSet && iban.Value == null)
                throw new ArgumentNullException(nameof(iban), "Property is not nullable for class BankAccountResult.");

            if (bic.IsSet && bic.Value == null)
                throw new ArgumentNullException(nameof(bic), "Property is not nullable for class BankAccountResult.");

            if (foreignService.IsSet && foreignService.Value == null)
                throw new ArgumentNullException(nameof(foreignService), "Property is not nullable for class BankAccountResult.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BankAccountResult.");

            if (reconciledBalance.IsSet && reconciledBalance.Value == null)
                throw new ArgumentNullException(nameof(reconciledBalance), "Property is not nullable for class BankAccountResult.");

            if (reconciledDate.IsSet && reconciledDate.Value == null)
                throw new ArgumentNullException(nameof(reconciledDate), "Property is not nullable for class BankAccountResult.");

            if (inactive.IsSet && inactive.Value == null)
                throw new ArgumentNullException(nameof(inactive), "Property is not nullable for class BankAccountResult.");

            return new BankAccountResult(bankAccountId, name, accountCode, bankAccountNumber, iban, bic, foreignService, type, reconciledBalance, reconciledDate, inactive);
        }

        /// <summary>
        /// Serializes a <see cref="BankAccountResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankAccountResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BankAccountResult bankAccountResult, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, bankAccountResult, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BankAccountResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankAccountResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BankAccountResult bankAccountResult, JsonSerializerOptions jsonSerializerOptions)
        {
            if (bankAccountResult.NameOption.IsSet && bankAccountResult.Name == null)
                throw new ArgumentNullException(nameof(bankAccountResult.Name), "Property is required for class BankAccountResult.");

            if (bankAccountResult.AccountCodeOption.IsSet && bankAccountResult.AccountCode == null)
                throw new ArgumentNullException(nameof(bankAccountResult.AccountCode), "Property is required for class BankAccountResult.");

            if (bankAccountResult.BankAccountNumberOption.IsSet && bankAccountResult.BankAccountNumber == null)
                throw new ArgumentNullException(nameof(bankAccountResult.BankAccountNumber), "Property is required for class BankAccountResult.");

            if (bankAccountResult.IbanOption.IsSet && bankAccountResult.Iban == null)
                throw new ArgumentNullException(nameof(bankAccountResult.Iban), "Property is required for class BankAccountResult.");

            if (bankAccountResult.BicOption.IsSet && bankAccountResult.Bic == null)
                throw new ArgumentNullException(nameof(bankAccountResult.Bic), "Property is required for class BankAccountResult.");

            if (bankAccountResult.ForeignServiceOption.IsSet && bankAccountResult.ForeignService == null)
                throw new ArgumentNullException(nameof(bankAccountResult.ForeignService), "Property is required for class BankAccountResult.");

            if (bankAccountResult.BankAccountIdOption.IsSet)
                writer.WriteNumber("bankAccountId", bankAccountResult.BankAccountIdOption.Value!.Value);

            if (bankAccountResult.NameOption.IsSet)
                writer.WriteString("name", bankAccountResult.Name);

            if (bankAccountResult.AccountCodeOption.IsSet)
                writer.WriteString("accountCode", bankAccountResult.AccountCode);

            if (bankAccountResult.BankAccountNumberOption.IsSet)
                writer.WriteString("bankAccountNumber", bankAccountResult.BankAccountNumber);

            if (bankAccountResult.IbanOption.IsSet)
                writer.WriteString("iban", bankAccountResult.Iban);

            if (bankAccountResult.BicOption.IsSet)
                writer.WriteString("bic", bankAccountResult.Bic);

            if (bankAccountResult.ForeignServiceOption.IsSet)
                writer.WriteString("foreignService", bankAccountResult.ForeignService);

            var typeRawValue = BankAccountResult.TypeEnumToJsonValue(bankAccountResult.TypeOption.Value!.Value);
            writer.WriteString("type", typeRawValue);
            if (bankAccountResult.ReconciledBalanceOption.IsSet)
                writer.WriteNumber("reconciledBalance", bankAccountResult.ReconciledBalanceOption.Value!.Value);

            if (bankAccountResult.ReconciledDateOption.IsSet)
                writer.WriteString("reconciledDate", bankAccountResult.ReconciledDateOption.Value!.Value.ToString(ReconciledDateFormat));

            if (bankAccountResult.InactiveOption.IsSet)
                writer.WriteBoolean("inactive", bankAccountResult.InactiveOption.Value!.Value);
        }
    }
}
