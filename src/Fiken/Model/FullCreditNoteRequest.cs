...
namespace Fiken.Model
{
    ...
    /// </summary>
    public partial class FullCreditNoteRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FullCreditNoteRequest" /> class.
        /// </summary>
        /// <param name="issueDate">Date that the credit note is issued, format yyyy-mm-dd</param>
        /// <param name="invoiceId">Id of invoice that the credit note is associated with.</param>
        /// <param name="creditNoteText">creditNoteText</param>
        [JsonConstructor]
        public FullCreditNoteRequest(DateOnly issueDate, long invoiceId, Option<string?> creditNoteText = default)
        {
            IssueDate = issueDate;
            InvoiceId = invoiceId;
    ...
    /// <summary>
    /// A Json converter for type <see cref="FullCreditNoteRequest" />
    /// </summary>
    public class FullCreditNoteRequestJsonConverter : JsonConverter<FullCreditNoteRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="FullCreditNoteRequest" />
        /// </summary>
        ...
        public override FullCreditNoteRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!issueDate.IsSet)
                throw new ArgumentException("Property is required for class FullCreditNoteRequest.", nameof(issueDate));

            if (!invoiceId.IsSet)
                throw new ArgumentException("Property is required for class FullCreditNoteRequest.", nameof(invoiceId));

            if (issueDate.IsSet && issueDate.Value == null)
                throw new ArgumentNullException(nameof(issueDate), "Property is not nullable for class FullCreditNoteRequest.");

            if (invoiceId.IsSet && invoiceId.Value == null)
                throw new ArgumentNullException(nameof(invoiceId), "Property is not nullable for class FullCreditNoteRequest.");

            if (creditNoteText.IsSet && creditNoteText.Value == null)
                throw new ArgumentNullException(nameof(creditNoteText), "Property is not nullable for class FullCreditNoteRequest.");

            return new FullCreditNoteRequest(issueDate.Value!.Value!, invoiceId.Value!.Value!, creditNoteText);
        }

        /// <summary>
        /// Serializes a <see cref="FullCreditNoteRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fullCreditNoteRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FullCreditNoteRequest fullCreditNoteRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, fullCreditNoteRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FullCreditNoteRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fullCreditNoteRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FullCreditNoteRequest fullCreditNoteRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (fullCreditNoteRequest.CreditNoteTextOption.IsSet && fullCreditNoteRequest.CreditNoteText == null)
                throw new ArgumentNullException(nameof(fullCreditNoteRequest.CreditNoteText), "Property is required for class FullCreditNoteRequest.");

            writer.WriteString("issueDate", fullCreditNoteRequest.IssueDate.ToString(IssueDateFormat));

            writer.WriteNumber("invoiceId", fullCreditNoteRequest.InvoiceId);

            if (fullCreditNoteRequest.CreditNoteTextOption.IsSet)
                writer.WriteString("creditNoteText", fullCreditNoteRequest.CreditNoteText);
        }
    }
}
