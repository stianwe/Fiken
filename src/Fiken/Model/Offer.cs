...
namespace Fiken.Model
{
    ...
    public partial class Offer : IValidatableObject
    {
        ...
        /// <param name="offerDraftUuid">UUID are represented as 32 hexadecimal (base-16) digits, displayed in 5 groups separated by hyphens, in the form 8-4-4-4-12 for a total of 36 characters.</param>
        /// <param name="date">Date for offer</param>
        /// <param name="offerNumber">Unique offer number generated by us.</param>
        ...
        /// <param name="contactPersonId">Contact person associated with offer. Must belong to the provided contact.</param>
        /// <param name="projectId">projectId</param>
        /// <param name="archived">If order confirmation has been archived or not. (default to false)</param>
        [JsonConstructor]
        public Offer(Option<long?> offerId = default, Option<string?> offerDraftUuid = default, Option<DateOnly?> date = default, Option<int?> offerNumber = default, Option<long?> net = default, Option<long?> vat = default, Option<long?> gross = default, Option<string?> comment = default, Option<string?> yourReference = default, Option<string?> ourReference = default, Option<string?> orderReference = default, Option<decimal?> discount = default, Option<Address?> address = default, Option<List<InvoiceLineResult>?> lines = default, Option<string?> currency = default, Option<long?> contactId = default, Option<long?> contactPersonId = default, Option<long?> projectId = default, Option<bool?> archived = default)
        {
            OfferIdOption = offerId;
            OfferDraftUuidOption = offerDraftUuid;
            DateOption = date;
            OfferNumberOption = offerNumber;
            NetOption = net;
            VatOption = vat;
            GrossOption = gross;
        ...
        public Option<long?> OfferIdOption { get; }
        ...
        public long? OfferId { get { return this.OfferIdOption; } }

        /// <summary>
        /// Used to track the state of OfferDraftUuid
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> OfferDraftUuidOption { get; }
        ...
        [JsonPropertyName("offerDraftUuid")]
        public string? OfferDraftUuid { get { return this.OfferDraftUuidOption; } }
        ...
        /// <summary>
        /// Used to track the state of OfferNumber
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<int?> OfferNumberOption { get; private set; }
        ...
        public int? OfferNumber { get { return this.OfferNumberOption; } set { this.OfferNumberOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OfferDraftUuid: ").Append(OfferDraftUuid).Append("\n");
    ...
    public class OfferJsonConverter : JsonConverter<Offer>
    {
        ...
        public override Offer Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> offerDraftUuid = default;
            Option<DateOnly?> date = default;
            Option<int?> offerNumber = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "offerId":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                offerId = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
                        case "offerDraftUuid":
                            offerDraftUuid = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "date":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "offerNumber":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                offerNumber = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "net":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (offerId.IsSet && offerId.Value == null)
                throw new ArgumentNullException(nameof(offerId), "Property is not nullable for class Offer.");

            if (offerDraftUuid.IsSet && offerDraftUuid.Value == null)
                throw new ArgumentNullException(nameof(offerDraftUuid), "Property is not nullable for class Offer.");

            if (date.IsSet && date.Value == null)
                throw new ArgumentNullException(nameof(date), "Property is not nullable for class Offer.");

            if (offerNumber.IsSet && offerNumber.Value == null)
                throw new ArgumentNullException(nameof(offerNumber), "Property is not nullable for class Offer.");

            if (net.IsSet && net.Value == null)
                throw new ArgumentNullException(nameof(net), "Property is not nullable for class Offer.");

            if (vat.IsSet && vat.Value == null)
                throw new ArgumentNullException(nameof(vat), "Property is not nullable for class Offer.");

            if (gross.IsSet && gross.Value == null)
                throw new ArgumentNullException(nameof(gross), "Property is not nullable for class Offer.");

            if (comment.IsSet && comment.Value == null)
                throw new ArgumentNullException(nameof(comment), "Property is not nullable for class Offer.");

            if (yourReference.IsSet && yourReference.Value == null)
                throw new ArgumentNullException(nameof(yourReference), "Property is not nullable for class Offer.");

            if (ourReference.IsSet && ourReference.Value == null)
                throw new ArgumentNullException(nameof(ourReference), "Property is not nullable for class Offer.");

            if (orderReference.IsSet && orderReference.Value == null)
                throw new ArgumentNullException(nameof(orderReference), "Property is not nullable for class Offer.");

            if (discount.IsSet && discount.Value == null)
                throw new ArgumentNullException(nameof(discount), "Property is not nullable for class Offer.");

            if (address.IsSet && address.Value == null)
                throw new ArgumentNullException(nameof(address), "Property is not nullable for class Offer.");

            if (lines.IsSet && lines.Value == null)
                throw new ArgumentNullException(nameof(lines), "Property is not nullable for class Offer.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class Offer.");

            if (contactId.IsSet && contactId.Value == null)
                throw new ArgumentNullException(nameof(contactId), "Property is not nullable for class Offer.");

            if (contactPersonId.IsSet && contactPersonId.Value == null)
                throw new ArgumentNullException(nameof(contactPersonId), "Property is not nullable for class Offer.");

            if (projectId.IsSet && projectId.Value == null)
                throw new ArgumentNullException(nameof(projectId), "Property is not nullable for class Offer.");

            if (archived.IsSet && archived.Value == null)
                throw new ArgumentNullException(nameof(archived), "Property is not nullable for class Offer.");

            return new Offer(offerId, offerDraftUuid, date, offerNumber, net, vat, gross, comment, yourReference, ourReference, orderReference, discount, address, lines, currency, contactId, contactPersonId, projectId, archived);
        }
        ...
        {
            if (offer.OfferDraftUuidOption.IsSet && offer.OfferDraftUuid == null)
                throw new ArgumentNullException(nameof(offer.OfferDraftUuid), "Property is required for class Offer.");

            if (offer.CommentOption.IsSet && offer.Comment == null)
                throw new ArgumentNullException(nameof(offer.Comment), "Property is required for class Offer.");

            if (offer.YourReferenceOption.IsSet && offer.YourReference == null)
                throw new ArgumentNullException(nameof(offer.YourReference), "Property is required for class Offer.");

            if (offer.OurReferenceOption.IsSet && offer.OurReference == null)
                throw new ArgumentNullException(nameof(offer.OurReference), "Property is required for class Offer.");

            if (offer.OrderReferenceOption.IsSet && offer.OrderReference == null)
                throw new ArgumentNullException(nameof(offer.OrderReference), "Property is required for class Offer.");

            if (offer.AddressOption.IsSet && offer.Address == null)
                throw new ArgumentNullException(nameof(offer.Address), "Property is required for class Offer.");

            if (offer.LinesOption.IsSet && offer.Lines == null)
                throw new ArgumentNullException(nameof(offer.Lines), "Property is required for class Offer.");

            if (offer.CurrencyOption.IsSet && offer.Currency == null)
                throw new ArgumentNullException(nameof(offer.Currency), "Property is required for class Offer.");

            if (offer.OfferIdOption.IsSet)
                writer.WriteNumber("offerId", offer.OfferIdOption.Value!.Value);

            if (offer.OfferDraftUuidOption.IsSet)
                writer.WriteString("offerDraftUuid", offer.OfferDraftUuid);

            if (offer.DateOption.IsSet)
                writer.WriteString("date", offer.DateOption.Value!.Value.ToString(DateFormat));

            if (offer.OfferNumberOption.IsSet)
                writer.WriteNumber("offerNumber", offer.OfferNumberOption.Value!.Value);

            if (offer.NetOption.IsSet)
                writer.WriteNumber("net", offer.NetOption.Value!.Value);

            if (offer.VatOption.IsSet)
                writer.WriteNumber("vat", offer.VatOption.Value!.Value);

            if (offer.GrossOption.IsSet)
                writer.WriteNumber("gross", offer.GrossOption.Value!.Value);

            if (offer.CommentOption.IsSet)
                writer.WriteString("comment", offer.Comment);

            if (offer.YourReferenceOption.IsSet)
                writer.WriteString("yourReference", offer.YourReference);

            if (offer.OurReferenceOption.IsSet)
                writer.WriteString("ourReference", offer.OurReference);

            if (offer.OrderReferenceOption.IsSet)
                writer.WriteString("orderReference", offer.OrderReference);

            if (offer.DiscountOption.IsSet)
                writer.WriteNumber("discount", offer.DiscountOption.Value!.Value);

            if (offer.AddressOption.IsSet)
            {
                writer.WritePropertyName("address");
                JsonSerializer.Serialize(writer, offer.Address, jsonSerializerOptions);
            }
            if (offer.LinesOption.IsSet)
            {
                writer.WritePropertyName("lines");
                JsonSerializer.Serialize(writer, offer.Lines, jsonSerializerOptions);
            }
            if (offer.CurrencyOption.IsSet)
                writer.WriteString("currency", offer.Currency);

            if (offer.ContactIdOption.IsSet)
                writer.WriteNumber("contactId", offer.ContactIdOption.Value!.Value);

            if (offer.ContactPersonIdOption.IsSet)
                writer.WriteNumber("contactPersonId", offer.ContactPersonIdOption.Value!.Value);

            if (offer.ProjectIdOption.IsSet)
                writer.WriteNumber("projectId", offer.ProjectIdOption.Value!.Value);

            if (offer.ArchivedOption.IsSet)
                writer.WriteBoolean("archived", offer.ArchivedOption.Value!.Value);
        }
    }
}
