...
namespace Fiken.Model
{
    ...
    /// DispatchResult
    /// </summary>
    public partial class DispatchResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DispatchResult" /> class.
        /// </summary>
        /// <param name="date">Date that invoice was sent from Fiken, format yyyy-mm-dd</param>
        /// <param name="dispatchType">The type of disptach. Unknown is returned when an invoice was manually sent and Fiken doesn&#39;t know the dispatch method.</param>
        [JsonConstructor]
        internal DispatchResult(Option<DateOnly?> date = default, Option<DispatchTypeEnum?> dispatchType = default)
        {
            DateOption = date;
            DispatchTypeOption = dispatchType;
            OnCreated();
        }
        ...
        /// </summary>
        /// <value>The type of disptach. Unknown is returned when an invoice was manually sent and Fiken doesn&#39;t know the dispatch method.</value>
        ...
        /// <summary>
        /// Returns a <see cref="DispatchTypeEnum"/>
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static DispatchTypeEnum DispatchTypeEnumFromString(string value)
        {
            if (value.Equals("email"))
                return DispatchTypeEnum.Email;

            if (value.Equals("sms"))
                return DispatchTypeEnum.Sms;

            if (value.Equals("ehf"))
                return DispatchTypeEnum.Ehf;

            if (value.Equals("letter"))
                return DispatchTypeEnum.Letter;

            if (value.Equals("vipps"))
                return DispatchTypeEnum.Vipps;

            if (value.Equals("efaktura"))
                return DispatchTypeEnum.Efaktura;

            if (value.Equals("unknown"))
                return DispatchTypeEnum.Unknown;

            throw new NotImplementedException($"Could not convert value to type DispatchTypeEnum: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static DispatchTypeEnum? DispatchTypeEnumFromStringOrDefault(string value)
        {
            if (value.Equals("email"))
                return DispatchTypeEnum.Email;
        ...
        /// <summary>
        /// Converts the <see cref="DispatchTypeEnum"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static string DispatchTypeEnumToJsonValue(DispatchTypeEnum? value)
        {
            if (value == DispatchTypeEnum.Email)
                return "email";

            if (value == DispatchTypeEnum.Sms)
                return "sms";

            if (value == DispatchTypeEnum.Ehf)
                return "ehf";

            if (value == DispatchTypeEnum.Letter)
                return "letter";

            if (value == DispatchTypeEnum.Vipps)
                return "vipps";

            if (value == DispatchTypeEnum.Efaktura)
                return "efaktura";

            if (value == DispatchTypeEnum.Unknown)
                return "unknown";
        ...
        /// <summary>
        /// Used to track the state of DispatchType
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DispatchTypeEnum?> DispatchTypeOption { get; }
        ...
        public DispatchTypeEnum? DispatchType { get { return this.DispatchTypeOption; } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DateOnly?> DateOption { get; }

        /// <summary>
        /// Date that invoice was sent from Fiken, format yyyy-mm-dd
        /// </summary>
        /// <value>Date that invoice was sent from Fiken, format yyyy-mm-dd</value>
        /* <example>Wed Apr 03 02:00:00 CEST 2024</example> */
        [JsonPropertyName("date")]
        public DateOnly? Date { get { return this.DateOption; } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DispatchResult {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="DispatchResult" />
    /// </summary>
    public class DispatchResultJsonConverter : JsonConverter<DispatchResult>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="DispatchResult" />
        /// </summary>
        ...
        public override DispatchResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DispatchResult.DispatchTypeEnum?> dispatchType = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "date":
                            ...
                            break;
                        case "dispatchType":
                            string? dispatchTypeRawValue = utf8JsonReader.GetString();
                            if (dispatchTypeRawValue != null)
                                dispatchType = new Option<DispatchResult.DispatchTypeEnum?>(DispatchResult.DispatchTypeEnumFromStringOrDefault(dispatchTypeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (date.IsSet && date.Value == null)
                throw new ArgumentNullException(nameof(date), "Property is not nullable for class DispatchResult.");

            if (dispatchType.IsSet && dispatchType.Value == null)
                throw new ArgumentNullException(nameof(dispatchType), "Property is not nullable for class DispatchResult.");

            return new DispatchResult(date, dispatchType);
        }

        /// <summary>
        /// Serializes a <see cref="DispatchResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dispatchResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DispatchResult dispatchResult, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, dispatchResult, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DispatchResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dispatchResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DispatchResult dispatchResult, JsonSerializerOptions jsonSerializerOptions)
        {
            if (dispatchResult.DateOption.IsSet)
                writer.WriteString("date", dispatchResult.DateOption.Value!.Value.ToString(DateFormat));

            var dispatchTypeRawValue = DispatchResult.DispatchTypeEnumToJsonValue(dispatchResult.DispatchTypeOption.Value!.Value);
            writer.WriteString("dispatchType", dispatchTypeRawValue);
        }
    }
}
