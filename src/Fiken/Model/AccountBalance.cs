...
namespace Fiken.Model
{
    ...
    public partial class AccountBalance : IValidatableObject
    {
        ...
        /// <param name="balance">Balance of account for a given date given in cents (5050 &#x3D; 50.50)</param>
        [JsonConstructor]
        public AccountBalance(Option<string?> code = default, Option<string?> name = default, Option<long?> balance = default)
        {
            CodeOption = code;
            NameOption = name;
        ...
        /* <example>15200</example> */
        [JsonPropertyName("balance")]
        public long? Balance { get { return this.BalanceOption; } set { this.BalanceOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="AccountBalance" />
    /// </summary>
    public class AccountBalanceJsonConverter : JsonConverter<AccountBalance>
    {
        /// <summary>
        /// Deserializes json to <see cref="AccountBalance" />
        /// </summary>
        ...
        public override AccountBalance Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (code.IsSet && code.Value == null)
                throw new ArgumentNullException(nameof(code), "Property is not nullable for class AccountBalance.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class AccountBalance.");

            if (balance.IsSet && balance.Value == null)
                throw new ArgumentNullException(nameof(balance), "Property is not nullable for class AccountBalance.");

            return new AccountBalance(code, name, balance);
        }

        /// <summary>
        /// Serializes a <see cref="AccountBalance" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="accountBalance"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AccountBalance accountBalance, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, accountBalance, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AccountBalance" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="accountBalance"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AccountBalance accountBalance, JsonSerializerOptions jsonSerializerOptions)
        {
            if (accountBalance.CodeOption.IsSet && accountBalance.Code == null)
                throw new ArgumentNullException(nameof(accountBalance.Code), "Property is required for class AccountBalance.");

            if (accountBalance.NameOption.IsSet && accountBalance.Name == null)
                throw new ArgumentNullException(nameof(accountBalance.Name), "Property is required for class AccountBalance.");

            if (accountBalance.CodeOption.IsSet)
                writer.WriteString("code", accountBalance.Code);

            if (accountBalance.NameOption.IsSet)
                writer.WriteString("name", accountBalance.Name);

            if (accountBalance.BalanceOption.IsSet)
                writer.WriteNumber("balance", accountBalance.BalanceOption.Value!.Value);
        }
    }
}
