...
namespace Fiken.Model
{
    ...
    /// JournalEntryLine
    /// </summary>
    public partial class JournalEntryLine : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JournalEntryLine" /> class.
        /// </summary>
        /// <param name="amount">This will be the net amount (excluding VAT) for debitAccount lines and gross amount  (including VAT) for creditAccount lines. The reason for this difference is due to the  way Fiken calculates VAT based on the debitVatCode and creditVatCode. </param>
        /// <param name="account">account</param>
        /// <param name="vatCode">vatCode</param>
        /// <param name="debitAccount">debitAccount</param>
        /// <param name="debitVatCode">debitVatCode</param>
        /// <param name="creditAccount">creditAccount</param>
        /// <param name="creditVatCode">creditVatCode</param>
        /// <param name="projectId">projectId</param>
        /// <param name="lastModifiedDate">Date that journal entry line was last modified in Fiken, format yyyy-mm-dd.</param>
        [JsonConstructor]
        public JournalEntryLine(long amount, Option<string?> account = default, Option<string?> vatCode = default, Option<string?> debitAccount = default, Option<long?> debitVatCode = default, Option<string?> creditAccount = default, Option<long?> creditVatCode = default, Option<List<long>?> projectId = default, Option<DateOnly?> lastModifiedDate = default)
        {
            Amount = amount;
            AccountOption = account;
            VatCodeOption = vatCode;
            DebitAccountOption = debitAccount;
            DebitVatCodeOption = debitVatCode;
            CreditAccountOption = creditAccount;
            CreditVatCodeOption = creditVatCode;
        ...
        /// <summary>
        /// This will be the net amount (excluding VAT) for debitAccount lines and gross amount  (including VAT) for creditAccount lines. The reason for this difference is due to the  way Fiken calculates VAT based on the debitVatCode and creditVatCode. 
        /// </summary>
        /// <value>This will be the net amount (excluding VAT) for debitAccount lines and gross amount  (including VAT) for creditAccount lines. The reason for this difference is due to the  way Fiken calculates VAT based on the debitVatCode and creditVatCode. </value>
        ...
        /// <summary>
        /// Used to track the state of DebitAccount
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> DebitAccountOption { get; private set; }

        /// <summary>
        /// Gets or Sets DebitAccount
        /// </summary>
        [JsonPropertyName("debitAccount")]
        public string? DebitAccount { get { return this.DebitAccountOption; } set { this.DebitAccountOption = new(value); } }

        /// <summary>
        /// Used to track the state of DebitVatCode
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> DebitVatCodeOption { get; private set; }

        /// <summary>
        /// Gets or Sets DebitVatCode
        /// </summary>
        [JsonPropertyName("debitVatCode")]
        public long? DebitVatCode { get { return this.DebitVatCodeOption; } set { this.DebitVatCodeOption = new(value); } }

        /// <summary>
        /// Used to track the state of CreditAccount
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> CreditAccountOption { get; private set; }

        /// <summary>
        /// Gets or Sets CreditAccount
        /// </summary>
        [JsonPropertyName("creditAccount")]
        public string? CreditAccount { get { return this.CreditAccountOption; } set { this.CreditAccountOption = new(value); } }

        /// <summary>
        /// Used to track the state of CreditVatCode
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> CreditVatCodeOption { get; private set; }

        /// <summary>
        /// Gets or Sets CreditVatCode
        /// </summary>
        [JsonPropertyName("creditVatCode")]
        public long? CreditVatCode { get { return this.CreditVatCodeOption; } set { this.CreditVatCodeOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<long>?> ProjectIdOption { get; }

        /// <summary>
        /// Gets or Sets ProjectId
        /// </summary>
        [JsonPropertyName("projectId")]
        public List<long>? ProjectId { get { return this.ProjectIdOption; } }
        ...
        /// </summary>
        /// <value>Date that journal entry line was last modified in Fiken, format yyyy-mm-dd.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DebitVatCode: ").Append(DebitVatCode).Append("\n");
            sb.Append("  CreditAccount: ").Append(CreditAccount).Append("\n");
            sb.Append("  CreditVatCode: ").Append(CreditVatCode).Append("\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="JournalEntryLine" />
    /// </summary>
    public class JournalEntryLineJsonConverter : JsonConverter<JournalEntryLine>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="JournalEntryLine" />
        /// </summary>
        ...
        public override JournalEntryLine Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> debitAccount = default;
            Option<long?> debitVatCode = default;
            Option<string?> creditAccount = default;
            Option<long?> creditVatCode = default;
            Option<List<long>?> projectId = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "vatCode":
                            ...
                            break;
                        case "debitAccount":
                            debitAccount = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "debitVatCode":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                debitVatCode = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
                        case "creditAccount":
                            creditAccount = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "creditVatCode":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                creditVatCode = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
                        case "projectId":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                projectId = new Option<List<long>?>(JsonSerializer.Deserialize<List<long>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
            ...
            if (!amount.IsSet)
                throw new ArgumentException("Property is required for class JournalEntryLine.", nameof(amount));

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class JournalEntryLine.");

            if (account.IsSet && account.Value == null)
                throw new ArgumentNullException(nameof(account), "Property is not nullable for class JournalEntryLine.");

            if (vatCode.IsSet && vatCode.Value == null)
                throw new ArgumentNullException(nameof(vatCode), "Property is not nullable for class JournalEntryLine.");

            if (debitAccount.IsSet && debitAccount.Value == null)
                throw new ArgumentNullException(nameof(debitAccount), "Property is not nullable for class JournalEntryLine.");

            if (debitVatCode.IsSet && debitVatCode.Value == null)
                throw new ArgumentNullException(nameof(debitVatCode), "Property is not nullable for class JournalEntryLine.");

            if (creditAccount.IsSet && creditAccount.Value == null)
                throw new ArgumentNullException(nameof(creditAccount), "Property is not nullable for class JournalEntryLine.");

            if (creditVatCode.IsSet && creditVatCode.Value == null)
                throw new ArgumentNullException(nameof(creditVatCode), "Property is not nullable for class JournalEntryLine.");

            if (projectId.IsSet && projectId.Value == null)
                throw new ArgumentNullException(nameof(projectId), "Property is not nullable for class JournalEntryLine.");

            if (lastModifiedDate.IsSet && lastModifiedDate.Value == null)
                throw new ArgumentNullException(nameof(lastModifiedDate), "Property is not nullable for class JournalEntryLine.");

            return new JournalEntryLine(amount.Value!.Value!, account, vatCode, debitAccount, debitVatCode, creditAccount, creditVatCode, projectId, lastModifiedDate);
        }

        /// <summary>
        /// Serializes a <see cref="JournalEntryLine" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="journalEntryLine"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, JournalEntryLine journalEntryLine, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, journalEntryLine, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="JournalEntryLine" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="journalEntryLine"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, JournalEntryLine journalEntryLine, JsonSerializerOptions jsonSerializerOptions)
        {
            if (journalEntryLine.AccountOption.IsSet && journalEntryLine.Account == null)
                throw new ArgumentNullException(nameof(journalEntryLine.Account), "Property is required for class JournalEntryLine.");

            if (journalEntryLine.VatCodeOption.IsSet && journalEntryLine.VatCode == null)
                throw new ArgumentNullException(nameof(journalEntryLine.VatCode), "Property is required for class JournalEntryLine.");

            if (journalEntryLine.DebitAccountOption.IsSet && journalEntryLine.DebitAccount == null)
                throw new ArgumentNullException(nameof(journalEntryLine.DebitAccount), "Property is required for class JournalEntryLine.");

            if (journalEntryLine.CreditAccountOption.IsSet && journalEntryLine.CreditAccount == null)
                throw new ArgumentNullException(nameof(journalEntryLine.CreditAccount), "Property is required for class JournalEntryLine.");

            if (journalEntryLine.ProjectIdOption.IsSet && journalEntryLine.ProjectId == null)
                throw new ArgumentNullException(nameof(journalEntryLine.ProjectId), "Property is required for class JournalEntryLine.");

            writer.WriteNumber("amount", journalEntryLine.Amount);

            if (journalEntryLine.AccountOption.IsSet)
                writer.WriteString("account", journalEntryLine.Account);

            if (journalEntryLine.VatCodeOption.IsSet)
                writer.WriteString("vatCode", journalEntryLine.VatCode);

            if (journalEntryLine.DebitAccountOption.IsSet)
                writer.WriteString("debitAccount", journalEntryLine.DebitAccount);

            if (journalEntryLine.DebitVatCodeOption.IsSet)
                writer.WriteNumber("debitVatCode", journalEntryLine.DebitVatCodeOption.Value!.Value);

            if (journalEntryLine.CreditAccountOption.IsSet)
                writer.WriteString("creditAccount", journalEntryLine.CreditAccount);

            if (journalEntryLine.CreditVatCodeOption.IsSet)
                writer.WriteNumber("creditVatCode", journalEntryLine.CreditVatCodeOption.Value!.Value);

            if (journalEntryLine.ProjectIdOption.IsSet)
            {
                writer.WritePropertyName("projectId");
                JsonSerializer.Serialize(writer, journalEntryLine.ProjectId, jsonSerializerOptions);
            }
            if (journalEntryLine.LastModifiedDateOption.IsSet)
                writer.WriteString("lastModifiedDate", journalEntryLine.LastModifiedDateOption.Value!.Value.ToString(LastModifiedDateFormat));
        }
    }
}
