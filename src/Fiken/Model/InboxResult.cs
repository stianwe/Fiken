...
namespace Fiken.Model
{
    ...
    /// InboxResult
    /// </summary>
    public partial class InboxResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InboxResult" /> class.
        /// </summary>
        /// <param name="documentId">documentId</param>
        /// <param name="name">Name of the document as it appears in the inbox</param>
        /// <param name="description">Additional description of document</param>
        /// <param name="filename">Name of the underlying file for the inbox document</param>
        /// <param name="status">Whether the document has been used as documentation or not</param>
        /// <param name="createdAt">When the document was created</param>
        [JsonConstructor]
        public InboxResult(Option<long?> documentId = default, Option<string?> name = default, Option<string?> description = default, Option<string?> filename = default, Option<bool?> status = default, Option<DateTimeOffset?> createdAt = default)
        {
        ...
        public Option<long?> DocumentIdOption { get; }

        /// <summary>
        /// Gets or Sets DocumentId
        /// </summary>
        /* <example>1234134</example> */
        [JsonPropertyName("documentId")]
        public long? DocumentId { get { return this.DocumentIdOption; } }
        ...
        public bool? Status { get { return this.StatusOption; } set { this.StatusOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InboxResult" />
    /// </summary>
    public class InboxResultJsonConverter : JsonConverter<InboxResult>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="InboxResult" />
        /// </summary>
        ...
        public override InboxResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "documentId":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                documentId = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
                        case "name":
            ...
            if (documentId.IsSet && documentId.Value == null)
                throw new ArgumentNullException(nameof(documentId), "Property is not nullable for class InboxResult.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class InboxResult.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class InboxResult.");

            if (filename.IsSet && filename.Value == null)
                throw new ArgumentNullException(nameof(filename), "Property is not nullable for class InboxResult.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class InboxResult.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class InboxResult.");

            return new InboxResult(documentId, name, description, filename, status, createdAt);
        }

        /// <summary>
        /// Serializes a <see cref="InboxResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inboxResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InboxResult inboxResult, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, inboxResult, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InboxResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="inboxResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InboxResult inboxResult, JsonSerializerOptions jsonSerializerOptions)
        {
            if (inboxResult.NameOption.IsSet && inboxResult.Name == null)
                throw new ArgumentNullException(nameof(inboxResult.Name), "Property is required for class InboxResult.");

            if (inboxResult.DescriptionOption.IsSet && inboxResult.Description == null)
                throw new ArgumentNullException(nameof(inboxResult.Description), "Property is required for class InboxResult.");

            if (inboxResult.FilenameOption.IsSet && inboxResult.Filename == null)
                throw new ArgumentNullException(nameof(inboxResult.Filename), "Property is required for class InboxResult.");

            if (inboxResult.DocumentIdOption.IsSet)
                writer.WriteNumber("documentId", inboxResult.DocumentIdOption.Value!.Value);

            if (inboxResult.NameOption.IsSet)
                writer.WriteString("name", inboxResult.Name);

            if (inboxResult.DescriptionOption.IsSet)
                writer.WriteString("description", inboxResult.Description);

            if (inboxResult.FilenameOption.IsSet)
                writer.WriteString("filename", inboxResult.Filename);

            if (inboxResult.StatusOption.IsSet)
                writer.WriteBoolean("status", inboxResult.StatusOption.Value!.Value);

            if (inboxResult.CreatedAtOption.IsSet)
                writer.WriteString("createdAt", inboxResult.CreatedAtOption.Value!.Value.ToString(CreatedAtFormat));
        }
    }
}
