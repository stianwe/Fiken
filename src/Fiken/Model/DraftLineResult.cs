...
namespace Fiken.Model
{
    ...
    /// DraftLineResult
    /// </summary>
    public partial class DraftLineResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DraftLineResult" /> class.
        /// </summary>
        /// <param name="text">Description of the sale/purchase line.</param>
        ...
        [JsonConstructor]
        public DraftLineResult(Option<string?> text = default, Option<string?> vatType = default, Option<string?> incomeAccount = default, Option<long?> net = default, Option<long?> gross = default, Option<ProjectResult?> project = default)
        {
            TextOption = text;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DraftLineResult {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="DraftLineResult" />
    /// </summary>
    public class DraftLineResultJsonConverter : JsonConverter<DraftLineResult>
    {
        /// <summary>
        /// Deserializes json to <see cref="DraftLineResult" />
        /// </summary>
        ...
        public override DraftLineResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (text.IsSet && text.Value == null)
                throw new ArgumentNullException(nameof(text), "Property is not nullable for class DraftLineResult.");

            if (vatType.IsSet && vatType.Value == null)
                throw new ArgumentNullException(nameof(vatType), "Property is not nullable for class DraftLineResult.");

            if (incomeAccount.IsSet && incomeAccount.Value == null)
                throw new ArgumentNullException(nameof(incomeAccount), "Property is not nullable for class DraftLineResult.");

            if (net.IsSet && net.Value == null)
                throw new ArgumentNullException(nameof(net), "Property is not nullable for class DraftLineResult.");

            if (gross.IsSet && gross.Value == null)
                throw new ArgumentNullException(nameof(gross), "Property is not nullable for class DraftLineResult.");

            if (project.IsSet && project.Value == null)
                throw new ArgumentNullException(nameof(project), "Property is not nullable for class DraftLineResult.");

            return new DraftLineResult(text, vatType, incomeAccount, net, gross, project);
        }

        /// <summary>
        /// Serializes a <see cref="DraftLineResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="draftLineResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DraftLineResult draftLineResult, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, draftLineResult, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DraftLineResult" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="draftLineResult"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DraftLineResult draftLineResult, JsonSerializerOptions jsonSerializerOptions)
        {
            if (draftLineResult.TextOption.IsSet && draftLineResult.Text == null)
                throw new ArgumentNullException(nameof(draftLineResult.Text), "Property is required for class DraftLineResult.");

            if (draftLineResult.VatTypeOption.IsSet && draftLineResult.VatType == null)
                throw new ArgumentNullException(nameof(draftLineResult.VatType), "Property is required for class DraftLineResult.");

            if (draftLineResult.IncomeAccountOption.IsSet && draftLineResult.IncomeAccount == null)
                throw new ArgumentNullException(nameof(draftLineResult.IncomeAccount), "Property is required for class DraftLineResult.");

            if (draftLineResult.ProjectOption.IsSet && draftLineResult.Project == null)
                throw new ArgumentNullException(nameof(draftLineResult.Project), "Property is required for class DraftLineResult.");

            if (draftLineResult.TextOption.IsSet)
                writer.WriteString("text", draftLineResult.Text);

            if (draftLineResult.VatTypeOption.IsSet)
                writer.WriteString("vatType", draftLineResult.VatType);

            if (draftLineResult.IncomeAccountOption.IsSet)
                writer.WriteString("incomeAccount", draftLineResult.IncomeAccount);

            if (draftLineResult.NetOption.IsSet)
                writer.WriteNumber("net", draftLineResult.NetOption.Value!.Value);

            if (draftLineResult.GrossOption.IsSet)
                writer.WriteNumber("gross", draftLineResult.GrossOption.Value!.Value);

            if (draftLineResult.ProjectOption.IsSet)
            {
                writer.WritePropertyName("project");
                JsonSerializer.Serialize(writer, draftLineResult.Project, jsonSerializerOptions);
            }
        }
    }
}
