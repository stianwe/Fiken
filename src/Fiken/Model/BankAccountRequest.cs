...
namespace Fiken.Model
{
    ...
    /// BankAccountRequest
    /// </summary>
    public partial class BankAccountRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public BankAccountRequest(string name, string bankAccountNumber, TypeEnum type, Option<string?> bic = default, Option<string?> iban = default, Option<string?> foreignService = default, Option<bool?> inactive = default)
        {
            Name = name;
        ...
        /// Gets or Sets Iban
        /// </summary>
        /* <example>NO49 1111 2233 334</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="BankAccountRequest" />
    /// </summary>
    public class BankAccountRequestJsonConverter : JsonConverter<BankAccountRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="BankAccountRequest" />
        /// </summary>
        ...
        public override BankAccountRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<BankAccountRequest.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<BankAccountRequest.TypeEnum?>(BankAccountRequest.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "bic":
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class BankAccountRequest.", nameof(name));

            if (!bankAccountNumber.IsSet)
                throw new ArgumentException("Property is required for class BankAccountRequest.", nameof(bankAccountNumber));

            if (!type.IsSet)
                throw new ArgumentException("Property is required for class BankAccountRequest.", nameof(type));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class BankAccountRequest.");

            if (bankAccountNumber.IsSet && bankAccountNumber.Value == null)
                throw new ArgumentNullException(nameof(bankAccountNumber), "Property is not nullable for class BankAccountRequest.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class BankAccountRequest.");

            if (bic.IsSet && bic.Value == null)
                throw new ArgumentNullException(nameof(bic), "Property is not nullable for class BankAccountRequest.");

            if (iban.IsSet && iban.Value == null)
                throw new ArgumentNullException(nameof(iban), "Property is not nullable for class BankAccountRequest.");

            if (foreignService.IsSet && foreignService.Value == null)
                throw new ArgumentNullException(nameof(foreignService), "Property is not nullable for class BankAccountRequest.");

            if (inactive.IsSet && inactive.Value == null)
                throw new ArgumentNullException(nameof(inactive), "Property is not nullable for class BankAccountRequest.");

            return new BankAccountRequest(name.Value!, bankAccountNumber.Value!, type.Value!.Value!, bic, iban, foreignService, inactive);
        }

        /// <summary>
        /// Serializes a <see cref="BankAccountRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankAccountRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, BankAccountRequest bankAccountRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, bankAccountRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="BankAccountRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bankAccountRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, BankAccountRequest bankAccountRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (bankAccountRequest.Name == null)
                throw new ArgumentNullException(nameof(bankAccountRequest.Name), "Property is required for class BankAccountRequest.");

            if (bankAccountRequest.BankAccountNumber == null)
                throw new ArgumentNullException(nameof(bankAccountRequest.BankAccountNumber), "Property is required for class BankAccountRequest.");

            if (bankAccountRequest.BicOption.IsSet && bankAccountRequest.Bic == null)
                throw new ArgumentNullException(nameof(bankAccountRequest.Bic), "Property is required for class BankAccountRequest.");

            if (bankAccountRequest.IbanOption.IsSet && bankAccountRequest.Iban == null)
                throw new ArgumentNullException(nameof(bankAccountRequest.Iban), "Property is required for class BankAccountRequest.");

            if (bankAccountRequest.ForeignServiceOption.IsSet && bankAccountRequest.ForeignService == null)
                throw new ArgumentNullException(nameof(bankAccountRequest.ForeignService), "Property is required for class BankAccountRequest.");

            writer.WriteString("name", bankAccountRequest.Name);

            writer.WriteString("bankAccountNumber", bankAccountRequest.BankAccountNumber);

            var typeRawValue = BankAccountRequest.TypeEnumToJsonValue(bankAccountRequest.Type);
            writer.WriteString("type", typeRawValue);
            if (bankAccountRequest.BicOption.IsSet)
                writer.WriteString("bic", bankAccountRequest.Bic);

            if (bankAccountRequest.IbanOption.IsSet)
                writer.WriteString("iban", bankAccountRequest.Iban);

            if (bankAccountRequest.ForeignServiceOption.IsSet)
                writer.WriteString("foreignService", bankAccountRequest.ForeignService);

            if (bankAccountRequest.InactiveOption.IsSet)
                writer.WriteBoolean("inactive", bankAccountRequest.InactiveOption.Value!.Value);
        }
    }
}
