...
namespace Fiken.Model
{
    ...
    public partial class Product : IValidatableObject
    {
        ...
        /// <param name="incomeAccount">The accounting account that will receive the payment.</param>
        ...
        /// <param name="createdDate">Date that product was created in Fiken, format yyyy-mm-dd</param>
        /// <param name="lastModifiedDate">Date that product was last modified in Fiken, format yyyy-mm-dd.</param>
        /// <param name="unitPrice">The net unit price in cents.</param>
        /// <param name="active">If product is in use (True) or not (False). (default to true)</param>
        /// <param name="productNumber">productNumber</param>
        /// <param name="stock">Number of products available in stock. If not provided, stock value is set to null. Decimal values are accepted. For example 5.5</param>
        /// <param name="note">Optional field for additional information.</param>
        [JsonConstructor]
        public Product(string name, string incomeAccount, string vatType, Option<long?> productId = default, Option<DateOnly?> createdDate = default, Option<DateOnly?> lastModifiedDate = default, Option<long?> unitPrice = default, bool active = true, Option<string?> productNumber = default, Option<float?> stock = default, Option<string?> note = default)
        {
            Name = name;
            ...
            Active = active;
            ProductNumberOption = productNumber;
            StockOption = stock;
            NoteOption = note;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of ProductNumber
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> ProductNumberOption { get; private set; }

        /// <summary>
        /// Gets or Sets ProductNumber
        /// </summary>
        /* <example>125-1</example> */
        [JsonPropertyName("productNumber")]
        public string? ProductNumber { get { return this.ProductNumberOption; } set { this.ProductNumberOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<float?> StockOption { get; private set; }
        ...
        public float? Stock { get { return this.StockOption; } set { this.StockOption = new(value); } }
    ...
    public class ProductJsonConverter : JsonConverter<Product>
    {
        ...
        public override Product Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> productNumber = default;
            Option<float?> stock = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "active":
                            ...
                            break;
                        case "productNumber":
                            productNumber = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "stock":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                stock = new Option<float?>((float)utf8JsonReader.GetDouble());
                            break;
                        case "note":
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class Product.", nameof(name));

            if (!incomeAccount.IsSet)
                throw new ArgumentException("Property is required for class Product.", nameof(incomeAccount));

            if (!vatType.IsSet)
                throw new ArgumentException("Property is required for class Product.", nameof(vatType));

            if (!active.IsSet)
                throw new ArgumentException("Property is required for class Product.", nameof(active));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class Product.");

            if (incomeAccount.IsSet && incomeAccount.Value == null)
                throw new ArgumentNullException(nameof(incomeAccount), "Property is not nullable for class Product.");

            if (vatType.IsSet && vatType.Value == null)
                throw new ArgumentNullException(nameof(vatType), "Property is not nullable for class Product.");

            if (productId.IsSet && productId.Value == null)
                throw new ArgumentNullException(nameof(productId), "Property is not nullable for class Product.");

            if (createdDate.IsSet && createdDate.Value == null)
                throw new ArgumentNullException(nameof(createdDate), "Property is not nullable for class Product.");

            if (lastModifiedDate.IsSet && lastModifiedDate.Value == null)
                throw new ArgumentNullException(nameof(lastModifiedDate), "Property is not nullable for class Product.");

            if (unitPrice.IsSet && unitPrice.Value == null)
                throw new ArgumentNullException(nameof(unitPrice), "Property is not nullable for class Product.");

            if (active.IsSet && active.Value == null)
                throw new ArgumentNullException(nameof(active), "Property is not nullable for class Product.");

            if (productNumber.IsSet && productNumber.Value == null)
                throw new ArgumentNullException(nameof(productNumber), "Property is not nullable for class Product.");
            ...
            if (note.IsSet && note.Value == null)
                throw new ArgumentNullException(nameof(note), "Property is not nullable for class Product.");

            return new Product(name.Value!, incomeAccount.Value!, vatType.Value!, productId, createdDate, lastModifiedDate, unitPrice, active.Value!.Value!, productNumber, stock, note);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Product product, JsonSerializerOptions jsonSerializerOptions)
        {
            if (product.Name == null)
                throw new ArgumentNullException(nameof(product.Name), "Property is required for class Product.");

            if (product.IncomeAccount == null)
                throw new ArgumentNullException(nameof(product.IncomeAccount), "Property is required for class Product.");

            if (product.VatType == null)
                throw new ArgumentNullException(nameof(product.VatType), "Property is required for class Product.");

            if (product.ProductNumberOption.IsSet && product.ProductNumber == null)
                throw new ArgumentNullException(nameof(product.ProductNumber), "Property is required for class Product.");

            if (product.NoteOption.IsSet && product.Note == null)
                throw new ArgumentNullException(nameof(product.Note), "Property is required for class Product.");

            writer.WriteString("name", product.Name);

            writer.WriteString("incomeAccount", product.IncomeAccount);

            writer.WriteString("vatType", product.VatType);

            if (product.ProductIdOption.IsSet)
                writer.WriteNumber("productId", product.ProductIdOption.Value!.Value);

            if (product.CreatedDateOption.IsSet)
                writer.WriteString("createdDate", product.CreatedDateOption.Value!.Value.ToString(CreatedDateFormat));

            if (product.LastModifiedDateOption.IsSet)
                writer.WriteString("lastModifiedDate", product.LastModifiedDateOption.Value!.Value.ToString(LastModifiedDateFormat));

            if (product.UnitPriceOption.IsSet)
                writer.WriteNumber("unitPrice", product.UnitPriceOption.Value!.Value);

            writer.WriteBoolean("active", product.Active);

            if (product.ProductNumberOption.IsSet)
                writer.WriteString("productNumber", product.ProductNumber);

            if (product.StockOption.IsSet)
                writer.WriteNumber("stock", product.StockOption.Value!.Value);

            if (product.NoteOption.IsSet)
                writer.WriteString("note", product.Note);
        }
    }
}
