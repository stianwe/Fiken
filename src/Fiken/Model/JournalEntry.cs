...
namespace Fiken.Model
{
    ...
    public partial class JournalEntry : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="description">We add the flag &#39;Fri postering registrert via API: &#39;. This must be taken into account in the max length of the description</param>
        /// <param name="date">date</param>
        /// <param name="lines">lines</param>
        /// <param name="journalEntryId">journalEntryId</param>
        /// <param name="createdDate">Date that journal entry was created in Fiken, format yyyy-mm-dd</param>
        /// <param name="lastModifiedDate">Date that journal entry was last modified in Fiken, format yyyy-mm-dd.</param>
        /// <param name="transactionId">transactionId</param>
        /// <param name="offsetTransactionId">If a journal entry has been cancelled this provides the id of the balancing transaction</param>
        /// <param name="journalEntryNumber">journalEntryNumber</param>
        /// <param name="attachments">attachments</param>
        [JsonConstructor]
        public JournalEntry(string description, DateOnly date, List<JournalEntryLine> lines, Option<long?> journalEntryId = default, Option<DateOnly?> createdDate = default, Option<DateOnly?> lastModifiedDate = default, Option<long?> transactionId = default, Option<long?> offsetTransactionId = default, Option<int?> journalEntryNumber = default, Option<List<Attachment>?> attachments = default)
        {
            Description = description;
            Date = date;
            Lines = lines;
            JournalEntryIdOption = journalEntryId;
            CreatedDateOption = createdDate;
            LastModifiedDateOption = lastModifiedDate;
            TransactionIdOption = transactionId;
            OffsetTransactionIdOption = offsetTransactionId;
            JournalEntryNumberOption = journalEntryNumber;
        ...
        /// <summary>
        /// We add the flag &#39;Fri postering registrert via API: &#39;. This must be taken into account in the max length of the description
        /// </summary>
        /// <value>We add the flag &#39;Fri postering registrert via API: &#39;. This must be taken into account in the max length of the description</value>
        /* <example>Purchase, Schweigaards Gate 34 AS (invoice nr 26083)</example> */
        ...
        /// <summary>
        /// Used to track the state of JournalEntryId
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> JournalEntryIdOption { get; }

        /// <summary>
        /// Gets or Sets JournalEntryId
        /// </summary>
        [JsonPropertyName("journalEntryId")]
        public long? JournalEntryId { get { return this.JournalEntryIdOption; } }
        ...
        /// </summary>
        /// <value>Date that journal entry was created in Fiken, format yyyy-mm-dd</value>
        /* <example>Tue Apr 03 02:00:00 CEST 2018</example> */
        ...
        /// </summary>
        /// <value>Date that journal entry was last modified in Fiken, format yyyy-mm-dd.</value>
        /* <example>Tue Apr 03 02:00:00 CEST 2018</example> */
        ...
        /// <summary>
        /// Used to track the state of OffsetTransactionId
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> OffsetTransactionIdOption { get; }
        ...
        [JsonPropertyName("offsetTransactionId")]
        public long? OffsetTransactionId { get { return this.OffsetTransactionIdOption; } }

        /// <summary>
        /// Used to track the state of JournalEntryNumber
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<int?> JournalEntryNumberOption { get; }
        ...
        public int? JournalEntryNumber { get { return this.JournalEntryNumberOption; } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<Attachment>?> AttachmentsOption { get; }

        /// <summary>
        /// Gets or Sets Attachments
        /// </summary>
        [JsonPropertyName("attachments")]
        public List<Attachment>? Attachments { get { return this.AttachmentsOption; } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OffsetTransactionId: ").Append(OffsetTransactionId).Append("\n");
            sb.Append("  JournalEntryNumber: ").Append(JournalEntryNumber).Append("\n");
    ...
    public class JournalEntryJsonConverter : JsonConverter<JournalEntry>
    {
        ...
        public override JournalEntry Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<JournalEntryLine>?> lines = default;
            Option<long?> journalEntryId = default;
            Option<DateOnly?> createdDate = default;
            Option<DateOnly?> lastModifiedDate = default;
            Option<long?> transactionId = default;
            Option<long?> offsetTransactionId = default;
            Option<int?> journalEntryNumber = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "lines":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                lines = new Option<List<JournalEntryLine>?>(JsonSerializer.Deserialize<List<JournalEntryLine>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "journalEntryId":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                journalEntryId = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
                        case "createdDate":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "offsetTransactionId":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                offsetTransactionId = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
                        case "journalEntryNumber":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                journalEntryNumber = new Option<int?>(utf8JsonReader.GetInt32());
                            break;
                        case "attachments":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (!description.IsSet)
                throw new ArgumentException("Property is required for class JournalEntry.", nameof(description));

            if (!date.IsSet)
                throw new ArgumentException("Property is required for class JournalEntry.", nameof(date));

            if (!lines.IsSet)
                throw new ArgumentException("Property is required for class JournalEntry.", nameof(lines));

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class JournalEntry.");

            if (date.IsSet && date.Value == null)
                throw new ArgumentNullException(nameof(date), "Property is not nullable for class JournalEntry.");

            if (lines.IsSet && lines.Value == null)
                throw new ArgumentNullException(nameof(lines), "Property is not nullable for class JournalEntry.");

            if (journalEntryId.IsSet && journalEntryId.Value == null)
                throw new ArgumentNullException(nameof(journalEntryId), "Property is not nullable for class JournalEntry.");

            if (createdDate.IsSet && createdDate.Value == null)
                throw new ArgumentNullException(nameof(createdDate), "Property is not nullable for class JournalEntry.");

            if (lastModifiedDate.IsSet && lastModifiedDate.Value == null)
                throw new ArgumentNullException(nameof(lastModifiedDate), "Property is not nullable for class JournalEntry.");

            if (transactionId.IsSet && transactionId.Value == null)
                throw new ArgumentNullException(nameof(transactionId), "Property is not nullable for class JournalEntry.");

            if (offsetTransactionId.IsSet && offsetTransactionId.Value == null)
                throw new ArgumentNullException(nameof(offsetTransactionId), "Property is not nullable for class JournalEntry.");

            if (journalEntryNumber.IsSet && journalEntryNumber.Value == null)
                throw new ArgumentNullException(nameof(journalEntryNumber), "Property is not nullable for class JournalEntry.");

            if (attachments.IsSet && attachments.Value == null)
                throw new ArgumentNullException(nameof(attachments), "Property is not nullable for class JournalEntry.");

            return new JournalEntry(description.Value!, date.Value!.Value!, lines.Value!, journalEntryId, createdDate, lastModifiedDate, transactionId, offsetTransactionId, journalEntryNumber, attachments);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, JournalEntry journalEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            if (journalEntry.Description == null)
                throw new ArgumentNullException(nameof(journalEntry.Description), "Property is required for class JournalEntry.");

            if (journalEntry.Lines == null)
                throw new ArgumentNullException(nameof(journalEntry.Lines), "Property is required for class JournalEntry.");

            if (journalEntry.AttachmentsOption.IsSet && journalEntry.Attachments == null)
                throw new ArgumentNullException(nameof(journalEntry.Attachments), "Property is required for class JournalEntry.");

            writer.WriteString("description", journalEntry.Description);

            writer.WriteString("date", journalEntry.Date.ToString(DateFormat));

            writer.WritePropertyName("lines");
            JsonSerializer.Serialize(writer, journalEntry.Lines, jsonSerializerOptions);
            if (journalEntry.JournalEntryIdOption.IsSet)
                writer.WriteNumber("journalEntryId", journalEntry.JournalEntryIdOption.Value!.Value);

            if (journalEntry.CreatedDateOption.IsSet)
                writer.WriteString("createdDate", journalEntry.CreatedDateOption.Value!.Value.ToString(CreatedDateFormat));

            if (journalEntry.LastModifiedDateOption.IsSet)
                writer.WriteString("lastModifiedDate", journalEntry.LastModifiedDateOption.Value!.Value.ToString(LastModifiedDateFormat));

            if (journalEntry.TransactionIdOption.IsSet)
                writer.WriteNumber("transactionId", journalEntry.TransactionIdOption.Value!.Value);

            if (journalEntry.OffsetTransactionIdOption.IsSet)
                writer.WriteNumber("offsetTransactionId", journalEntry.OffsetTransactionIdOption.Value!.Value);

            if (journalEntry.JournalEntryNumberOption.IsSet)
                writer.WriteNumber("journalEntryNumber", journalEntry.JournalEntryNumberOption.Value!.Value);

            if (journalEntry.AttachmentsOption.IsSet)
            {
                writer.WritePropertyName("attachments");
                JsonSerializer.Serialize(writer, journalEntry.Attachments, jsonSerializerOptions);
            }
        }
    }
}
