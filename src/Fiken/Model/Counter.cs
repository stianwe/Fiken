...
namespace Fiken.Model
{
    ...
    /// Counter
    /// </summary>
    public partial class Counter : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Counter" /> class.
        /// </summary>
        /// <param name="value">Current value of the counter (default to 10000)</param>
        [JsonConstructor]
        public Counter(Option<int?> value = default)
        {
            ValueOption = value;
            OnCreated();
        }
        ...
        /// </summary>
        /// <value>Current value of the counter</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="Counter" />
    /// </summary>
    public class CounterJsonConverter : JsonConverter<Counter>
    {
        /// <summary>
        /// Deserializes json to <see cref="Counter" />
        /// </summary>
        ...
        public override Counter Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class Counter.");

            return new Counter(value);
        }

        /// <summary>
        /// Serializes a <see cref="Counter" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="counter"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Counter counter, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, counter, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Counter" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="counter"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Counter counter, JsonSerializerOptions jsonSerializerOptions)
        {
            if (counter.ValueOption.IsSet)
                writer.WriteNumber("value", counter.ValueOption.Value!.Value);
        }
    }
}
