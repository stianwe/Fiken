...
namespace Fiken.Model
{
    ...
    /// </summary>
    public partial class ProductSalesLineInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductSalesLineInfo" /> class.
        /// </summary>
        /// <param name="count">count</param>
        /// <param name="sales">sales</param>
        /// <param name="netAmount">Net amount excluding VAT in cents (5000 &#x3D; 50.00)</param>
        /// <param name="vatAmount">VAT amount for sale in cents (500 &#x3D; 5.00)</param>
        /// <param name="grossAmount">Gross amount of sale (net + VAT) in cents (5500 &#x3D; 55.00)</param>
        [JsonConstructor]
        public ProductSalesLineInfo(Option<long?> count = default, Option<long?> sales = default, Option<long?> netAmount = default, Option<long?> vatAmount = default, Option<long?> grossAmount = default)
        {
            CountOption = count;
            SalesOption = sales;
        ...
        /// <summary>
        /// Used to track the state of Sales
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> SalesOption { get; private set; }
        ...
        public long? Sales { get { return this.SalesOption; } set { this.SalesOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<long?> GrossAmountOption { get; private set; }
        ...
        public long? GrossAmount { get { return this.GrossAmountOption; } set { this.GrossAmountOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProductSalesLineInfo" />
    /// </summary>
    public class ProductSalesLineInfoJsonConverter : JsonConverter<ProductSalesLineInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="ProductSalesLineInfo" />
        /// </summary>
        ...
        public override ProductSalesLineInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "sales":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                sales = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
                        case "netAmount":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "grossAmount":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                grossAmount = new Option<long?>(utf8JsonReader.GetInt64());
                            break;
                        default:
                            break;
                    }
            ...
            if (count.IsSet && count.Value == null)
                throw new ArgumentNullException(nameof(count), "Property is not nullable for class ProductSalesLineInfo.");

            if (sales.IsSet && sales.Value == null)
                throw new ArgumentNullException(nameof(sales), "Property is not nullable for class ProductSalesLineInfo.");

            if (netAmount.IsSet && netAmount.Value == null)
                throw new ArgumentNullException(nameof(netAmount), "Property is not nullable for class ProductSalesLineInfo.");

            if (vatAmount.IsSet && vatAmount.Value == null)
                throw new ArgumentNullException(nameof(vatAmount), "Property is not nullable for class ProductSalesLineInfo.");

            if (grossAmount.IsSet && grossAmount.Value == null)
                throw new ArgumentNullException(nameof(grossAmount), "Property is not nullable for class ProductSalesLineInfo.");

            return new ProductSalesLineInfo(count, sales, netAmount, vatAmount, grossAmount);
        }

        /// <summary>
        /// Serializes a <see cref="ProductSalesLineInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="productSalesLineInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProductSalesLineInfo productSalesLineInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, productSalesLineInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProductSalesLineInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="productSalesLineInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProductSalesLineInfo productSalesLineInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (productSalesLineInfo.CountOption.IsSet)
                writer.WriteNumber("count", productSalesLineInfo.CountOption.Value!.Value);

            if (productSalesLineInfo.SalesOption.IsSet)
                writer.WriteNumber("sales", productSalesLineInfo.SalesOption.Value!.Value);

            if (productSalesLineInfo.NetAmountOption.IsSet)
                writer.WriteNumber("netAmount", productSalesLineInfo.NetAmountOption.Value!.Value);

            if (productSalesLineInfo.VatAmountOption.IsSet)
                writer.WriteNumber("vatAmount", productSalesLineInfo.VatAmountOption.Value!.Value);

            if (productSalesLineInfo.GrossAmountOption.IsSet)
                writer.WriteNumber("grossAmount", productSalesLineInfo.GrossAmountOption.Value!.Value);
        }
    }
}
