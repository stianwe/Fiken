...
namespace Fiken.Model
{
    ...
    public partial class Transaction : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Transaction(Option<long?> transactionId = default, Option<DateOnly?> createdDate = default, Option<DateOnly?> lastModifiedDate = default, Option<string?> description = default, Option<string?> type = default, Option<List<JournalEntry>?> entries = default)
        {
        ...
        /// Gets or Sets Type
        /// </summary>
        /* <example>General Journal Entry</example> */
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<JournalEntry>?> EntriesOption { get; private set; }

        /// <summary>
        /// Gets or Sets Entries
        /// </summary>
        [JsonPropertyName("entries")]
        public List<JournalEntry>? Entries { get { return this.EntriesOption; } set { this.EntriesOption = new(value); } }
    ...
    public class TransactionJsonConverter : JsonConverter<Transaction>
    {
        ...
        public override Transaction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<JournalEntry>?> entries = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "entries":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                entries = new Option<List<JournalEntry>?>(JsonSerializer.Deserialize<List<JournalEntry>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (transactionId.IsSet && transactionId.Value == null)
                throw new ArgumentNullException(nameof(transactionId), "Property is not nullable for class Transaction.");

            if (createdDate.IsSet && createdDate.Value == null)
                throw new ArgumentNullException(nameof(createdDate), "Property is not nullable for class Transaction.");

            if (lastModifiedDate.IsSet && lastModifiedDate.Value == null)
                throw new ArgumentNullException(nameof(lastModifiedDate), "Property is not nullable for class Transaction.");
            ...
            if (entries.IsSet && entries.Value == null)
                throw new ArgumentNullException(nameof(entries), "Property is not nullable for class Transaction.");

            return new Transaction(transactionId, createdDate, lastModifiedDate, description, type, entries);
        }
        ...
        {
            if (transaction.DescriptionOption.IsSet && transaction.Description == null)
                throw new ArgumentNullException(nameof(transaction.Description), "Property is required for class Transaction.");

            if (transaction.TypeOption.IsSet && transaction.Type == null)
                throw new ArgumentNullException(nameof(transaction.Type), "Property is required for class Transaction.");

            if (transaction.EntriesOption.IsSet && transaction.Entries == null)
                throw new ArgumentNullException(nameof(transaction.Entries), "Property is required for class Transaction.");

            if (transaction.TransactionIdOption.IsSet)
                writer.WriteNumber("transactionId", transaction.TransactionIdOption.Value!.Value);

            if (transaction.CreatedDateOption.IsSet)
                writer.WriteString("createdDate", transaction.CreatedDateOption.Value!.Value.ToString(CreatedDateFormat));

            if (transaction.LastModifiedDateOption.IsSet)
                writer.WriteString("lastModifiedDate", transaction.LastModifiedDateOption.Value!.Value.ToString(LastModifiedDateFormat));

            if (transaction.DescriptionOption.IsSet)
                writer.WriteString("description", transaction.Description);

            if (transaction.TypeOption.IsSet)
                writer.WriteString("type", transaction.Type);

            if (transaction.EntriesOption.IsSet)
            {
                writer.WritePropertyName("entries");
                JsonSerializer.Serialize(writer, transaction.Entries, jsonSerializerOptions);
            }
        }
    }
}
