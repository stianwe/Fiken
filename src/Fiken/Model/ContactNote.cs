...
namespace Fiken.Model
{
    ...
    public partial class ContactNote : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ContactNote(Option<string?> author = default, Option<string?> note = default)
        {
            AuthorOption = author;
            NoteOption = note;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="ContactNote" />
    /// </summary>
    public class ContactNoteJsonConverter : JsonConverter<ContactNote>
    {
        /// <summary>
        /// Deserializes json to <see cref="ContactNote" />
        /// </summary>
        ...
        public override ContactNote Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (author.IsSet && author.Value == null)
                throw new ArgumentNullException(nameof(author), "Property is not nullable for class ContactNote.");

            if (note.IsSet && note.Value == null)
                throw new ArgumentNullException(nameof(note), "Property is not nullable for class ContactNote.");

            return new ContactNote(author, note);
        }

        /// <summary>
        /// Serializes a <see cref="ContactNote" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="contactNote"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ContactNote contactNote, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, contactNote, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ContactNote" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="contactNote"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ContactNote contactNote, JsonSerializerOptions jsonSerializerOptions)
        {
            if (contactNote.AuthorOption.IsSet && contactNote.Author == null)
                throw new ArgumentNullException(nameof(contactNote.Author), "Property is required for class ContactNote.");

            if (contactNote.NoteOption.IsSet && contactNote.Note == null)
                throw new ArgumentNullException(nameof(contactNote.Note), "Property is required for class ContactNote.");

            if (contactNote.AuthorOption.IsSet)
                writer.WriteString("author", contactNote.Author);

            if (contactNote.NoteOption.IsSet)
                writer.WriteString("note", contactNote.Note);
        }
    }
}
