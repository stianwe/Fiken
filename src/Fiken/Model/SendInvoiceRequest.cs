...
namespace Fiken.Model
{
    ...
    /// SendInvoiceRequest
    /// </summary>
    public partial class SendInvoiceRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public SendInvoiceRequest(List<SendInvoiceRequest.MethodEnum> method, long invoiceId, bool includeDocumentAttachments = true, Option<string?> recipientName = default, Option<string?> recipientEmail = default, Option<string?> message = default, Option<EmailSendOptionEnum?> emailSendOption = default, Option<bool?> mergeInvoiceAndAttachments = default, Option<string?> organizationNumber = default, Option<string?> mobileNumber = default)
        {
            Method = method;
            InvoiceId = invoiceId;
        ...
        public List<SendInvoiceRequest.MethodEnum> Method { get; set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="SendInvoiceRequest" />
    /// </summary>
    public class SendInvoiceRequestJsonConverter : JsonConverter<SendInvoiceRequest>
    {
        /// <summary>
        /// Deserializes json to <see cref="SendInvoiceRequest" />
        /// </summary>
        ...
        public override SendInvoiceRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<SendInvoiceRequest.MethodEnum>?> method = default;
            ...
            Option<SendInvoiceRequest.EmailSendOptionEnum?> emailSendOption = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "method":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                method = new Option<List<SendInvoiceRequest.MethodEnum>?>(JsonSerializer.Deserialize<List<SendInvoiceRequest.MethodEnum>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "invoiceId":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "emailSendOption":
                            ...
                            if (emailSendOptionRawValue != null)
                                emailSendOption = new Option<SendInvoiceRequest.EmailSendOptionEnum?>(SendInvoiceRequest.EmailSendOptionEnumFromStringOrDefault(emailSendOptionRawValue));
                            break;
            ...
            if (!method.IsSet)
                throw new ArgumentException("Property is required for class SendInvoiceRequest.", nameof(method));

            if (!invoiceId.IsSet)
                throw new ArgumentException("Property is required for class SendInvoiceRequest.", nameof(invoiceId));

            if (!includeDocumentAttachments.IsSet)
                throw new ArgumentException("Property is required for class SendInvoiceRequest.", nameof(includeDocumentAttachments));

            if (method.IsSet && method.Value == null)
                throw new ArgumentNullException(nameof(method), "Property is not nullable for class SendInvoiceRequest.");

            if (invoiceId.IsSet && invoiceId.Value == null)
                throw new ArgumentNullException(nameof(invoiceId), "Property is not nullable for class SendInvoiceRequest.");

            if (includeDocumentAttachments.IsSet && includeDocumentAttachments.Value == null)
                throw new ArgumentNullException(nameof(includeDocumentAttachments), "Property is not nullable for class SendInvoiceRequest.");

            if (recipientName.IsSet && recipientName.Value == null)
                throw new ArgumentNullException(nameof(recipientName), "Property is not nullable for class SendInvoiceRequest.");

            if (recipientEmail.IsSet && recipientEmail.Value == null)
                throw new ArgumentNullException(nameof(recipientEmail), "Property is not nullable for class SendInvoiceRequest.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class SendInvoiceRequest.");

            if (emailSendOption.IsSet && emailSendOption.Value == null)
                throw new ArgumentNullException(nameof(emailSendOption), "Property is not nullable for class SendInvoiceRequest.");

            if (mergeInvoiceAndAttachments.IsSet && mergeInvoiceAndAttachments.Value == null)
                throw new ArgumentNullException(nameof(mergeInvoiceAndAttachments), "Property is not nullable for class SendInvoiceRequest.");

            if (organizationNumber.IsSet && organizationNumber.Value == null)
                throw new ArgumentNullException(nameof(organizationNumber), "Property is not nullable for class SendInvoiceRequest.");

            if (mobileNumber.IsSet && mobileNumber.Value == null)
                throw new ArgumentNullException(nameof(mobileNumber), "Property is not nullable for class SendInvoiceRequest.");

            return new SendInvoiceRequest(method.Value!, invoiceId.Value!.Value!, includeDocumentAttachments.Value!.Value!, recipientName, recipientEmail, message, emailSendOption, mergeInvoiceAndAttachments, organizationNumber, mobileNumber);
        }

        /// <summary>
        /// Serializes a <see cref="SendInvoiceRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendInvoiceRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SendInvoiceRequest sendInvoiceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sendInvoiceRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SendInvoiceRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendInvoiceRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SendInvoiceRequest sendInvoiceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sendInvoiceRequest.Method == null)
                throw new ArgumentNullException(nameof(sendInvoiceRequest.Method), "Property is required for class SendInvoiceRequest.");

            if (sendInvoiceRequest.RecipientNameOption.IsSet && sendInvoiceRequest.RecipientName == null)
                throw new ArgumentNullException(nameof(sendInvoiceRequest.RecipientName), "Property is required for class SendInvoiceRequest.");

            if (sendInvoiceRequest.RecipientEmailOption.IsSet && sendInvoiceRequest.RecipientEmail == null)
                throw new ArgumentNullException(nameof(sendInvoiceRequest.RecipientEmail), "Property is required for class SendInvoiceRequest.");

            if (sendInvoiceRequest.MessageOption.IsSet && sendInvoiceRequest.Message == null)
                throw new ArgumentNullException(nameof(sendInvoiceRequest.Message), "Property is required for class SendInvoiceRequest.");

            if (sendInvoiceRequest.OrganizationNumberOption.IsSet && sendInvoiceRequest.OrganizationNumber == null)
                throw new ArgumentNullException(nameof(sendInvoiceRequest.OrganizationNumber), "Property is required for class SendInvoiceRequest.");

            if (sendInvoiceRequest.MobileNumberOption.IsSet && sendInvoiceRequest.MobileNumber == null)
                throw new ArgumentNullException(nameof(sendInvoiceRequest.MobileNumber), "Property is required for class SendInvoiceRequest.");

            writer.WritePropertyName("method");
            JsonSerializer.Serialize(writer, sendInvoiceRequest.Method, jsonSerializerOptions);
            writer.WriteNumber("invoiceId", sendInvoiceRequest.InvoiceId);

            writer.WriteBoolean("includeDocumentAttachments", sendInvoiceRequest.IncludeDocumentAttachments);

            if (sendInvoiceRequest.RecipientNameOption.IsSet)
                writer.WriteString("recipientName", sendInvoiceRequest.RecipientName);

            if (sendInvoiceRequest.RecipientEmailOption.IsSet)
                writer.WriteString("recipientEmail", sendInvoiceRequest.RecipientEmail);

            if (sendInvoiceRequest.MessageOption.IsSet)
                writer.WriteString("message", sendInvoiceRequest.Message);

            var emailSendOptionRawValue = SendInvoiceRequest.EmailSendOptionEnumToJsonValue(sendInvoiceRequest.EmailSendOptionOption.Value!.Value);
            writer.WriteString("emailSendOption", emailSendOptionRawValue);
            if (sendInvoiceRequest.MergeInvoiceAndAttachmentsOption.IsSet)
                writer.WriteBoolean("mergeInvoiceAndAttachments", sendInvoiceRequest.MergeInvoiceAndAttachmentsOption.Value!.Value);

            if (sendInvoiceRequest.OrganizationNumberOption.IsSet)
                writer.WriteString("organizationNumber", sendInvoiceRequest.OrganizationNumber);

            if (sendInvoiceRequest.MobileNumberOption.IsSet)
                writer.WriteString("mobileNumber", sendInvoiceRequest.MobileNumber);
        }
    }
}
