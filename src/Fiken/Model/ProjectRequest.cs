...
namespace Fiken.Model
{
    ...
    public partial class ProjectRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ProjectRequest(string number, string name, DateOnly startDate, Option<string?> description = default, Option<DateOnly?> endDate = default, Option<long?> contactId = default, Option<bool?> completed = default)
        {
            Number = number;
            Name = name;
            StartDate = startDate;
    ...
    public class ProjectRequestJsonConverter : JsonConverter<ProjectRequest>
    {
        ...
        public override ProjectRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!number.IsSet)
                throw new ArgumentException("Property is required for class ProjectRequest.", nameof(number));

            if (!name.IsSet)
                throw new ArgumentException("Property is required for class ProjectRequest.", nameof(name));

            if (!startDate.IsSet)
                throw new ArgumentException("Property is required for class ProjectRequest.", nameof(startDate));

            if (number.IsSet && number.Value == null)
                throw new ArgumentNullException(nameof(number), "Property is not nullable for class ProjectRequest.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ProjectRequest.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class ProjectRequest.");

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class ProjectRequest.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class ProjectRequest.");

            if (contactId.IsSet && contactId.Value == null)
                throw new ArgumentNullException(nameof(contactId), "Property is not nullable for class ProjectRequest.");

            if (completed.IsSet && completed.Value == null)
                throw new ArgumentNullException(nameof(completed), "Property is not nullable for class ProjectRequest.");

            return new ProjectRequest(number.Value!, name.Value!, startDate.Value!.Value!, description, endDate, contactId, completed);
        }
        ...
        {
            if (projectRequest.Number == null)
                throw new ArgumentNullException(nameof(projectRequest.Number), "Property is required for class ProjectRequest.");
            ...
            if (projectRequest.DescriptionOption.IsSet && projectRequest.Description == null)
                throw new ArgumentNullException(nameof(projectRequest.Description), "Property is required for class ProjectRequest.");

            writer.WriteString("number", projectRequest.Number);

            writer.WriteString("name", projectRequest.Name);

            writer.WriteString("startDate", projectRequest.StartDate.ToString(StartDateFormat));

            if (projectRequest.DescriptionOption.IsSet)
                writer.WriteString("description", projectRequest.Description);

            if (projectRequest.EndDateOption.IsSet)
                writer.WriteString("endDate", projectRequest.EndDateOption.Value!.Value.ToString(EndDateFormat));

            if (projectRequest.ContactIdOption.IsSet)
                writer.WriteNumber("contactId", projectRequest.ContactIdOption.Value!.Value);

            if (projectRequest.CompletedOption.IsSet)
                writer.WriteBoolean("completed", projectRequest.CompletedOption.Value!.Value);
        }
    }
}
