...
namespace Fiken.Model
{
    ...
    /// InvoiceRequest
    /// </summary>
    public partial class InvoiceRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceRequest" /> class.
        /// </summary>
        /// <param name="issueDate">Date that the invoice was issued, format yyyy-mm-dd</param>
        /// <param name="dueDate">Due date of invoice, format yyyy-mm-dd</param>
        /// <param name="lines">lines</param>
        /// <param name="customerId">customerId &#x3D; contactId where customer &#x3D; true</param>
        /// <param name="bankAccountCode">Bank account code associated with invoice, format 1920:XXXXX</param>
        /// <param name="cash">Payment taken in cash (True) or not (False).</param>
        /// <param name="uuid">UUID are represented as 32 hexadecimal (base-16) digits, displayed in 5 groups separated by hyphens, in the form 8-4-4-4-12 for a total of 36 characters. If not provided, API will generate a UUID.</param>
        /// <param name="ourReference">ourReference</param>
        /// <param name="yourReference">Your reference for invoice, free string format</param>
        ...
        /// <param name="currency">ISO 4217 currency code. Defaults to \&quot;NOK\&quot; if unspecified.</param>
        /// <param name="invoiceText">If not present, and standard text is registered, standard text is printed.</param>
        /// <param name="paymentAccount">For Cash Invoices only. For instance \&quot;1920:10001\&quot;.</param>
        /// <param name="projectId">Optional - Associated project for the invoice to be created.</param>
        [JsonConstructor]
        public InvoiceRequest(DateOnly issueDate, DateOnly dueDate, List<InvoiceLineRequest> lines, long customerId, string bankAccountCode, bool cash, Option<string?> uuid = default, Option<string?> ourReference = default, Option<string?> yourReference = default, Option<string?> orderReference = default, Option<long?> contactPersonId = default, Option<string?> currency = default, Option<string?> invoiceText = default, Option<string?> paymentAccount = default, Option<long?> projectId = default)
        {
            IssueDate = issueDate;
            DueDate = dueDate;
            Lines = lines;
        ...
        /// </summary>
        /// <value>UUID are represented as 32 hexadecimal (base-16) digits, displayed in 5 groups separated by hyphens, in the form 8-4-4-4-12 for a total of 36 characters. If not provided, API will generate a UUID.</value>
        ...
        /// </summary>
        /// <value>If not present, and standard text is registered, standard text is printed.</value>
        /* <example>Invoice for services rendered during the Oslo Knitting Festival.</example> */
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // InvoiceText (string) maxLength
            if (this.InvoiceText != null && this.InvoiceText.Length > 500)
            {
                yield return new ValidationResult("Invalid value for InvoiceText, length must be less than 500.", new [] { "InvoiceText" });
            }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InvoiceRequest" />
    /// </summary>
    public class InvoiceRequestJsonConverter : JsonConverter<InvoiceRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="InvoiceRequest" />
        /// </summary>
        ...
        public override InvoiceRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<InvoiceLineRequest>?> lines = default;
            Option<long?> customerId = default;
            Option<string?> bankAccountCode = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "lines":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                lines = new Option<List<InvoiceLineRequest>?>(JsonSerializer.Deserialize<List<InvoiceLineRequest>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "customerId":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                        ...
                        case "bankAccountCode":
                            bankAccountCode = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "cash":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
            ...
            if (!issueDate.IsSet)
                throw new ArgumentException("Property is required for class InvoiceRequest.", nameof(issueDate));

            if (!dueDate.IsSet)
                throw new ArgumentException("Property is required for class InvoiceRequest.", nameof(dueDate));

            if (!lines.IsSet)
                throw new ArgumentException("Property is required for class InvoiceRequest.", nameof(lines));

            if (!customerId.IsSet)
                throw new ArgumentException("Property is required for class InvoiceRequest.", nameof(customerId));

            if (!bankAccountCode.IsSet)
                throw new ArgumentException("Property is required for class InvoiceRequest.", nameof(bankAccountCode));

            if (!cash.IsSet)
                throw new ArgumentException("Property is required for class InvoiceRequest.", nameof(cash));

            if (issueDate.IsSet && issueDate.Value == null)
                throw new ArgumentNullException(nameof(issueDate), "Property is not nullable for class InvoiceRequest.");

            if (dueDate.IsSet && dueDate.Value == null)
                throw new ArgumentNullException(nameof(dueDate), "Property is not nullable for class InvoiceRequest.");

            if (lines.IsSet && lines.Value == null)
                throw new ArgumentNullException(nameof(lines), "Property is not nullable for class InvoiceRequest.");

            if (customerId.IsSet && customerId.Value == null)
                throw new ArgumentNullException(nameof(customerId), "Property is not nullable for class InvoiceRequest.");

            if (bankAccountCode.IsSet && bankAccountCode.Value == null)
                throw new ArgumentNullException(nameof(bankAccountCode), "Property is not nullable for class InvoiceRequest.");

            if (cash.IsSet && cash.Value == null)
                throw new ArgumentNullException(nameof(cash), "Property is not nullable for class InvoiceRequest.");

            if (uuid.IsSet && uuid.Value == null)
                throw new ArgumentNullException(nameof(uuid), "Property is not nullable for class InvoiceRequest.");

            if (ourReference.IsSet && ourReference.Value == null)
                throw new ArgumentNullException(nameof(ourReference), "Property is not nullable for class InvoiceRequest.");

            if (yourReference.IsSet && yourReference.Value == null)
                throw new ArgumentNullException(nameof(yourReference), "Property is not nullable for class InvoiceRequest.");

            if (orderReference.IsSet && orderReference.Value == null)
                throw new ArgumentNullException(nameof(orderReference), "Property is not nullable for class InvoiceRequest.");

            if (contactPersonId.IsSet && contactPersonId.Value == null)
                throw new ArgumentNullException(nameof(contactPersonId), "Property is not nullable for class InvoiceRequest.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class InvoiceRequest.");

            if (invoiceText.IsSet && invoiceText.Value == null)
                throw new ArgumentNullException(nameof(invoiceText), "Property is not nullable for class InvoiceRequest.");

            if (paymentAccount.IsSet && paymentAccount.Value == null)
                throw new ArgumentNullException(nameof(paymentAccount), "Property is not nullable for class InvoiceRequest.");

            if (projectId.IsSet && projectId.Value == null)
                throw new ArgumentNullException(nameof(projectId), "Property is not nullable for class InvoiceRequest.");

            return new InvoiceRequest(issueDate.Value!.Value!, dueDate.Value!.Value!, lines.Value!, customerId.Value!.Value!, bankAccountCode.Value!, cash.Value!.Value!, uuid, ourReference, yourReference, orderReference, contactPersonId, currency, invoiceText, paymentAccount, projectId);
        }

        /// <summary>
        /// Serializes a <see cref="InvoiceRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="invoiceRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InvoiceRequest invoiceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, invoiceRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InvoiceRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="invoiceRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InvoiceRequest invoiceRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (invoiceRequest.Lines == null)
                throw new ArgumentNullException(nameof(invoiceRequest.Lines), "Property is required for class InvoiceRequest.");

            if (invoiceRequest.BankAccountCode == null)
                throw new ArgumentNullException(nameof(invoiceRequest.BankAccountCode), "Property is required for class InvoiceRequest.");

            if (invoiceRequest.UuidOption.IsSet && invoiceRequest.Uuid == null)
                throw new ArgumentNullException(nameof(invoiceRequest.Uuid), "Property is required for class InvoiceRequest.");

            if (invoiceRequest.OurReferenceOption.IsSet && invoiceRequest.OurReference == null)
                throw new ArgumentNullException(nameof(invoiceRequest.OurReference), "Property is required for class InvoiceRequest.");

            if (invoiceRequest.YourReferenceOption.IsSet && invoiceRequest.YourReference == null)
                throw new ArgumentNullException(nameof(invoiceRequest.YourReference), "Property is required for class InvoiceRequest.");

            if (invoiceRequest.OrderReferenceOption.IsSet && invoiceRequest.OrderReference == null)
                throw new ArgumentNullException(nameof(invoiceRequest.OrderReference), "Property is required for class InvoiceRequest.");

            if (invoiceRequest.CurrencyOption.IsSet && invoiceRequest.Currency == null)
                throw new ArgumentNullException(nameof(invoiceRequest.Currency), "Property is required for class InvoiceRequest.");

            if (invoiceRequest.InvoiceTextOption.IsSet && invoiceRequest.InvoiceText == null)
                throw new ArgumentNullException(nameof(invoiceRequest.InvoiceText), "Property is required for class InvoiceRequest.");

            if (invoiceRequest.PaymentAccountOption.IsSet && invoiceRequest.PaymentAccount == null)
                throw new ArgumentNullException(nameof(invoiceRequest.PaymentAccount), "Property is required for class InvoiceRequest.");

            writer.WriteString("issueDate", invoiceRequest.IssueDate.ToString(IssueDateFormat));

            writer.WriteString("dueDate", invoiceRequest.DueDate.ToString(DueDateFormat));

            writer.WritePropertyName("lines");
            JsonSerializer.Serialize(writer, invoiceRequest.Lines, jsonSerializerOptions);
            writer.WriteNumber("customerId", invoiceRequest.CustomerId);

            writer.WriteString("bankAccountCode", invoiceRequest.BankAccountCode);

            writer.WriteBoolean("cash", invoiceRequest.Cash);

            if (invoiceRequest.UuidOption.IsSet)
                writer.WriteString("uuid", invoiceRequest.Uuid);

            if (invoiceRequest.OurReferenceOption.IsSet)
                writer.WriteString("ourReference", invoiceRequest.OurReference);

            if (invoiceRequest.YourReferenceOption.IsSet)
                writer.WriteString("yourReference", invoiceRequest.YourReference);

            if (invoiceRequest.OrderReferenceOption.IsSet)
                writer.WriteString("orderReference", invoiceRequest.OrderReference);

            if (invoiceRequest.ContactPersonIdOption.IsSet)
                writer.WriteNumber("contactPersonId", invoiceRequest.ContactPersonIdOption.Value!.Value);

            if (invoiceRequest.CurrencyOption.IsSet)
                writer.WriteString("currency", invoiceRequest.Currency);

            if (invoiceRequest.InvoiceTextOption.IsSet)
                writer.WriteString("invoiceText", invoiceRequest.InvoiceText);

            if (invoiceRequest.PaymentAccountOption.IsSet)
                writer.WriteString("paymentAccount", invoiceRequest.PaymentAccount);

            if (invoiceRequest.ProjectIdOption.IsSet)
                writer.WriteNumber("projectId", invoiceRequest.ProjectIdOption.Value!.Value);
        }
    }
}
