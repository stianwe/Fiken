...
namespace Fiken.Api
{
    ...
    public interface ICompaniesApi : IApi
    {
        ...
        /// <param name="sortBy"> (optional, default to name asc)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCompaniesApiResponse"/>&gt;</returns>
        Task<IGetCompaniesApiResponse> GetCompaniesAsync(Option<int> page = default, Option<int> pageSize = default, Option<string> sortBy = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCompaniesApiResponse"/>?&gt;</returns>
        Task<IGetCompaniesApiResponse?> GetCompaniesOrDefaultAsync(Option<int> page = default, Option<int> pageSize = default, Option<string> sortBy = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCompanyApiResponse"/>&gt;</returns>
        Task<IGetCompanyApiResponse> GetCompanyAsync(string companySlug, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCompanyApiResponse"/>?&gt;</returns>
        Task<IGetCompanyApiResponse?> GetCompanyOrDefaultAsync(string companySlug, System.Threading.CancellationToken cancellationToken = default);
    }

    /// <summary>
    /// The <see cref="IGetCompaniesApiResponse"/>
    /// </summary>
    public interface IGetCompaniesApiResponse : Fiken.Client.IApiResponse, IOk<List<Company>?>
    {
        /// <summary>
    ...
    /// <summary>
    /// The <see cref="IGetCompanyApiResponse"/>
    /// </summary>
    public interface IGetCompanyApiResponse : Fiken.Client.IApiResponse, IOk<Fiken.Model.Company?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public class CompaniesApiEvents
    {
        ...
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnGetCompanies;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorGetCompanies;

        internal void ExecuteOnGetCompanies(CompaniesApi.GetCompaniesApiResponse apiResponse)
        {
            OnGetCompanies?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorGetCompanies(Exception exception)
        {
            OnErrorGetCompanies?.Invoke(this, new ExceptionEventArgs(exception));
        }

        /// <summary>
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnGetCompany;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorGetCompany;

        internal void ExecuteOnGetCompany(CompaniesApi.GetCompanyApiResponse apiResponse)
        {
            OnGetCompany?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorGetCompany(Exception exception)
        {
            OnErrorGetCompany?.Invoke(this, new ExceptionEventArgs(exception));
        }
    }
    ...
    public sealed partial class CompaniesApi : ICompaniesApi
    {
        ...
        partial void FormatGetCompanies(ref Option<int> page, ref Option<int> pageSize, ref Option<string> sortBy);
        ...
        /// <returns></returns>
        private void ValidateGetCompanies(Option<string> sortBy)
        {
        ...
        /// <param name="sortBy"></param>
        private void AfterGetCompaniesDefaultImplementation(IGetCompaniesApiResponse apiResponseLocalVar, Option<int> page, Option<int> pageSize, Option<string> sortBy)
        {
            bool suppressDefaultLog = false;
            AfterGetCompanies(ref suppressDefaultLog, apiResponseLocalVar, page, pageSize, sortBy);
        ...
        /// <param name="pageSize"></param>
        /// <param name="sortBy"></param>
        partial void AfterGetCompanies(ref bool suppressDefaultLog, IGetCompaniesApiResponse apiResponseLocalVar, Option<int> page, Option<int> pageSize, Option<string> sortBy);
        ...
        /// <param name="pageSize"></param>
        /// <param name="sortBy"></param>
        private void OnErrorGetCompaniesDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> page, Option<int> pageSize, Option<string> sortBy)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetCompanies(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, page, pageSize, sortBy);
        ...
        /// <param name="pageSize"></param>
        /// <param name="sortBy"></param>
        partial void OnErrorGetCompanies(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<int> page, Option<int> pageSize, Option<string> sortBy);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCompaniesApiResponse"/>&gt;</returns>
        public async Task<IGetCompaniesApiResponse?> GetCompaniesOrDefaultAsync(Option<int> page = default, Option<int> pageSize = default, Option<string> sortBy = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetCompaniesAsync(page, pageSize, sortBy, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCompaniesApiResponse"/>&gt;</returns>
        public async Task<IGetCompaniesApiResponse> GetCompaniesAsync(Option<int> page = default, Option<int> pageSize = default, Option<string> sortBy = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetCompanies(sortBy);

                FormatGetCompanies(ref page, ref pageSize, ref sortBy);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ILogger<GetCompaniesApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<GetCompaniesApiResponse>();

                        GetCompaniesApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetCompaniesDefaultImplementation(apiResponseLocalVar, page, pageSize, sortBy);

                        Events.ExecuteOnGetCompanies(apiResponseLocalVar);
            ...
            {
                OnErrorGetCompaniesDefaultImplementation(e, "/companies", uriBuilderLocalVar.Path, page, pageSize, sortBy);
                Events.ExecuteOnErrorGetCompanies(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="GetCompaniesApiResponse"/>
        /// </summary>
        public partial class GetCompaniesApiResponse : Fiken.Client.ApiResponse, IGetCompaniesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<GetCompaniesApiResponse> Logger { get; }
            ...
            public GetCompaniesApiResponse(ILogger<GetCompaniesApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out List<Company>? result)
            {
                result = null;
        ...
        partial void FormatGetCompany(ref string companySlug);
        ...
        /// <returns></returns>
        private void ValidateGetCompany(string companySlug)
        {
            if (companySlug == null)
        ...
        /// <param name="apiResponseLocalVar"></param>
        /// <param name="companySlug"></param>
        private void AfterGetCompanyDefaultImplementation(IGetCompanyApiResponse apiResponseLocalVar, string companySlug)
        {
            bool suppressDefaultLog = false;
            AfterGetCompany(ref suppressDefaultLog, apiResponseLocalVar, companySlug);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="apiResponseLocalVar"></param>
        /// <param name="companySlug"></param>
        partial void AfterGetCompany(ref bool suppressDefaultLog, IGetCompanyApiResponse apiResponseLocalVar, string companySlug);
        ...
        /// <param name="pathLocalVar"></param>
        /// <param name="companySlug"></param>
        private void OnErrorGetCompanyDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetCompany(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="pathLocalVar"></param>
        /// <param name="companySlug"></param>
        partial void OnErrorGetCompany(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCompanyApiResponse"/>&gt;</returns>
        public async Task<IGetCompanyApiResponse?> GetCompanyOrDefaultAsync(string companySlug, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetCompanyAsync(companySlug, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetCompanyApiResponse"/>&gt;</returns>
        public async Task<IGetCompanyApiResponse> GetCompanyAsync(string companySlug, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetCompany(companySlug);

                FormatGetCompany(ref companySlug);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies/{companySlug}";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ILogger<GetCompanyApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<GetCompanyApiResponse>();

                        GetCompanyApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetCompanyDefaultImplementation(apiResponseLocalVar, companySlug);

                        Events.ExecuteOnGetCompany(apiResponseLocalVar);
            ...
            {
                OnErrorGetCompanyDefaultImplementation(e, "/companies/{companySlug}", uriBuilderLocalVar.Path, companySlug);
                Events.ExecuteOnErrorGetCompany(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="GetCompanyApiResponse"/>
        /// </summary>
        public partial class GetCompanyApiResponse : Fiken.Client.ApiResponse, IGetCompanyApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<GetCompanyApiResponse> Logger { get; }
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public GetCompanyApiResponse(ILogger<GetCompanyApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
            ...
            /// </summary>
            /// <returns></returns>
            public Fiken.Model.Company? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Fiken.Model.Company>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Fiken.Model.Company? result)
            {
                result = null;
