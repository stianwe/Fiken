...
namespace Fiken.Api
{
    ...
    /// </summary>
    public interface IAccountBalancesApi : IApi
    {
        /// <summary>
        /// The class containing the events
        /// </summary>
        AccountBalancesApiEvents Events { get; }
        ...
        /// <returns><see cref="Task"/>&lt;<see cref="IGetAccountBalanceApiResponse"/>&gt;</returns>
        Task<IGetAccountBalanceApiResponse> GetAccountBalanceAsync(string companySlug, string accountCode, DateOnly date, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetAccountBalanceApiResponse"/>?&gt;</returns>
        Task<IGetAccountBalanceApiResponse?> GetAccountBalanceOrDefaultAsync(string companySlug, string accountCode, DateOnly date, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetAccountBalancesApiResponse"/>&gt;</returns>
        Task<IGetAccountBalancesApiResponse> GetAccountBalancesAsync(string companySlug, DateOnly date, Option<long> fromAccount = default, Option<long> toAccount = default, Option<int> page = default, Option<int> pageSize = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetAccountBalancesApiResponse"/>?&gt;</returns>
        Task<IGetAccountBalancesApiResponse?> GetAccountBalancesOrDefaultAsync(string companySlug, DateOnly date, Option<long> fromAccount = default, Option<long> toAccount = default, Option<int> page = default, Option<int> pageSize = default, System.Threading.CancellationToken cancellationToken = default);
    }

    /// <summary>
    /// The <see cref="IGetAccountBalanceApiResponse"/>
    /// </summary>
    public interface IGetAccountBalanceApiResponse : Fiken.Client.IApiResponse, IOk<Fiken.Model.AccountBalance?>
    {
        /// <summary>
    ...
    /// <summary>
    /// The <see cref="IGetAccountBalancesApiResponse"/>
    /// </summary>
    public interface IGetAccountBalancesApiResponse : Fiken.Client.IApiResponse, IOk<List<AccountBalance>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class AccountBalancesApiEvents
    {
        /// <summary>
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnGetAccountBalance;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorGetAccountBalance;

        internal void ExecuteOnGetAccountBalance(AccountBalancesApi.GetAccountBalanceApiResponse apiResponse)
        {
            OnGetAccountBalance?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorGetAccountBalance(Exception exception)
        {
            OnErrorGetAccountBalance?.Invoke(this, new ExceptionEventArgs(exception));
        }

        /// <summary>
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnGetAccountBalances;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorGetAccountBalances;

        internal void ExecuteOnGetAccountBalances(AccountBalancesApi.GetAccountBalancesApiResponse apiResponse)
        {
            OnGetAccountBalances?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorGetAccountBalances(Exception exception)
        {
            OnErrorGetAccountBalances?.Invoke(this, new ExceptionEventArgs(exception));
        }
    }
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public sealed partial class AccountBalancesApi : IAccountBalancesApi
    {
        ...
        /// The logger
        /// </summary>
        public ILogger<AccountBalancesApi> Logger { get; }
        ...
        /// The class containing the events
        /// </summary>
        public AccountBalancesApiEvents Events { get; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountBalancesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AccountBalancesApi(ILogger<AccountBalancesApi> logger, ILoggerFactory loggerFactory, HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, AccountBalancesApiEvents accountBalancesApiEvents,
            TokenProvider<OAuthToken> oauthTokenProvider)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = LoggerFactory.CreateLogger<AccountBalancesApi>();
            HttpClient = httpClient;
            Events = accountBalancesApiEvents;
            OauthTokenProvider = oauthTokenProvider;
        }

        partial void FormatGetAccountBalance(ref string companySlug, ref string accountCode, ref DateOnly date);
        ...
        /// <returns></returns>
        private void ValidateGetAccountBalance(string companySlug, string accountCode)
        {
            if (companySlug == null)
        ...
        private void AfterGetAccountBalanceDefaultImplementation(IGetAccountBalanceApiResponse apiResponseLocalVar, string companySlug, string accountCode, DateOnly date)
        {
            bool suppressDefaultLog = false;
            AfterGetAccountBalance(ref suppressDefaultLog, apiResponseLocalVar, companySlug, accountCode, date);
        ...
        /// <param name="accountCode"></param>
        /// <param name="date"></param>
        partial void AfterGetAccountBalance(ref bool suppressDefaultLog, IGetAccountBalanceApiResponse apiResponseLocalVar, string companySlug, string accountCode, DateOnly date);
        ...
        /// <param name="accountCode"></param>
        /// <param name="date"></param>
        private void OnErrorGetAccountBalanceDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, string accountCode, DateOnly date)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetAccountBalance(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, accountCode, date);
        ...
        /// <param name="accountCode"></param>
        /// <param name="date"></param>
        partial void OnErrorGetAccountBalance(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, string accountCode, DateOnly date);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetAccountBalanceApiResponse"/>&gt;</returns>
        public async Task<IGetAccountBalanceApiResponse?> GetAccountBalanceOrDefaultAsync(string companySlug, string accountCode, DateOnly date, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetAccountBalanceAsync(companySlug, accountCode, date, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetAccountBalanceApiResponse"/>&gt;</returns>
        public async Task<IGetAccountBalanceApiResponse> GetAccountBalanceAsync(string companySlug, string accountCode, DateOnly date, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetAccountBalance(companySlug, accountCode);

                FormatGetAccountBalance(ref companySlug, ref accountCode, ref date);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies/{companySlug}/accountBalances/{accountCode}";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ILogger<GetAccountBalanceApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<GetAccountBalanceApiResponse>();

                        GetAccountBalanceApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/accountBalances/{accountCode}", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetAccountBalanceDefaultImplementation(apiResponseLocalVar, companySlug, accountCode, date);

                        Events.ExecuteOnGetAccountBalance(apiResponseLocalVar);
            ...
            {
                OnErrorGetAccountBalanceDefaultImplementation(e, "/companies/{companySlug}/accountBalances/{accountCode}", uriBuilderLocalVar.Path, companySlug, accountCode, date);
                Events.ExecuteOnErrorGetAccountBalance(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="GetAccountBalanceApiResponse"/>
        /// </summary>
        public partial class GetAccountBalanceApiResponse : Fiken.Client.ApiResponse, IGetAccountBalanceApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<GetAccountBalanceApiResponse> Logger { get; }
            ...
            public GetAccountBalanceApiResponse(ILogger<GetAccountBalanceApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
            ...
            /// </summary>
            /// <returns></returns>
            public Fiken.Model.AccountBalance? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Fiken.Model.AccountBalance>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Fiken.Model.AccountBalance? result)
            {
                result = null;
        ...
        partial void FormatGetAccountBalances(ref string companySlug, ref DateOnly date, ref Option<long> fromAccount, ref Option<long> toAccount, ref Option<int> page, ref Option<int> pageSize);
        ...
        /// <param name="companySlug"></param>
        /// <returns></returns>
        private void ValidateGetAccountBalances(string companySlug)
        {
            if (companySlug == null)
                throw new ArgumentNullException(nameof(companySlug));
        }
        ...
        private void AfterGetAccountBalancesDefaultImplementation(IGetAccountBalancesApiResponse apiResponseLocalVar, string companySlug, DateOnly date, Option<long> fromAccount, Option<long> toAccount, Option<int> page, Option<int> pageSize)
        {
            bool suppressDefaultLog = false;
            AfterGetAccountBalances(ref suppressDefaultLog, apiResponseLocalVar, companySlug, date, fromAccount, toAccount, page, pageSize);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="page"></param>
        /// <param name="pageSize"></param>
        partial void AfterGetAccountBalances(ref bool suppressDefaultLog, IGetAccountBalancesApiResponse apiResponseLocalVar, string companySlug, DateOnly date, Option<long> fromAccount, Option<long> toAccount, Option<int> page, Option<int> pageSize);
        ...
        /// <param name="page"></param>
        /// <param name="pageSize"></param>
        private void OnErrorGetAccountBalancesDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, DateOnly date, Option<long> fromAccount, Option<long> toAccount, Option<int> page, Option<int> pageSize)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetAccountBalances(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, date, fromAccount, toAccount, page, pageSize);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="page"></param>
        /// <param name="pageSize"></param>
        partial void OnErrorGetAccountBalances(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, DateOnly date, Option<long> fromAccount, Option<long> toAccount, Option<int> page, Option<int> pageSize);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetAccountBalancesApiResponse"/>&gt;</returns>
        public async Task<IGetAccountBalancesApiResponse?> GetAccountBalancesOrDefaultAsync(string companySlug, DateOnly date, Option<long> fromAccount = default, Option<long> toAccount = default, Option<int> page = default, Option<int> pageSize = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetAccountBalancesAsync(companySlug, date, fromAccount, toAccount, page, pageSize, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetAccountBalancesApiResponse"/>&gt;</returns>
        public async Task<IGetAccountBalancesApiResponse> GetAccountBalancesAsync(string companySlug, DateOnly date, Option<long> fromAccount = default, Option<long> toAccount = default, Option<int> page = default, Option<int> pageSize = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetAccountBalances(companySlug);

                FormatGetAccountBalances(ref companySlug, ref date, ref fromAccount, ref toAccount, ref page, ref pageSize);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies/{companySlug}/accountBalances";
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7BcompanySlug%7D", Uri.EscapeDataString(companySlug.ToString()));
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ILogger<GetAccountBalancesApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<GetAccountBalancesApiResponse>();

                        GetAccountBalancesApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/accountBalances", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetAccountBalancesDefaultImplementation(apiResponseLocalVar, companySlug, date, fromAccount, toAccount, page, pageSize);

                        Events.ExecuteOnGetAccountBalances(apiResponseLocalVar);
            ...
            {
                OnErrorGetAccountBalancesDefaultImplementation(e, "/companies/{companySlug}/accountBalances", uriBuilderLocalVar.Path, companySlug, date, fromAccount, toAccount, page, pageSize);
                Events.ExecuteOnErrorGetAccountBalances(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="GetAccountBalancesApiResponse"/>
        /// </summary>
        public partial class GetAccountBalancesApiResponse : Fiken.Client.ApiResponse, IGetAccountBalancesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<GetAccountBalancesApiResponse> Logger { get; }
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public GetAccountBalancesApiResponse(ILogger<GetAccountBalancesApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
            ...
            /// </summary>
            /// <returns></returns>
            public List<AccountBalance>? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<List<AccountBalance>>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out List<AccountBalance>? result)
            {
                result = null;
