...
namespace Fiken.Api
{
    ...
    /// </summary>
    public interface IInboxApi : IApi
    {
        /// <summary>
        /// The class containing the events
        /// </summary>
        InboxApiEvents Events { get; }
        ...
        /// <param name="name">The name of the inbox document, usually the same as the filename (optional)</param>
        /// <param name="filename">The filename of the file uploaded (optional)</param>
        /// <param name="description">Additional description of the inbox document (optional)</param>
        /// <param name="file"> (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateInboxDocumentApiResponse"/>&gt;</returns>
        Task<ICreateInboxDocumentApiResponse> CreateInboxDocumentAsync(string companySlug, Option<string> name = default, Option<string> filename = default, Option<string> description = default, Option<System.IO.Stream> file = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateInboxDocumentApiResponse"/>?&gt;</returns>
        Task<ICreateInboxDocumentApiResponse?> CreateInboxDocumentOrDefaultAsync(string companySlug, Option<string> name = default, Option<string> filename = default, Option<string> description = default, Option<System.IO.Stream> file = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="sortBy">Sorts results in either ascending (asc) or descending (desc) order based on the parameter value. (optional, default to createdDate desc)</param>
        /// <param name="status"> (optional, default to all)</param>
        /// <param name="name">Filter documents based on their name, case-insensitive substring match. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetInboxApiResponse"/>&gt;</returns>
        Task<IGetInboxApiResponse> GetInboxAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<string> sortBy = default, Option<string> status = default, Option<string> name = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetInboxApiResponse"/>?&gt;</returns>
        Task<IGetInboxApiResponse?> GetInboxOrDefaultAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<string> sortBy = default, Option<string> status = default, Option<string> name = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetInboxDocumentApiResponse"/>&gt;</returns>
        Task<IGetInboxDocumentApiResponse> GetInboxDocumentAsync(string companySlug, long inboxDocumentId, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetInboxDocumentApiResponse"/>?&gt;</returns>
        Task<IGetInboxDocumentApiResponse?> GetInboxDocumentOrDefaultAsync(string companySlug, long inboxDocumentId, System.Threading.CancellationToken cancellationToken = default);
    }

    /// <summary>
    /// The <see cref="ICreateInboxDocumentApiResponse"/>
    /// </summary>
    public interface ICreateInboxDocumentApiResponse : Fiken.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetInboxApiResponse : Fiken.Client.IApiResponse, IOk<List<InboxResult>?>
    {
        /// <summary>
    ...
    /// <summary>
    /// The <see cref="IGetInboxDocumentApiResponse"/>
    /// </summary>
    public interface IGetInboxDocumentApiResponse : Fiken.Client.IApiResponse, IOk<Fiken.Model.InboxResult?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class InboxApiEvents
    {
        /// <summary>
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnCreateInboxDocument;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorCreateInboxDocument;

        internal void ExecuteOnCreateInboxDocument(InboxApi.CreateInboxDocumentApiResponse apiResponse)
        {
            OnCreateInboxDocument?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorCreateInboxDocument(Exception exception)
        {
            OnErrorCreateInboxDocument?.Invoke(this, new ExceptionEventArgs(exception));
        }
        ...
        internal void ExecuteOnGetInbox(InboxApi.GetInboxApiResponse apiResponse)
        {
        ...
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnGetInboxDocument;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorGetInboxDocument;

        internal void ExecuteOnGetInboxDocument(InboxApi.GetInboxDocumentApiResponse apiResponse)
        {
            OnGetInboxDocument?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorGetInboxDocument(Exception exception)
        {
            OnErrorGetInboxDocument?.Invoke(this, new ExceptionEventArgs(exception));
        }
    }
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public sealed partial class InboxApi : IInboxApi
    {
        ...
        /// The logger
        /// </summary>
        public ILogger<InboxApi> Logger { get; }
        ...
        /// The class containing the events
        /// </summary>
        public InboxApiEvents Events { get; }
        ...
        /// </summary>
        /// <returns></returns>
        public InboxApi(ILogger<InboxApi> logger, ILoggerFactory loggerFactory, HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, InboxApiEvents inboxApiEvents,
            TokenProvider<OAuthToken> oauthTokenProvider)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = LoggerFactory.CreateLogger<InboxApi>();
            HttpClient = httpClient;
            Events = inboxApiEvents;
            OauthTokenProvider = oauthTokenProvider;
        }

        partial void FormatCreateInboxDocument(ref string companySlug, ref Option<string> name, ref Option<string> filename, ref Option<string> description, ref Option<System.IO.Stream> file);
        ...
        /// <returns></returns>
        private void ValidateCreateInboxDocument(string companySlug, Option<string> name, Option<string> filename, Option<string> description, Option<System.IO.Stream> file)
        {
            if (companySlug == null)
        ...
        /// <param name="description"></param>
        /// <param name="file"></param>
        private void AfterCreateInboxDocumentDefaultImplementation(ICreateInboxDocumentApiResponse apiResponseLocalVar, string companySlug, Option<string> name, Option<string> filename, Option<string> description, Option<System.IO.Stream> file)
        {
            bool suppressDefaultLog = false;
            AfterCreateInboxDocument(ref suppressDefaultLog, apiResponseLocalVar, companySlug, name, filename, description, file);
        ...
        /// <param name="description"></param>
        /// <param name="file"></param>
        partial void AfterCreateInboxDocument(ref bool suppressDefaultLog, ICreateInboxDocumentApiResponse apiResponseLocalVar, string companySlug, Option<string> name, Option<string> filename, Option<string> description, Option<System.IO.Stream> file);
        ...
        /// <param name="description"></param>
        /// <param name="file"></param>
        private void OnErrorCreateInboxDocumentDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, Option<string> name, Option<string> filename, Option<string> description, Option<System.IO.Stream> file)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorCreateInboxDocument(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, name, filename, description, file);
        ...
        /// <param name="description"></param>
        /// <param name="file"></param>
        partial void OnErrorCreateInboxDocument(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, Option<string> name, Option<string> filename, Option<string> description, Option<System.IO.Stream> file);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateInboxDocumentApiResponse"/>&gt;</returns>
        public async Task<ICreateInboxDocumentApiResponse?> CreateInboxDocumentOrDefaultAsync(string companySlug, Option<string> name = default, Option<string> filename = default, Option<string> description = default, Option<System.IO.Stream> file = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await CreateInboxDocumentAsync(companySlug, name, filename, description, file, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateInboxDocumentApiResponse"/>&gt;</returns>
        public async Task<ICreateInboxDocumentApiResponse> CreateInboxDocumentAsync(string companySlug, Option<string> name = default, Option<string> filename = default, Option<string> description = default, Option<System.IO.Stream> file = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateCreateInboxDocument(companySlug, name, filename, description, file);

                FormatCreateInboxDocument(ref companySlug, ref name, ref filename, ref description, ref file);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies/{companySlug}/inbox";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ILogger<CreateInboxDocumentApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<CreateInboxDocumentApiResponse>();

                        CreateInboxDocumentApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/inbox", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterCreateInboxDocumentDefaultImplementation(apiResponseLocalVar, companySlug, name, filename, description, file);

                        Events.ExecuteOnCreateInboxDocument(apiResponseLocalVar);
            ...
            {
                OnErrorCreateInboxDocumentDefaultImplementation(e, "/companies/{companySlug}/inbox", uriBuilderLocalVar.Path, companySlug, name, filename, description, file);
                Events.ExecuteOnErrorCreateInboxDocument(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="CreateInboxDocumentApiResponse"/>
        /// </summary>
        public partial class CreateInboxDocumentApiResponse : Fiken.Client.ApiResponse, ICreateInboxDocumentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<CreateInboxDocumentApiResponse> Logger { get; }
            ...
            public CreateInboxDocumentApiResponse(ILogger<CreateInboxDocumentApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
        ...
        partial void FormatGetInbox(ref string companySlug, ref Option<int> page, ref Option<int> pageSize, ref Option<string> sortBy, ref Option<string> status, ref Option<string> name);
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        private void ValidateGetInbox(string companySlug, Option<string> sortBy, Option<string> status, Option<string> name)
        {
            if (companySlug == null)
                throw new ArgumentNullException(nameof(companySlug));
        ...
        /// <param name="status"></param>
        /// <param name="name"></param>
        private void AfterGetInboxDefaultImplementation(IGetInboxApiResponse apiResponseLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<string> sortBy, Option<string> status, Option<string> name)
        {
            bool suppressDefaultLog = false;
            AfterGetInbox(ref suppressDefaultLog, apiResponseLocalVar, companySlug, page, pageSize, sortBy, status, name);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="status"></param>
        /// <param name="name"></param>
        partial void AfterGetInbox(ref bool suppressDefaultLog, IGetInboxApiResponse apiResponseLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<string> sortBy, Option<string> status, Option<string> name);
        ...
        /// <param name="status"></param>
        /// <param name="name"></param>
        private void OnErrorGetInboxDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<string> sortBy, Option<string> status, Option<string> name)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetInbox(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, page, pageSize, sortBy, status, name);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="status"></param>
        /// <param name="name"></param>
        partial void OnErrorGetInbox(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<string> sortBy, Option<string> status, Option<string> name);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetInboxApiResponse"/>&gt;</returns>
        public async Task<IGetInboxApiResponse?> GetInboxOrDefaultAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<string> sortBy = default, Option<string> status = default, Option<string> name = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetInboxAsync(companySlug, page, pageSize, sortBy, status, name, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetInboxApiResponse"/>&gt;</returns>
        public async Task<IGetInboxApiResponse> GetInboxAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<string> sortBy = default, Option<string> status = default, Option<string> name = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetInbox(companySlug, sortBy, status, name);

                FormatGetInbox(ref companySlug, ref page, ref pageSize, ref sortBy, ref status, ref name);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetInboxApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/inbox", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetInboxDefaultImplementation(apiResponseLocalVar, companySlug, page, pageSize, sortBy, status, name);
            ...
            {
                OnErrorGetInboxDefaultImplementation(e, "/companies/{companySlug}/inbox", uriBuilderLocalVar.Path, companySlug, page, pageSize, sortBy, status, name);
        ...
        /// </summary>
        public partial class GetInboxApiResponse : Fiken.Client.ApiResponse, IGetInboxApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public List<InboxResult>? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<List<InboxResult>>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out List<InboxResult>? result)
            {
                result = null;
        ...
        partial void FormatGetInboxDocument(ref string companySlug, ref long inboxDocumentId);
        ...
        /// <param name="companySlug"></param>
        /// <returns></returns>
        private void ValidateGetInboxDocument(string companySlug)
        {
            if (companySlug == null)
                throw new ArgumentNullException(nameof(companySlug));
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="inboxDocumentId"></param>
        private void AfterGetInboxDocumentDefaultImplementation(IGetInboxDocumentApiResponse apiResponseLocalVar, string companySlug, long inboxDocumentId)
        {
            bool suppressDefaultLog = false;
            AfterGetInboxDocument(ref suppressDefaultLog, apiResponseLocalVar, companySlug, inboxDocumentId);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="inboxDocumentId"></param>
        partial void AfterGetInboxDocument(ref bool suppressDefaultLog, IGetInboxDocumentApiResponse apiResponseLocalVar, string companySlug, long inboxDocumentId);
        ...
        /// <param name="companySlug"></param>
        /// <param name="inboxDocumentId"></param>
        private void OnErrorGetInboxDocumentDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, long inboxDocumentId)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetInboxDocument(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, inboxDocumentId);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="inboxDocumentId"></param>
        partial void OnErrorGetInboxDocument(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, long inboxDocumentId);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetInboxDocumentApiResponse"/>&gt;</returns>
        public async Task<IGetInboxDocumentApiResponse?> GetInboxDocumentOrDefaultAsync(string companySlug, long inboxDocumentId, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetInboxDocumentAsync(companySlug, inboxDocumentId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetInboxDocumentApiResponse"/>&gt;</returns>
        public async Task<IGetInboxDocumentApiResponse> GetInboxDocumentAsync(string companySlug, long inboxDocumentId, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetInboxDocument(companySlug);

                FormatGetInboxDocument(ref companySlug, ref inboxDocumentId);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies/{companySlug}/inbox/{inboxDocumentId}";
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7BcompanySlug%7D", Uri.EscapeDataString(companySlug.ToString()));
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7BinboxDocumentId%7D", Uri.EscapeDataString(inboxDocumentId.ToString()));
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ILogger<GetInboxDocumentApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<GetInboxDocumentApiResponse>();

                        GetInboxDocumentApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/inbox/{inboxDocumentId}", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetInboxDocumentDefaultImplementation(apiResponseLocalVar, companySlug, inboxDocumentId);

                        Events.ExecuteOnGetInboxDocument(apiResponseLocalVar);
            ...
            {
                OnErrorGetInboxDocumentDefaultImplementation(e, "/companies/{companySlug}/inbox/{inboxDocumentId}", uriBuilderLocalVar.Path, companySlug, inboxDocumentId);
                Events.ExecuteOnErrorGetInboxDocument(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="GetInboxDocumentApiResponse"/>
        /// </summary>
        public partial class GetInboxDocumentApiResponse : Fiken.Client.ApiResponse, IGetInboxDocumentApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<GetInboxDocumentApiResponse> Logger { get; }
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public GetInboxDocumentApiResponse(ILogger<GetInboxDocumentApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
            ...
            /// </summary>
            /// <returns></returns>
            public Fiken.Model.InboxResult? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Fiken.Model.InboxResult>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Fiken.Model.InboxResult? result)
            {
                result = null;
