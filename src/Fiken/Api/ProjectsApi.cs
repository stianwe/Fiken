...
namespace Fiken.Api
{
    ...
    public interface IProjectsApi : IApi
    {
        ...
        Task<ICreateProjectApiResponse> CreateProjectAsync(string companySlug, ProjectRequest projectRequest, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateProjectApiResponse"/>?&gt;</returns>
        Task<ICreateProjectApiResponse?> CreateProjectOrDefaultAsync(string companySlug, ProjectRequest projectRequest, System.Threading.CancellationToken cancellationToken = default);
        ...
        Task<IDeleteProjectApiResponse> DeleteProjectAsync(string companySlug, long projectId, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IDeleteProjectApiResponse"/>?&gt;</returns>
        Task<IDeleteProjectApiResponse?> DeleteProjectOrDefaultAsync(string companySlug, long projectId, System.Threading.CancellationToken cancellationToken = default);
        ...
        Task<IGetProjectApiResponse> GetProjectAsync(string companySlug, long projectId, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetProjectApiResponse"/>?&gt;</returns>
        Task<IGetProjectApiResponse?> GetProjectOrDefaultAsync(string companySlug, long projectId, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="completed">Filter results based on completed / not completed. (optional)</param>
        /// <param name="name">Filter results based on name of the project. (optional)</param>
        /// <param name="number">Filter results based on number of the project. (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetProjectsApiResponse"/>&gt;</returns>
        Task<IGetProjectsApiResponse> GetProjectsAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<bool> completed = default, Option<string> name = default, Option<string> number = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetProjectsApiResponse"/>?&gt;</returns>
        Task<IGetProjectsApiResponse?> GetProjectsOrDefaultAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<bool> completed = default, Option<string> name = default, Option<string> number = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        Task<IUpdateProjectApiResponse> UpdateProjectAsync(string companySlug, long projectId, UpdateProjectRequest updateProjectRequest, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IUpdateProjectApiResponse"/>?&gt;</returns>
        Task<IUpdateProjectApiResponse?> UpdateProjectOrDefaultAsync(string companySlug, long projectId, UpdateProjectRequest updateProjectRequest, System.Threading.CancellationToken cancellationToken = default);
    }

    /// <summary>
    /// The <see cref="ICreateProjectApiResponse"/>
    /// </summary>
    public interface ICreateProjectApiResponse : Fiken.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IDeleteProjectApiResponse : Fiken.Client.IApiResponse
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetProjectApiResponse : Fiken.Client.IApiResponse, IOk<Fiken.Model.ProjectResult?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IGetProjectsApiResponse : Fiken.Client.IApiResponse, IOk<List<ProjectResult>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IUpdateProjectApiResponse : Fiken.Client.IApiResponse
    {
        /// <summary>
        /// Returns true if the response is 201 Created
        /// </summary>
    ...
    public sealed partial class ProjectsApi : IProjectsApi
    {
        ...
        partial void FormatCreateProject(ref string companySlug, ProjectRequest projectRequest);
        ...
        /// <param name="projectRequest"></param>
        /// <returns></returns>
        private void ValidateCreateProject(string companySlug, ProjectRequest projectRequest)
        {
            if (companySlug == null)
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectRequest"></param>
        private void AfterCreateProjectDefaultImplementation(ICreateProjectApiResponse apiResponseLocalVar, string companySlug, ProjectRequest projectRequest)
        {
            bool suppressDefaultLog = false;
            AfterCreateProject(ref suppressDefaultLog, apiResponseLocalVar, companySlug, projectRequest);
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectRequest"></param>
        partial void AfterCreateProject(ref bool suppressDefaultLog, ICreateProjectApiResponse apiResponseLocalVar, string companySlug, ProjectRequest projectRequest);
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectRequest"></param>
        private void OnErrorCreateProjectDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, ProjectRequest projectRequest)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorCreateProject(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, projectRequest);
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectRequest"></param>
        partial void OnErrorCreateProject(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, ProjectRequest projectRequest);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateProjectApiResponse"/>&gt;</returns>
        public async Task<ICreateProjectApiResponse?> CreateProjectOrDefaultAsync(string companySlug, ProjectRequest projectRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await CreateProjectAsync(companySlug, projectRequest, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateProjectApiResponse"/>&gt;</returns>
        public async Task<ICreateProjectApiResponse> CreateProjectAsync(string companySlug, ProjectRequest projectRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateCreateProject(companySlug, projectRequest);

                FormatCreateProject(ref companySlug, projectRequest);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies/{companySlug}/projects";
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7BcompanySlug%7D", Uri.EscapeDataString(companySlug.ToString()));

                    httpRequestMessageLocalVar.Content = (projectRequest as object) is System.IO.Stream stream
                        ? httpRequestMessageLocalVar.Content = new StreamContent(stream)
                        : httpRequestMessageLocalVar.Content = new StringContent(JsonSerializer.Serialize(projectRequest, _jsonSerializerOptions));
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        CreateProjectApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/projects", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterCreateProjectDefaultImplementation(apiResponseLocalVar, companySlug, projectRequest);
            ...
            {
                OnErrorCreateProjectDefaultImplementation(e, "/companies/{companySlug}/projects", uriBuilderLocalVar.Path, companySlug, projectRequest);
        ...
        /// </summary>
        public partial class CreateProjectApiResponse : Fiken.Client.ApiResponse, ICreateProjectApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatDeleteProject(ref string companySlug, ref long projectId);
        ...
        /// <param name="companySlug"></param>
        /// <returns></returns>
        private void ValidateDeleteProject(string companySlug)
        {
            if (companySlug == null)
                throw new ArgumentNullException(nameof(companySlug));
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectId"></param>
        private void AfterDeleteProjectDefaultImplementation(IDeleteProjectApiResponse apiResponseLocalVar, string companySlug, long projectId)
        {
            bool suppressDefaultLog = false;
            AfterDeleteProject(ref suppressDefaultLog, apiResponseLocalVar, companySlug, projectId);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectId"></param>
        partial void AfterDeleteProject(ref bool suppressDefaultLog, IDeleteProjectApiResponse apiResponseLocalVar, string companySlug, long projectId);
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectId"></param>
        private void OnErrorDeleteProjectDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, long projectId)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorDeleteProject(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, projectId);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectId"></param>
        partial void OnErrorDeleteProject(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, long projectId);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IDeleteProjectApiResponse"/>&gt;</returns>
        public async Task<IDeleteProjectApiResponse?> DeleteProjectOrDefaultAsync(string companySlug, long projectId, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await DeleteProjectAsync(companySlug, projectId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IDeleteProjectApiResponse"/>&gt;</returns>
        public async Task<IDeleteProjectApiResponse> DeleteProjectAsync(string companySlug, long projectId, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateDeleteProject(companySlug);

                FormatDeleteProject(ref companySlug, ref projectId);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies/{companySlug}/projects/{projectId}";
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7BcompanySlug%7D", Uri.EscapeDataString(companySlug.ToString()));
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        DeleteProjectApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/projects/{projectId}", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterDeleteProjectDefaultImplementation(apiResponseLocalVar, companySlug, projectId);
            ...
            {
                OnErrorDeleteProjectDefaultImplementation(e, "/companies/{companySlug}/projects/{projectId}", uriBuilderLocalVar.Path, companySlug, projectId);
        ...
        /// </summary>
        public partial class DeleteProjectApiResponse : Fiken.Client.ApiResponse, IDeleteProjectApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        partial void FormatGetProject(ref string companySlug, ref long projectId);
        ...
        /// <param name="companySlug"></param>
        /// <returns></returns>
        private void ValidateGetProject(string companySlug)
        {
            if (companySlug == null)
                throw new ArgumentNullException(nameof(companySlug));
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectId"></param>
        private void AfterGetProjectDefaultImplementation(IGetProjectApiResponse apiResponseLocalVar, string companySlug, long projectId)
        {
            bool suppressDefaultLog = false;
            AfterGetProject(ref suppressDefaultLog, apiResponseLocalVar, companySlug, projectId);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectId"></param>
        partial void AfterGetProject(ref bool suppressDefaultLog, IGetProjectApiResponse apiResponseLocalVar, string companySlug, long projectId);
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectId"></param>
        private void OnErrorGetProjectDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, long projectId)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetProject(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, projectId);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="projectId"></param>
        partial void OnErrorGetProject(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, long projectId);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetProjectApiResponse"/>&gt;</returns>
        public async Task<IGetProjectApiResponse?> GetProjectOrDefaultAsync(string companySlug, long projectId, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetProjectAsync(companySlug, projectId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetProjectApiResponse"/>&gt;</returns>
        public async Task<IGetProjectApiResponse> GetProjectAsync(string companySlug, long projectId, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetProject(companySlug);

                FormatGetProject(ref companySlug, ref projectId);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetProjectApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/projects/{projectId}", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetProjectDefaultImplementation(apiResponseLocalVar, companySlug, projectId);
            ...
            {
                OnErrorGetProjectDefaultImplementation(e, "/companies/{companySlug}/projects/{projectId}", uriBuilderLocalVar.Path, companySlug, projectId);
        ...
        /// </summary>
        public partial class GetProjectApiResponse : Fiken.Client.ApiResponse, IGetProjectApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Fiken.Model.ProjectResult? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Fiken.Model.ProjectResult>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Fiken.Model.ProjectResult? result)
            {
                result = null;
        ...
        partial void FormatGetProjects(ref string companySlug, ref Option<int> page, ref Option<int> pageSize, ref Option<bool> completed, ref Option<string> name, ref Option<string> number);
        ...
        /// <returns></returns>
        private void ValidateGetProjects(string companySlug, Option<string> name, Option<string> number)
        {
            if (companySlug == null)
                throw new ArgumentNullException(nameof(companySlug));
        ...
        /// <param name="name"></param>
        /// <param name="number"></param>
        private void AfterGetProjectsDefaultImplementation(IGetProjectsApiResponse apiResponseLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<bool> completed, Option<string> name, Option<string> number)
        {
            bool suppressDefaultLog = false;
            AfterGetProjects(ref suppressDefaultLog, apiResponseLocalVar, companySlug, page, pageSize, completed, name, number);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="name"></param>
        /// <param name="number"></param>
        partial void AfterGetProjects(ref bool suppressDefaultLog, IGetProjectsApiResponse apiResponseLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<bool> completed, Option<string> name, Option<string> number);
        ...
        /// <param name="name"></param>
        /// <param name="number"></param>
        private void OnErrorGetProjectsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<bool> completed, Option<string> name, Option<string> number)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetProjects(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, page, pageSize, completed, name, number);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="name"></param>
        /// <param name="number"></param>
        partial void OnErrorGetProjects(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<bool> completed, Option<string> name, Option<string> number);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetProjectsApiResponse"/>&gt;</returns>
        public async Task<IGetProjectsApiResponse?> GetProjectsOrDefaultAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<bool> completed = default, Option<string> name = default, Option<string> number = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetProjectsAsync(companySlug, page, pageSize, completed, name, number, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetProjectsApiResponse"/>&gt;</returns>
        public async Task<IGetProjectsApiResponse> GetProjectsAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<bool> completed = default, Option<string> name = default, Option<string> number = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetProjects(companySlug, name, number);

                FormatGetProjects(ref companySlug, ref page, ref pageSize, ref completed, ref name, ref number);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetProjectsApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/projects", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetProjectsDefaultImplementation(apiResponseLocalVar, companySlug, page, pageSize, completed, name, number);
            ...
            {
                OnErrorGetProjectsDefaultImplementation(e, "/companies/{companySlug}/projects", uriBuilderLocalVar.Path, companySlug, page, pageSize, completed, name, number);
        ...
        /// </summary>
        public partial class GetProjectsApiResponse : Fiken.Client.ApiResponse, IGetProjectsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public List<ProjectResult>? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<List<ProjectResult>>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out List<ProjectResult>? result)
            {
                result = null;
        ...
        partial void FormatUpdateProject(ref string companySlug, ref long projectId, UpdateProjectRequest updateProjectRequest);
        ...
        /// <param name="updateProjectRequest"></param>
        /// <returns></returns>
        private void ValidateUpdateProject(string companySlug, UpdateProjectRequest updateProjectRequest)
        {
            if (companySlug == null)
                throw new ArgumentNullException(nameof(companySlug));
        ...
        /// <param name="projectId"></param>
        /// <param name="updateProjectRequest"></param>
        private void AfterUpdateProjectDefaultImplementation(IUpdateProjectApiResponse apiResponseLocalVar, string companySlug, long projectId, UpdateProjectRequest updateProjectRequest)
        {
            bool suppressDefaultLog = false;
            AfterUpdateProject(ref suppressDefaultLog, apiResponseLocalVar, companySlug, projectId, updateProjectRequest);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="projectId"></param>
        /// <param name="updateProjectRequest"></param>
        partial void AfterUpdateProject(ref bool suppressDefaultLog, IUpdateProjectApiResponse apiResponseLocalVar, string companySlug, long projectId, UpdateProjectRequest updateProjectRequest);
        ...
        /// <param name="projectId"></param>
        /// <param name="updateProjectRequest"></param>
        private void OnErrorUpdateProjectDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, long projectId, UpdateProjectRequest updateProjectRequest)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorUpdateProject(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, projectId, updateProjectRequest);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="projectId"></param>
        /// <param name="updateProjectRequest"></param>
        partial void OnErrorUpdateProject(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, long projectId, UpdateProjectRequest updateProjectRequest);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IUpdateProjectApiResponse"/>&gt;</returns>
        public async Task<IUpdateProjectApiResponse?> UpdateProjectOrDefaultAsync(string companySlug, long projectId, UpdateProjectRequest updateProjectRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await UpdateProjectAsync(companySlug, projectId, updateProjectRequest, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IUpdateProjectApiResponse"/>&gt;</returns>
        public async Task<IUpdateProjectApiResponse> UpdateProjectAsync(string companySlug, long projectId, UpdateProjectRequest updateProjectRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateUpdateProject(companySlug, updateProjectRequest);

                FormatUpdateProject(ref companySlug, ref projectId, updateProjectRequest);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        UpdateProjectApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/projects/{projectId}", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterUpdateProjectDefaultImplementation(apiResponseLocalVar, companySlug, projectId, updateProjectRequest);
            ...
            {
                OnErrorUpdateProjectDefaultImplementation(e, "/companies/{companySlug}/projects/{projectId}", uriBuilderLocalVar.Path, companySlug, projectId, updateProjectRequest);
        ...
        /// </summary>
        public partial class UpdateProjectApiResponse : Fiken.Client.ApiResponse, IUpdateProjectApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
