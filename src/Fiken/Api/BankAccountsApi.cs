...
namespace Fiken.Api
{
    ...
    /// </summary>
    public interface IBankAccountsApi : IApi
    {
        /// <summary>
        /// The class containing the events
        /// </summary>
        BankAccountsApiEvents Events { get; }
        ...
        /// <param name="bankAccountRequest"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateBankAccountApiResponse"/>&gt;</returns>
        Task<ICreateBankAccountApiResponse> CreateBankAccountAsync(string companySlug, BankAccountRequest bankAccountRequest, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateBankAccountApiResponse"/>?&gt;</returns>
        Task<ICreateBankAccountApiResponse?> CreateBankAccountOrDefaultAsync(string companySlug, BankAccountRequest bankAccountRequest, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetBankAccountApiResponse"/>&gt;</returns>
        Task<IGetBankAccountApiResponse> GetBankAccountAsync(string companySlug, long bankAccountId, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetBankAccountApiResponse"/>?&gt;</returns>
        Task<IGetBankAccountApiResponse?> GetBankAccountOrDefaultAsync(string companySlug, long bankAccountId, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="inactive">Return all active bank accounts (false) or all inactive bank accounts (true). (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetBankAccountsApiResponse"/>&gt;</returns>
        Task<IGetBankAccountsApiResponse> GetBankAccountsAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<bool> inactive = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetBankAccountsApiResponse"/>?&gt;</returns>
        Task<IGetBankAccountsApiResponse?> GetBankAccountsOrDefaultAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<bool> inactive = default, System.Threading.CancellationToken cancellationToken = default);
    }

    /// <summary>
    /// The <see cref="ICreateBankAccountApiResponse"/>
    /// </summary>
    public interface ICreateBankAccountApiResponse : Fiken.Client.IApiResponse
    {
        /// <summary>
    ...
    /// <summary>
    /// The <see cref="IGetBankAccountApiResponse"/>
    /// </summary>
    public interface IGetBankAccountApiResponse : Fiken.Client.IApiResponse, IOk<Fiken.Model.BankAccountResult?>
    {
        /// <summary>
    ...
    /// <summary>
    /// The <see cref="IGetBankAccountsApiResponse"/>
    /// </summary>
    public interface IGetBankAccountsApiResponse : Fiken.Client.IApiResponse, IOk<List<BankAccountResult>?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class BankAccountsApiEvents
    {
        /// <summary>
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnCreateBankAccount;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorCreateBankAccount;

        internal void ExecuteOnCreateBankAccount(BankAccountsApi.CreateBankAccountApiResponse apiResponse)
        {
            OnCreateBankAccount?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorCreateBankAccount(Exception exception)
        {
            OnErrorCreateBankAccount?.Invoke(this, new ExceptionEventArgs(exception));
        }

        /// <summary>
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnGetBankAccount;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorGetBankAccount;

        internal void ExecuteOnGetBankAccount(BankAccountsApi.GetBankAccountApiResponse apiResponse)
        {
            OnGetBankAccount?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorGetBankAccount(Exception exception)
        {
            OnErrorGetBankAccount?.Invoke(this, new ExceptionEventArgs(exception));
        }

        /// <summary>
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnGetBankAccounts;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorGetBankAccounts;

        internal void ExecuteOnGetBankAccounts(BankAccountsApi.GetBankAccountsApiResponse apiResponse)
        {
            OnGetBankAccounts?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorGetBankAccounts(Exception exception)
        {
            OnErrorGetBankAccounts?.Invoke(this, new ExceptionEventArgs(exception));
        }
    }
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public sealed partial class BankAccountsApi : IBankAccountsApi
    {
        ...
        /// The logger
        /// </summary>
        public ILogger<BankAccountsApi> Logger { get; }
        ...
        /// The class containing the events
        /// </summary>
        public BankAccountsApiEvents Events { get; }
        ...
        /// </summary>
        /// <returns></returns>
        public BankAccountsApi(ILogger<BankAccountsApi> logger, ILoggerFactory loggerFactory, HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, BankAccountsApiEvents bankAccountsApiEvents,
            TokenProvider<OAuthToken> oauthTokenProvider)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            LoggerFactory = loggerFactory;
            Logger = LoggerFactory.CreateLogger<BankAccountsApi>();
            HttpClient = httpClient;
            Events = bankAccountsApiEvents;
            OauthTokenProvider = oauthTokenProvider;
        }

        partial void FormatCreateBankAccount(ref string companySlug, BankAccountRequest bankAccountRequest);
        ...
        /// <param name="bankAccountRequest"></param>
        /// <returns></returns>
        private void ValidateCreateBankAccount(string companySlug, BankAccountRequest bankAccountRequest)
        {
            if (companySlug == null)
                throw new ArgumentNullException(nameof(companySlug));

            if (bankAccountRequest == null)
                throw new ArgumentNullException(nameof(bankAccountRequest));
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="bankAccountRequest"></param>
        private void AfterCreateBankAccountDefaultImplementation(ICreateBankAccountApiResponse apiResponseLocalVar, string companySlug, BankAccountRequest bankAccountRequest)
        {
            bool suppressDefaultLog = false;
            AfterCreateBankAccount(ref suppressDefaultLog, apiResponseLocalVar, companySlug, bankAccountRequest);
        ...
        /// <param name="companySlug"></param>
        /// <param name="bankAccountRequest"></param>
        partial void AfterCreateBankAccount(ref bool suppressDefaultLog, ICreateBankAccountApiResponse apiResponseLocalVar, string companySlug, BankAccountRequest bankAccountRequest);
        ...
        /// <param name="companySlug"></param>
        /// <param name="bankAccountRequest"></param>
        private void OnErrorCreateBankAccountDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, BankAccountRequest bankAccountRequest)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorCreateBankAccount(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, bankAccountRequest);
        ...
        /// <param name="companySlug"></param>
        /// <param name="bankAccountRequest"></param>
        partial void OnErrorCreateBankAccount(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, BankAccountRequest bankAccountRequest);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateBankAccountApiResponse"/>&gt;</returns>
        public async Task<ICreateBankAccountApiResponse?> CreateBankAccountOrDefaultAsync(string companySlug, BankAccountRequest bankAccountRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await CreateBankAccountAsync(companySlug, bankAccountRequest, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateBankAccountApiResponse"/>&gt;</returns>
        public async Task<ICreateBankAccountApiResponse> CreateBankAccountAsync(string companySlug, BankAccountRequest bankAccountRequest, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateCreateBankAccount(companySlug, bankAccountRequest);

                FormatCreateBankAccount(ref companySlug, bankAccountRequest);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies/{companySlug}/bankAccounts";
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7BcompanySlug%7D", Uri.EscapeDataString(companySlug.ToString()));

                    httpRequestMessageLocalVar.Content = (bankAccountRequest as object) is System.IO.Stream stream
                        ? httpRequestMessageLocalVar.Content = new StreamContent(stream)
                        : httpRequestMessageLocalVar.Content = new StringContent(JsonSerializer.Serialize(bankAccountRequest, _jsonSerializerOptions));
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ILogger<CreateBankAccountApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<CreateBankAccountApiResponse>();

                        CreateBankAccountApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/bankAccounts", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterCreateBankAccountDefaultImplementation(apiResponseLocalVar, companySlug, bankAccountRequest);

                        Events.ExecuteOnCreateBankAccount(apiResponseLocalVar);
            ...
            {
                OnErrorCreateBankAccountDefaultImplementation(e, "/companies/{companySlug}/bankAccounts", uriBuilderLocalVar.Path, companySlug, bankAccountRequest);
                Events.ExecuteOnErrorCreateBankAccount(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="CreateBankAccountApiResponse"/>
        /// </summary>
        public partial class CreateBankAccountApiResponse : Fiken.Client.ApiResponse, ICreateBankAccountApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<CreateBankAccountApiResponse> Logger { get; }
            ...
            public CreateBankAccountApiResponse(ILogger<CreateBankAccountApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
        ...
        partial void FormatGetBankAccount(ref string companySlug, ref long bankAccountId);
        ...
        /// <param name="companySlug"></param>
        /// <returns></returns>
        private void ValidateGetBankAccount(string companySlug)
        {
            if (companySlug == null)
                throw new ArgumentNullException(nameof(companySlug));
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="bankAccountId"></param>
        private void AfterGetBankAccountDefaultImplementation(IGetBankAccountApiResponse apiResponseLocalVar, string companySlug, long bankAccountId)
        {
            bool suppressDefaultLog = false;
            AfterGetBankAccount(ref suppressDefaultLog, apiResponseLocalVar, companySlug, bankAccountId);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="bankAccountId"></param>
        partial void AfterGetBankAccount(ref bool suppressDefaultLog, IGetBankAccountApiResponse apiResponseLocalVar, string companySlug, long bankAccountId);
        ...
        /// <param name="companySlug"></param>
        /// <param name="bankAccountId"></param>
        private void OnErrorGetBankAccountDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, long bankAccountId)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetBankAccount(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, bankAccountId);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="companySlug"></param>
        /// <param name="bankAccountId"></param>
        partial void OnErrorGetBankAccount(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, long bankAccountId);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetBankAccountApiResponse"/>&gt;</returns>
        public async Task<IGetBankAccountApiResponse?> GetBankAccountOrDefaultAsync(string companySlug, long bankAccountId, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetBankAccountAsync(companySlug, bankAccountId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetBankAccountApiResponse"/>&gt;</returns>
        public async Task<IGetBankAccountApiResponse> GetBankAccountAsync(string companySlug, long bankAccountId, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetBankAccount(companySlug);

                FormatGetBankAccount(ref companySlug, ref bankAccountId);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies/{companySlug}/bankAccounts/{bankAccountId}";
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7BcompanySlug%7D", Uri.EscapeDataString(companySlug.ToString()));
                    uriBuilderLocalVar.Path = uriBuilderLocalVar.Path.Replace("%7BbankAccountId%7D", Uri.EscapeDataString(bankAccountId.ToString()));
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ILogger<GetBankAccountApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<GetBankAccountApiResponse>();

                        GetBankAccountApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/bankAccounts/{bankAccountId}", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetBankAccountDefaultImplementation(apiResponseLocalVar, companySlug, bankAccountId);

                        Events.ExecuteOnGetBankAccount(apiResponseLocalVar);
            ...
            {
                OnErrorGetBankAccountDefaultImplementation(e, "/companies/{companySlug}/bankAccounts/{bankAccountId}", uriBuilderLocalVar.Path, companySlug, bankAccountId);
                Events.ExecuteOnErrorGetBankAccount(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="GetBankAccountApiResponse"/>
        /// </summary>
        public partial class GetBankAccountApiResponse : Fiken.Client.ApiResponse, IGetBankAccountApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<GetBankAccountApiResponse> Logger { get; }
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public GetBankAccountApiResponse(ILogger<GetBankAccountApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
            ...
            /// </summary>
            /// <returns></returns>
            public Fiken.Model.BankAccountResult? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Fiken.Model.BankAccountResult>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Fiken.Model.BankAccountResult? result)
            {
                result = null;
        ...
        partial void FormatGetBankAccounts(ref string companySlug, ref Option<int> page, ref Option<int> pageSize, ref Option<bool> inactive);
        ...
        /// <param name="companySlug"></param>
        /// <returns></returns>
        private void ValidateGetBankAccounts(string companySlug)
        {
            if (companySlug == null)
                throw new ArgumentNullException(nameof(companySlug));
        }
        ...
        private void AfterGetBankAccountsDefaultImplementation(IGetBankAccountsApiResponse apiResponseLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<bool> inactive)
        {
            bool suppressDefaultLog = false;
            AfterGetBankAccounts(ref suppressDefaultLog, apiResponseLocalVar, companySlug, page, pageSize, inactive);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="pageSize"></param>
        /// <param name="inactive"></param>
        partial void AfterGetBankAccounts(ref bool suppressDefaultLog, IGetBankAccountsApiResponse apiResponseLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<bool> inactive);
        ...
        /// <param name="pageSize"></param>
        /// <param name="inactive"></param>
        private void OnErrorGetBankAccountsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<bool> inactive)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetBankAccounts(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, page, pageSize, inactive);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="pageSize"></param>
        /// <param name="inactive"></param>
        partial void OnErrorGetBankAccounts(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, Option<int> page, Option<int> pageSize, Option<bool> inactive);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetBankAccountsApiResponse"/>&gt;</returns>
        public async Task<IGetBankAccountsApiResponse?> GetBankAccountsOrDefaultAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<bool> inactive = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetBankAccountsAsync(companySlug, page, pageSize, inactive, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetBankAccountsApiResponse"/>&gt;</returns>
        public async Task<IGetBankAccountsApiResponse> GetBankAccountsAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, Option<bool> inactive = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetBankAccounts(companySlug);

                FormatGetBankAccounts(ref companySlug, ref page, ref pageSize, ref inactive);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        ILogger<GetBankAccountsApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<GetBankAccountsApiResponse>();

                        GetBankAccountsApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/bankAccounts", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetBankAccountsDefaultImplementation(apiResponseLocalVar, companySlug, page, pageSize, inactive);

                        Events.ExecuteOnGetBankAccounts(apiResponseLocalVar);
            ...
            {
                OnErrorGetBankAccountsDefaultImplementation(e, "/companies/{companySlug}/bankAccounts", uriBuilderLocalVar.Path, companySlug, page, pageSize, inactive);
                Events.ExecuteOnErrorGetBankAccounts(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="GetBankAccountsApiResponse"/>
        /// </summary>
        public partial class GetBankAccountsApiResponse : Fiken.Client.ApiResponse, IGetBankAccountsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            public ILogger<GetBankAccountsApiResponse> Logger { get; }
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public GetBankAccountsApiResponse(ILogger<GetBankAccountsApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
            ...
            /// </summary>
            /// <returns></returns>
            public List<BankAccountResult>? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<List<BankAccountResult>>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out List<BankAccountResult>? result)
            {
                result = null;
