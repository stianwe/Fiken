...
namespace Fiken.Api
{
    ...
    public interface IGroupsApi : IApi
    {
        ...
        Task<IGetGroupsApiResponse> GetGroupsAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetGroupsApiResponse"/>?&gt;</returns>
        Task<IGetGroupsApiResponse?> GetGroupsOrDefaultAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, System.Threading.CancellationToken cancellationToken = default);
    }

    /// <summary>
    /// The <see cref="IGetGroupsApiResponse"/>
    /// </summary>
    public interface IGetGroupsApiResponse : Fiken.Client.IApiResponse, IOk<List<string>?>
    {
        /// <summary>
    ...
    public class GroupsApiEvents
    {
        ...
        internal void ExecuteOnGetGroups(GroupsApi.GetGroupsApiResponse apiResponse)
        {
    ...
    public sealed partial class GroupsApi : IGroupsApi
    {
        ...
        partial void FormatGetGroups(ref string companySlug, ref Option<int> page, ref Option<int> pageSize);
        ...
        /// <returns></returns>
        private void ValidateGetGroups(string companySlug)
        {
            if (companySlug == null)
        ...
        private void AfterGetGroupsDefaultImplementation(IGetGroupsApiResponse apiResponseLocalVar, string companySlug, Option<int> page, Option<int> pageSize)
        {
            bool suppressDefaultLog = false;
            AfterGetGroups(ref suppressDefaultLog, apiResponseLocalVar, companySlug, page, pageSize);
        ...
        /// <param name="page"></param>
        /// <param name="pageSize"></param>
        partial void AfterGetGroups(ref bool suppressDefaultLog, IGetGroupsApiResponse apiResponseLocalVar, string companySlug, Option<int> page, Option<int> pageSize);
        ...
        /// <param name="page"></param>
        /// <param name="pageSize"></param>
        private void OnErrorGetGroupsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, Option<int> page, Option<int> pageSize)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetGroups(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, companySlug, page, pageSize);
        ...
        /// <param name="page"></param>
        /// <param name="pageSize"></param>
        partial void OnErrorGetGroups(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string companySlug, Option<int> page, Option<int> pageSize);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetGroupsApiResponse"/>&gt;</returns>
        public async Task<IGetGroupsApiResponse?> GetGroupsOrDefaultAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetGroupsAsync(companySlug, page, pageSize, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetGroupsApiResponse"/>&gt;</returns>
        public async Task<IGetGroupsApiResponse> GetGroupsAsync(string companySlug, Option<int> page = default, Option<int> pageSize = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetGroups(companySlug);

                FormatGetGroups(ref companySlug, ref page, ref pageSize);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/companies/{companySlug}/groups";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetGroupsApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/companies/{companySlug}/groups", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetGroupsDefaultImplementation(apiResponseLocalVar, companySlug, page, pageSize);
            ...
            {
                OnErrorGetGroupsDefaultImplementation(e, "/companies/{companySlug}/groups", uriBuilderLocalVar.Path, companySlug, page, pageSize);
        ...
        /// </summary>
        public partial class GetGroupsApiResponse : Fiken.Client.ApiResponse, IGetGroupsApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
