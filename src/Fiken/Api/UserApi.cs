...
namespace Fiken.Api
{
    ...
    public interface IUserApi : IApi
    {
        ...
        Task<IGetUserApiResponse> GetUserAsync(System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetUserApiResponse"/>?&gt;</returns>
        Task<IGetUserApiResponse?> GetUserOrDefaultAsync(System.Threading.CancellationToken cancellationToken = default);
    }

    /// <summary>
    /// The <see cref="IGetUserApiResponse"/>
    /// </summary>
    public interface IGetUserApiResponse : Fiken.Client.IApiResponse, IOk<Fiken.Model.Userinfo?>
    {
        /// <summary>
    ...
    public sealed partial class UserApi : IUserApi
    {
        ...
        private void AfterGetUserDefaultImplementation(IGetUserApiResponse apiResponseLocalVar)
        {
            bool suppressDefaultLog = false;
            AfterGetUser(ref suppressDefaultLog, apiResponseLocalVar);
        ...
        /// <param name="apiResponseLocalVar"></param>
        partial void AfterGetUser(ref bool suppressDefaultLog, IGetUserApiResponse apiResponseLocalVar);
        ...
        private void OnErrorGetUserDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetUser(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar);
        ...
        /// <param name="pathFormatLocalVar"></param>
        /// <param name="pathLocalVar"></param>
        partial void OnErrorGetUser(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetUserApiResponse"/>&gt;</returns>
        public async Task<IGetUserApiResponse?> GetUserOrDefaultAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetUserAsync(cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetUserApiResponse"/>&gt;</returns>
        public async Task<IGetUserApiResponse> GetUserAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        GetUserApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/user", requestedAtLocalVar, _jsonSerializerOptions);

                        AfterGetUserDefaultImplementation(apiResponseLocalVar);
            ...
            {
                OnErrorGetUserDefaultImplementation(e, "/user", uriBuilderLocalVar.Path);
        ...
        /// </summary>
        public partial class GetUserApiResponse : Fiken.Client.ApiResponse, IGetUserApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Fiken.Model.Userinfo? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Fiken.Model.Userinfo>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Fiken.Model.Userinfo? result)
            {
                result = null;
