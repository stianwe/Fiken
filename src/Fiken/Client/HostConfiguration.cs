...
{
    /// <summary>
    /// Provides hosting configuration for Fiken
    /// </summary>
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new AccountBalanceJsonConverter());
            _jsonOptions.Converters.Add(new AddressJsonConverter());
            _jsonOptions.Converters.Add(new AttachmentJsonConverter());
            _jsonOptions.Converters.Add(new BankAccountRequestJsonConverter());
            _jsonOptions.Converters.Add(new BankAccountResultJsonConverter());
            _jsonOptions.Converters.Add(new CompanyJsonConverter());
            _jsonOptions.Converters.Add(new ContactJsonConverter());
            _jsonOptions.Converters.Add(new ContactNoteJsonConverter());
            _jsonOptions.Converters.Add(new ContactPersonJsonConverter());
            _jsonOptions.Converters.Add(new CounterJsonConverter());
            _jsonOptions.Converters.Add(new CreditNoteLineResultJsonConverter());
            _jsonOptions.Converters.Add(new CreditNoteResultJsonConverter());
            _jsonOptions.Converters.Add(new DispatchResultJsonConverter());
            _jsonOptions.Converters.Add(new DraftLineRequestJsonConverter());
            _jsonOptions.Converters.Add(new DraftLineResultJsonConverter());
            _jsonOptions.Converters.Add(new DraftRequestJsonConverter());
            _jsonOptions.Converters.Add(new DraftResultJsonConverter());
            _jsonOptions.Converters.Add(new FullCreditNoteRequestJsonConverter());
            _jsonOptions.Converters.Add(new GeneralJournalEntryRequestJsonConverter());
            _jsonOptions.Converters.Add(new InboxResultJsonConverter());
            _jsonOptions.Converters.Add(new InvoiceLineRequestJsonConverter());
            _jsonOptions.Converters.Add(new InvoiceLineResultJsonConverter());
            _jsonOptions.Converters.Add(new InvoiceRequestJsonConverter());
            _jsonOptions.Converters.Add(new InvoiceResultJsonConverter());
            _jsonOptions.Converters.Add(new InvoiceishDraftLineJsonConverter());
            _jsonOptions.Converters.Add(new InvoiceishDraftRequestJsonConverter());
            _jsonOptions.Converters.Add(new InvoiceishDraftResultJsonConverter());
            _jsonOptions.Converters.Add(new JournalEntryJsonConverter());
            _jsonOptions.Converters.Add(new JournalEntryLineJsonConverter());
            _jsonOptions.Converters.Add(new NoteJsonConverter());
            _jsonOptions.Converters.Add(new OfferJsonConverter());
            _jsonOptions.Converters.Add(new OrderConfirmationJsonConverter());
            _jsonOptions.Converters.Add(new OrderLineJsonConverter());
            _jsonOptions.Converters.Add(new PartialCreditNoteRequestJsonConverter());
            _jsonOptions.Converters.Add(new PaymentJsonConverter());
            _jsonOptions.Converters.Add(new ProductJsonConverter());
            _jsonOptions.Converters.Add(new ProductSalesLineInfoJsonConverter());
            _jsonOptions.Converters.Add(new ProductSalesReportRequestJsonConverter());
            _jsonOptions.Converters.Add(new ProductSalesReportResultJsonConverter());
            _jsonOptions.Converters.Add(new ProjectRequestJsonConverter());
            _jsonOptions.Converters.Add(new ProjectResultJsonConverter());
            _jsonOptions.Converters.Add(new PurchaseRequestJsonConverter());
            _jsonOptions.Converters.Add(new PurchaseResultJsonConverter());
            _jsonOptions.Converters.Add(new SaleRequestJsonConverter());
            _jsonOptions.Converters.Add(new SaleResultJsonConverter());
            _jsonOptions.Converters.Add(new SendCreditNoteRequestJsonConverter());
            _jsonOptions.Converters.Add(new SendInvoiceRequestJsonConverter());
            _jsonOptions.Converters.Add(new SendInvoiceishRequestJsonConverter());
            _jsonOptions.Converters.Add(new TransactionJsonConverter());
            _jsonOptions.Converters.Add(new UpdateInvoiceRequestJsonConverter());
            ...
            _services.AddSingleton<AccountBalancesApiEvents>();
            _services.AddTransient<IAccountBalancesApi, AccountBalancesApi>();
            _services.AddSingleton<AccountsApiEvents>();
            _services.AddTransient<IAccountsApi, AccountsApi>();
            _services.AddSingleton<BankAccountsApiEvents>();
            _services.AddTransient<IBankAccountsApi, BankAccountsApi>();
            _services.AddSingleton<CompaniesApiEvents>();
            _services.AddTransient<ICompaniesApi, CompaniesApi>();
            _services.AddSingleton<ContactsApiEvents>();
            _services.AddTransient<IContactsApi, ContactsApi>();
            _services.AddSingleton<CreditNotesApiEvents>();
            _services.AddTransient<ICreditNotesApi, CreditNotesApi>();
            _services.AddSingleton<GroupsApiEvents>();
            _services.AddTransient<IGroupsApi, GroupsApi>();
            _services.AddSingleton<InboxApiEvents>();
            _services.AddTransient<IInboxApi, InboxApi>();
            _services.AddSingleton<InvoicesApiEvents>();
            _services.AddTransient<IInvoicesApi, InvoicesApi>();
            _services.AddSingleton<JournalEntriesApiEvents>();
            _services.AddTransient<IJournalEntriesApi, JournalEntriesApi>();
            _services.AddSingleton<OffersApiEvents>();
            _services.AddTransient<IOffersApi, OffersApi>();
            _services.AddSingleton<OrderConfirmationsApiEvents>();
            _services.AddTransient<IOrderConfirmationsApi, OrderConfirmationsApi>();
            ...
            _services.AddSingleton<PurchasesApiEvents>();
            _services.AddTransient<IPurchasesApi, PurchasesApi>();
            _services.AddSingleton<SalesApiEvents>();
            _services.AddTransient<ISalesApi, SalesApi>();
        ...
        // {
            ...
            //
            // builders.Add(_services.AddHttpClient<IAccountBalancesApi, AccountBalancesApi>(client));
            // builders.Add(_services.AddHttpClient<IAccountsApi, AccountsApi>(client));
            // builders.Add(_services.AddHttpClient<IBankAccountsApi, BankAccountsApi>(client));
            ...
            // builders.Add(_services.AddHttpClient<ICreditNotesApi, CreditNotesApi>(client));
            // builders.Add(_services.AddHttpClient<IGroupsApi, GroupsApi>(client));
            // builders.Add(_services.AddHttpClient<IInboxApi, InboxApi>(client));
            // builders.Add(_services.AddHttpClient<IInvoicesApi, InvoicesApi>(client));
            // builders.Add(_services.AddHttpClient<IJournalEntriesApi, JournalEntriesApi>(client));
            // builders.Add(_services.AddHttpClient<IOffersApi, OffersApi>(client));
            // builders.Add(_services.AddHttpClient<IOrderConfirmationsApi, OrderConfirmationsApi>(client));
            ...
            // builders.Add(_services.AddHttpClient<IPurchasesApi, PurchasesApi>(client));
            // builders.Add(_services.AddHttpClient<ISalesApi, SalesApi>(client));
